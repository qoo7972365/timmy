...
username = 'forme'
password = 'forme'
php_function = 'system'  # Note: we can only kerberhash 1 argument to the function
...
request = br.open(url + 'block/tab_orders/period/3y/?isAjax=true', data='isAjax=false&form_key=' + key)
