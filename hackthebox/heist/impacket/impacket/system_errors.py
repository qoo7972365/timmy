...
ERROR_MESSAGES = {
        ...
        0x00000271: ("ERROR_VALIDATE_CONTINUE", "The validation process needs to continue on to the next step.txt.txt."),
        ...
        0x00003aa7: ("ERROR_EVT_FILTER_NOTELTSET", "Can't perform a step.txt.txt operation from a term that does not represent an element set."),
        ...
        0x00003aa9: ("ERROR_EVT_FILTER_INVTEST", "A step.txt.txt operation must involve either a node test or, in the case of a predicate, an algebraic expression against which to test each node in the node set identified by the preceding node set can be evaluated."),
