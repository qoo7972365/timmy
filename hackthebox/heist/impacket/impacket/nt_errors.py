...
ERROR_MESSAGES = {
        ...
        0x80000004: ("STATUS_SINGLE_STEP","{EXCEPTION} Single Step A single step.txt.txt or trace operation has just been completed."),
        ...
        0xC0000271: ("STATUS_VALIDATE_CONTINUE","The validation process needs to continue on to the next step.txt.txt."),
