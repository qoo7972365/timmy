...
/*    */ 
/*    */ public final class ReloadManagedServers_jsp extends org.apache.jasper.runtime.HttpJspBase implements JspSourceDependent
/*    */ {
...
/*    */       
/* 64 */       String resid = request.getParameter("serverID");
/* 65 */       String success = (String)request.getAttribute("success");
/*    */       
/* 67 */       out.write("\n  window.opener.location.href=\"/adminAction.do?method=showManagedServers&serverID=");
/* 68 */       out.print(resid);
/* 69 */       out.write("&success=");
/* 70 */       out.print(success);
/* 71 */       out.write("\";\n</script>\n</body>\n</html>\n\n");
/*    */     } catch (Throwable t) {
...
/* Location:              C:\Program Files (x86)\ManageEngine\AppManager12\working\WEB-INF\lib\AdventNetAppManagerWebClient.jar!\org\apache\jsp\jsp\ReloadManagedServers_jsp.class
