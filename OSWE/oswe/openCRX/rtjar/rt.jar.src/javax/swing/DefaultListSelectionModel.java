...
/*  58 */   private int minIndex = Integer.MAX_VALUE;
/*  59 */   private int maxIndex = -1;
/*  60 */   private int anchorIndex = -1;
/*  61 */   private int leadIndex = -1;
/*  62 */   private int firstAdjustedIndex = Integer.MAX_VALUE;
/*  63 */   private int lastAdjustedIndex = -1;
/*     */   
/*     */   private boolean isAdjusting = false;
/*  66 */   private int firstChangedIndex = Integer.MAX_VALUE;
...
/* 136 */     return this.listenerList.<ListSelectionListener>getListeners(ListSelectionListener.class);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 152 */     this.firstChangedIndex = Integer.MAX_VALUE;
...
/* 177 */     ListSelectionEvent listSelectionEvent = null;
/*     */     
/* 179 */     for (int i = arrayOfObject.length - 2; i >= 0; i -= 2) {
/* 180 */       if (arrayOfObject[i] == ListSelectionListener.class) {
/* 181 */         if (listSelectionEvent == null) {
/* 182 */           listSelectionEvent = new ListSelectionEvent(this, paramInt1, paramInt2, paramBoolean);
/*     */         }
/* 184 */         ((ListSelectionListener)arrayOfObject[i + 1]).valueChanged(listSelectionEvent);
/*     */       } 
/*     */     } 
/*     */   }
/*     */   
...
/* 208 */     this.firstAdjustedIndex = Integer.MAX_VALUE;
...
/* 292 */       this.minIndex++; for (; this.minIndex <= this.maxIndex && 
/* 293 */         !this.value.get(this.minIndex); this.minIndex++);
/*     */     } 
/*     */ 
/*     */ 
/*     */ 
...
/* 305 */       this.maxIndex--; for (; this.minIndex <= this.maxIndex && 
/* 306 */         !this.value.get(this.maxIndex); this.maxIndex--);
/*     */     } 
/*     */ 
/*     */ 
/*     */ 
...
/* 327 */       this.minIndex = Integer.MAX_VALUE;
/* 328 */       this.maxIndex = -1;
/*     */     } 
/*     */   }
/*     */ 
...
/*     */     
/* 503 */     int i = Integer.MAX_VALUE;
/* 504 */     byte b = -1;
/* 505 */     int j = Math.min(paramInt1, paramInt2);
/* 506 */     int k = Math.max(paramInt1, paramInt2);
/*     */ 
/*     */ 
/*     */ 
/*     */     
/* 511 */     if (getSelectionMode() == 1 && (k < this.minIndex - 1 || j > this.maxIndex + 1)) {
/*     */ 
/*     */       
...
/*     */ 
/*     */     
/* 615 */     k = (getSelectionMode() == 0) ? 0 : this.value.get(paramInt1); int m;
/* 616 */     for (m = i; m <= j; m++) {
/* 617 */       setState(m, k);
/*     */     }
/*     */     
...
/* 710 */     DefaultListSelectionModel defaultListSelectionModel = (DefaultListSelectionModel)super.clone();
/* 711 */     defaultListSelectionModel.value = (BitSet)this.value.clone();
/* 712 */     defaultListSelectionModel.listenerList = new EventListenerList();
/* 713 */     return defaultListSelectionModel;
/*     */   }
/*     */ 
/*     */   
/*     */   @Transient
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/javax/swing/DefaultListSelectionModel.class
