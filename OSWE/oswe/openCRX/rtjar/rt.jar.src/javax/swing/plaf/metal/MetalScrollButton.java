...
/*     */     
/*  82 */     ColorUIResource colorUIResource = bool2 ? MetalLookAndFeel.getControlInfo() : MetalLookAndFeel.getControlDisabled();
...
/*     */ 
/*     */       
/* 114 */       paramGraphics.setColor(colorUIResource);
/* 115 */       int i2 = (m + 1 - n) / 2;
/* 116 */       int i3 = k / 2;
/*     */       
/* 118 */       for (byte b = 0; b < n; b++) {
/* 119 */         paramGraphics.drawLine(i3 - b, i2 + b, i3 + b + 1, i2 + b);
/*     */       }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */       
/* 164 */       paramGraphics.setColor(colorUIResource);
/*     */       
/* 166 */       int i2 = (m + 1 - n) / 2 + n - 1;
/* 167 */       int i3 = k / 2;
/*     */ 
/*     */ 
/*     */       
/* 171 */       for (byte b = 0; b < n; b++) {
/* 172 */         paramGraphics.drawLine(i3 - b, i2 - b, i3 + b + 1, i2 - b);
/*     */       }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */       
/* 216 */       paramGraphics.setColor(colorUIResource);
/*     */       
/* 218 */       int i2 = (k + 1 - n) / 2 + n - 1;
/* 219 */       int i3 = m / 2;
/*     */ 
/*     */ 
/*     */       
/* 223 */       for (byte b = 0; b < n; b++) {
/* 224 */         paramGraphics.drawLine(i2 - b, i3 - b, i2 - b, i3 + b + 1);
/*     */       }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */       
/* 266 */       paramGraphics.setColor(colorUIResource);
/*     */       
/* 268 */       int i2 = (k + 1 - n) / 2;
/* 269 */       int i3 = m / 2;
/*     */ 
...
/* 273 */         paramGraphics.drawLine(i2 + b, i3 - b, i2 + b, i3 + b + 1);
/*     */       }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/javax/swing/plaf/metal/MetalScrollButton.class
