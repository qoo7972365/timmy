...
/*  77 */       case 3: paintBorderEnabled(paramGraphics2D);
/*     */         break; }
/*     */   
/*     */   }
/*     */ 
...
/* 127 */     this.rect.setRect(decodeX(0.6F), 
/* 128 */         decodeY(0.4F), (
/* 129 */         decodeX(2.4F) - decodeX(0.6F)), (
/* 130 */         decodeY(0.6F) - decodeY(0.4F)));
/* 131 */     return this.rect;
/*     */   }
/*     */   
/*     */   private Rectangle2D decodeRect2() {
/* 135 */     this.rect.setRect(decodeX(0.4F), 
/* 136 */         decodeY(0.4F), (
/* 137 */         decodeX(0.6F) - decodeX(0.4F)), (
/* 138 */         decodeY(2.6F) - decodeY(0.4F)));
/* 139 */     return this.rect;
/*     */   }
/*     */   
/*     */   private Rectangle2D decodeRect3() {
/* 143 */     this.rect.setRect(decodeX(2.4F), 
/* 144 */         decodeY(0.4F), (
/* 145 */         decodeX(2.6F) - decodeX(2.4F)), (
/* 146 */         decodeY(2.6F) - decodeY(0.4F)));
/* 147 */     return this.rect;
/*     */   }
/*     */   
/*     */   private Rectangle2D decodeRect4() {
/* 151 */     this.rect.setRect(decodeX(0.6F), 
/* 152 */         decodeY(2.4F), (
/* 153 */         decodeX(2.4F) - decodeX(0.6F)), (
/* 154 */         decodeY(2.6F) - decodeY(2.4F)));
...
/* 164 */     this.path.curveTo(decodeAnchorX(2.6F, 0.0F), decodeAnchorY(0.4F, 0.0F), decodeAnchorX(2.8800004F, 0.1F), decodeAnchorY(0.4F, 0.0F), decodeX(2.8800004F), decodeY(0.4F));
/* 165 */     this.path.curveTo(decodeAnchorX(2.8800004F, 0.1F), decodeAnchorY(0.4F, 0.0F), decodeAnchorX(2.8800004F, 0.0F), decodeAnchorY(2.8799999F, 0.0F), decodeX(2.8800004F), decodeY(2.8799999F));
/* 166 */     this.path.lineTo(decodeX(0.120000005F), decodeY(2.8799999F));
/* 167 */     this.path.lineTo(decodeX(0.120000005F), decodeY(0.120000005F));
/* 168 */     this.path.lineTo(decodeX(2.8800004F), decodeY(0.120000005F));
/* 169 */     this.path.lineTo(decodeX(2.8800004F), decodeY(0.4F));
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/javax/swing/plaf/nimbus/ScrollPanePainter.class
