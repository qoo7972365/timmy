...
/*  404 */       int i; switch (paramInt) {
/*      */         case 0:
/*      */         case 1:
/*  407 */           i = this.orientation;
/*  408 */           this.orientation = paramInt;
/*  409 */           firePropertyChange("orientation", i, paramInt);
/*  410 */           if (this.accessibleContext != null) {
/*  411 */             this.accessibleContext.firePropertyChange("AccessibleState", (i == 1) ? AccessibleState.VERTICAL : AccessibleState.HORIZONTAL, (this.orientation == 1) ? AccessibleState.VERTICAL : AccessibleState.HORIZONTAL);
/*      */           }
/*      */           break;
/*      */ 
/*      */ 
...
/*  529 */     double d = this.model.getValue();
/*  530 */     return (d - this.model.getMinimum()) / l;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  702 */     return this.listenerList.<ChangeListener>getListeners(ChangeListener.class);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  758 */     BoundedRangeModel boundedRangeModel = getModel();
/*      */     
/*  760 */     if (paramBoundedRangeModel != boundedRangeModel) {
/*  761 */       if (boundedRangeModel != null) {
/*  762 */         boundedRangeModel.removeChangeListener(this.changeListener);
...
/*  774 */         this.accessibleContext.firePropertyChange("AccessibleValue", (boundedRangeModel == null) ? null : 
/*      */ 
/*      */             
/*  777 */             Integer.valueOf(boundedRangeModel.getValue()), (paramBoundedRangeModel == null) ? null : 
/*      */             
/*  779 */             Integer.valueOf(paramBoundedRangeModel.getValue()));
/*      */       }
/*      */       
...
/*  845 */     BoundedRangeModel boundedRangeModel = getModel();
/*  846 */     int i = boundedRangeModel.getValue();
/*  847 */     boundedRangeModel.setValue(paramInt);
/*      */     
/*  849 */     if (this.accessibleContext != null) {
/*  850 */       this.accessibleContext.firePropertyChange("AccessibleValue", 
/*      */           
/*  852 */           Integer.valueOf(i), 
/*  853 */           Integer.valueOf(boundedRangeModel.getValue()));
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1049 */       AccessibleStateSet accessibleStateSet = super.getAccessibleStateSet();
/* 1050 */       if (JProgressBar.this.getModel().getValueIsAdjusting()) {
/* 1051 */         accessibleStateSet.add(AccessibleState.BUSY);
/*      */       }
/* 1053 */       if (JProgressBar.this.getOrientation() == 1) {
/* 1054 */         accessibleStateSet.add(AccessibleState.VERTICAL);
/*      */       } else {
/* 1056 */         accessibleStateSet.add(AccessibleState.HORIZONTAL);
/*      */       } 
/* 1058 */       return accessibleStateSet;
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1099 */       if (param1Number == null) {
/* 1100 */         return false;
/*      */       }
/* 1102 */       JProgressBar.this.setValue(param1Number.intValue());
/* 1103 */       return true;
/*      */     }
/*      */ 
/*      */ 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/javax/swing/JProgressBar.class
