...
/*     */     public Tag() {}
/*     */     
/*     */     protected Tag(String param1String) {
/*  63 */       this(param1String, false, false);
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*  78 */       this.name = param1String;
/*  79 */       this.breakTag = param1Boolean1;
/*  80 */       this.blockTag = param1Boolean2;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   {
/*     */     public UnknownTag(String param1String) {
/* 294 */       super(param1String);
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 316 */       if (param1Object instanceof UnknownTag) {
/* 317 */         return toString().equals(param1Object.toString());
/*     */       }
/* 319 */       return false;
/*     */     }
/*     */ 
...
/* 324 */       param1ObjectOutputStream.defaultWriteObject();
/* 325 */       param1ObjectOutputStream.writeBoolean(this.blockTag);
/* 326 */       param1ObjectOutputStream.writeBoolean(this.breakTag);
/* 327 */       param1ObjectOutputStream.writeBoolean(this.unknown);
/* 328 */       param1ObjectOutputStream.writeObject(this.name);
/*     */     }
/*     */ 
/*     */     
/*     */     private void readObject(ObjectInputStream param1ObjectInputStream) throws ClassNotFoundException, IOException {
/* 333 */       param1ObjectInputStream.defaultReadObject();
/* 334 */       this.blockTag = param1ObjectInputStream.readBoolean();
/* 335 */       this.breakTag = param1ObjectInputStream.readBoolean();
/* 336 */       this.unknown = param1ObjectInputStream.readBoolean();
/* 337 */       this.name = (String)param1ObjectInputStream.readObject();
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/*     */     Attribute(String param1String) {
/* 354 */       this.name = param1String;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/* 449 */     static final Attribute[] allAttributes = new Attribute[] { FACE, COMMENT, SIZE, COLOR, CLEAR, BACKGROUND, BGCOLOR, TEXT, LINK, VLINK, ALINK, WIDTH, HEIGHT, ALIGN, NAME, HREF, REL, REV, TITLE, TARGET, SHAPE, COORDS, ISMAP, NOHREF, ALT, ID, SRC, HSPACE, VSPACE, USEMAP, LOWSRC, CODEBASE, CODE, ARCHIVE, VALUE, VALUETYPE, TYPE, CLASS, STYLE, LANG, DIR, DECLARE, CLASSID, DATA, CODETYPE, STANDBY, BORDER, SHAPES, NOSHADE, COMPACT, START, ACTION, METHOD, ENCTYPE, CHECKED, MAXLENGTH, MULTIPLE, SELECTED, ROWS, COLS, DUMMY, CELLSPACING, CELLPADDING, VALIGN, HALIGN, NOWRAP, ROWSPAN, COLSPAN, PROMPT, HTTPEQUIV, CONTENT, LANGUAGE, VERSION, N, FRAMEBORDER, MARGINWIDTH, MARGINHEIGHT, SCROLLING, NORESIZE, MEDIA, ENDTAG };
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 542 */   private static final Hashtable<Object, Tag> scMapping = new Hashtable<>(8); public static final String NULL_ATTRIBUTE_VALUE = "#DEFAULT";
/*     */   
/*     */   static {
/*     */     byte b;
/* 546 */     for (b = 0; b < Tag.allTags.length; b++) {
/* 547 */       tagHashtable.put(Tag.allTags[b].toString(), Tag.allTags[b]);
/* 548 */       StyleContext.registerStaticAttributeKey(Tag.allTags[b]);
/*     */     } 
...
/* 553 */     for (b = 0; b < Attribute.allAttributes.length; b++) {
/* 554 */       StyleContext.registerStaticAttributeKey(Attribute.allAttributes[b]);
/*     */     }
/*     */     
...
/* 601 */     Tag tag = tagHashtable.get(paramString);
/* 602 */     return (tag == null) ? null : tag;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 616 */     return scMapping.get(paramStyleConstants);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 636 */       } catch (NumberFormatException numberFormatException) {
/* 637 */         i = paramInt;
/*     */       } 
/*     */     }
/* 640 */     return i;
...
/*     */ 
/*     */   
/* 649 */   private static final Hashtable<String, Attribute> attHashtable = new Hashtable<>(77);
/*     */ 
/*     */   
/*     */   static {
/* 653 */     for (b = 0; b < Attribute.allAttributes.length; b++) {
/* 654 */       attHashtable.put(Attribute.allAttributes[b].toString(), Attribute.allAttributes[b]);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 690 */     Attribute attribute = attHashtable.get(paramString);
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/javax/swing/text/html/HTML.class
