...
/*      */ 
/*      */     
/* 1012 */     this.writeCSS = false;
/*      */ 
/*      */ 
/*      */ 
/*      */     
/* 1017 */     this.convAttr = new SimpleAttributeSet();
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*      */     
/* 1023 */     this.oConvAttr = new SimpleAttributeSet();
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */           Element element = this.blockElementStack.peek();
/*      */           while (element != element2.getParentElement()) {
...
/*      */               endTag(element);
/*      */             } 
/*      */             element = this.blockElementStack.peek();
/*      */           } 
/*      */         } else if (element1.getParentElement() == element2.getParentElement()) {
/*      */           Element element = this.blockElementStack.peek();
/*      */           if (element == element1) {
...
/*      */       element1 = element2;
/*      */     } 
/*      */     closeOutUnwantedEmbeddedTags((AttributeSet)null);
/*      */     if (bool) {
/*      */       this.blockElementStack.pop();
/*      */       endTag(element1);
/*      */     } 
/*      */     while (!this.blockElementStack.empty()) {
/*      */       element1 = this.blockElementStack.pop();
...
/*      */   }
/*      */   
/*      */   protected void startTag(Element paramElement) throws IOException, BadLocationException {
/*      */     HTML.Tag tag;
...
/*      */   }
/*      */   
/*      */   protected void textAreaContent(AttributeSet paramAttributeSet) throws BadLocationException, IOException {
...
/*      */       OptionListModel<Option> optionListModel = (OptionListModel)object;
/*      */       int i = optionListModel.getSize();
/*      */       for (byte b = 0; b < i; b++) {
/*      */         Option option = optionListModel.getElementAt(b);
/*      */         writeOption(option);
/*      */       } 
/*      */     } else if (object instanceof OptionComboBoxModel) {
/*      */       OptionComboBoxModel<Option> optionComboBoxModel = (OptionComboBoxModel)object;
/*      */       int i = optionComboBoxModel.getSize();
/*      */       for (byte b = 0; b < i; b++) {
/*      */         Option option = optionComboBoxModel.getElementAt(b);
/*      */         writeOption(option);
/*      */       } 
/*      */     } 
/*      */     decrIndent();
...
/*      */   }
/*      */   
/*      */   protected void endTag(Element paramElement) throws IOException {
/*      */     if (synthesizedElement(paramElement))
/*      */       return; 
...
/*      */       Vector<E> vector = (Vector)object;
/*      */       byte b;
/*      */       int i;
/*      */       for (b = 0, i = vector.size(); b < i; b++)
/*      */         writeComment(vector.elementAt(b).toString()); 
/*      */     } 
/*      */   }
/*      */   
/*      */   protected boolean synthesizedElement(Element paramElement) {
/*      */     if (matchNameAttribute(paramElement.getAttributes(), HTML.Tag.IMPLIED))
/*      */       return true; 
/*      */     return false;
/*      */   }
/*      */   
...
/*      */     paramAttributeSet = convertToHTML(paramAttributeSet, (MutableAttributeSet)null);
/*      */     int i = -1;
/*      */     int j = this.tags.size();
/*      */     int k;
/*      */     for (k = j - 1; k >= 0; k--) {
/*      */       HTML.Tag tag = this.tags.elementAt(k);
...
/*      */       int m;
/*      */       for (m = j - 1; m >= i; m--) {
/*      */         HTML.Tag tag = this.tags.elementAt(m);
...
/*      */   }
/*      */   
/*      */   void writeMaps(Enumeration<Map> paramEnumeration) throws IOException {
/*      */     if (paramEnumeration != null)
/*      */       while (paramEnumeration.hasMoreElements()) {
/*      */         Map map = paramEnumeration.nextElement();
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/javax/swing/text/html/HTMLWriter.class
