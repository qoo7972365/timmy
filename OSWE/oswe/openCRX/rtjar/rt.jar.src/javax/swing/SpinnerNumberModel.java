...
/*     */   
/*     */   public SpinnerNumberModel(Number paramNumber1, Comparable<Number> paramComparable1, Comparable<Number> paramComparable2, Number paramNumber2) {
/* 120 */     if (paramNumber1 == null || paramNumber2 == null) {
/* 121 */       throw new IllegalArgumentException("value and stepSize must be non-null");
/*     */     }
/* 123 */     if ((paramComparable1 != null && paramComparable1.compareTo(paramNumber1) > 0) || (paramComparable2 != null && paramComparable2
/* 124 */       .compareTo(paramNumber1) < 0)) {
...
/* 174 */     this(Integer.valueOf(0), (Comparable)null, (Comparable)null, Integer.valueOf(1));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 326 */         Double double_ = new Double(d);
/*     */       } else {
/*     */         
/* 329 */         Float float_ = new Float(d);
/*     */       } 
/*     */     } else {
/*     */       
...
/* 336 */         Long long_ = Long.valueOf(l);
/*     */       }
/* 338 */       else if (this.value instanceof Integer) {
/* 339 */         Integer integer = Integer.valueOf((int)l);
/*     */       }
/* 341 */       else if (this.value instanceof Short) {
/* 342 */         Short short_ = Short.valueOf((short)(int)l);
/*     */       } else {
/*     */         
/* 345 */         byte_ = Byte.valueOf((byte)(int)l);
/*     */       } 
/*     */     } 
/*     */     
/* 349 */     if (this.maximum != null && this.maximum.compareTo(byte_) < 0) {
/* 350 */       return null;
/*     */     }
/* 352 */     if (this.minimum != null && this.minimum.compareTo(byte_) > 0) {
/* 353 */       return null;
/*     */     }
/*     */     
/* 356 */     return byte_;
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/javax/swing/SpinnerNumberModel.class
