...
/* 537 */     this.clientList = new ArrayList<>();
...
/*     */       if (this.env.get("jmx.remote.x.password.file") != null || this.env.get("jmx.remote.x.login.config") != null)
...
/*     */     dropDeadReferences();
/*     */     WeakReference<RMIConnection> weakReference = new WeakReference<>(rMIConnection);
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/javax/management/remote/rmi/RMIServerImpl.class
