...
/*     */         
/* 307 */         this.nc = i;
/* 308 */         this.dataOffset = 5; return;
/*     */       } 
/* 310 */       if (this.apdu.length == 6 + i) {
/*     */         
/* 312 */         this.nc = i;
/* 313 */         this.dataOffset = 5;
/* 314 */         int k = this.apdu[this.apdu.length - 1] & 0xFF;
/* 315 */         this.ne = (k == 0) ? 256 : k;
/*     */         return;
/*     */       } 
...
/* 415 */           b2 = 0;
/*     */         } else {
/* 417 */           b1 = (byte)(paramInt7 >> 8);
/* 418 */           b2 = (byte)paramInt7;
/*     */         } 
...
/* 584 */       return false;
/*     */     }
/* 586 */     CommandAPDU commandAPDU = (CommandAPDU)paramObject;
/* 587 */     return Arrays.equals(this.apdu, commandAPDU.apdu);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/javax/smartcardio/CommandAPDU.class
