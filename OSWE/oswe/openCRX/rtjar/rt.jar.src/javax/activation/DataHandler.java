...
/*     */       
/* 242 */       if (dch == null) {
/* 243 */         throw new UnsupportedDataTypeException("no DCH for MIME type " + 
/* 244 */             getBaseType());
/*     */       }
/* 246 */       if (dch instanceof ObjectDataContentHandler && (
/* 247 */         (ObjectDataContentHandler)dch).getDCH() == null) {
/* 248 */         throw new UnsupportedDataTypeException("no object DCH for MIME type " + 
/* 249 */             getBaseType());
/*     */       }
/*     */       
...
/*     */             public void run() {
/*     */               
/* 266 */               try { fdch.writeTo(DataHandler.this.object, DataHandler.this.objectMimeType, pos); }
/* 267 */               catch (IOException iOException)
/*     */               
/*     */               { 
/*     */                 try {
/* 271 */                   pos.close();
/* 272 */                 } catch (IOException iOException1) {} } finally { try { pos.close(); } catch (IOException iOException) {} }
/*     */ 
/*     */             
/*     */             }
...
/* 569 */     catch (ClassNotFoundException classNotFoundException) {}
/*     */     
/* 571 */     return bean;
/*     */   }
/*     */ 
...
/* 614 */         this
/* 615 */           .dataContentHandler = getCommandMap().createDataContentHandler(simpleMT, this.dataSource);
/*     */       } else {
/* 617 */         this
/* 618 */           .dataContentHandler = getCommandMap().createDataContentHandler(simpleMT);
/*     */       } 
/*     */     }
/*     */ 
/*     */     
...
/*     */ 
/*     */         
/* 679 */         if (DataHandler.class.getClassLoader() != newFactory
/* 680 */           .getClass().getClassLoader()) {
/* 681 */           throw ex;
/*     */         }
/*     */       }  
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/javax/activation/DataHandler.class
