...
/*     */ 
/*     */     
/*  85 */     int i = skipWhiteSpace(parameterList, 0); char c;
/*  86 */     for (; i < length && (c = parameterList.charAt(i)) == ';'; 
...
/*     */       }
/*     */       
/* 110 */       String name = parameterList.substring(lastIndex, i).toLowerCase(Locale.ENGLISH);
/*     */ 
/*     */       
...
/*     */ 
/*     */     
/* 247 */     Enumeration<String> keys = this.parameters.keys();
/* 248 */     while (keys.hasMoreElements()) {
/* 249 */       String key = keys.nextElement();
/* 250 */       buffer.append("; ");
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/javax/activation/MimeTypeParameterList.class
