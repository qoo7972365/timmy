...
/*     */       
/* 109 */       this
/* 110 */         .primaryType = rawdata.substring(0, slashIndex).trim().toLowerCase(Locale.ENGLISH);
/* 111 */       this
/* 112 */         .subType = rawdata.substring(slashIndex + 1).trim().toLowerCase(Locale.ENGLISH);
/* 113 */       this.parameters = new MimeTypeParameterList();
/* 114 */     } else if (slashIndex < semIndex) {
/*     */       
/* 116 */       this
/* 117 */         .primaryType = rawdata.substring(0, slashIndex).trim().toLowerCase(Locale.ENGLISH);
/* 118 */       this
/* 119 */         .subType = rawdata.substring(slashIndex + 1, semIndex).trim().toLowerCase(Locale.ENGLISH);
...
/* 249 */     return (this.primaryType.equals(type.getPrimaryType()) && (this.subType
/* 250 */       .equals("*") || type
/* 251 */       .getSubType().equals("*") || this.subType
/* 252 */       .equals(type.getSubType())));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/javax/activation/MimeType.class
