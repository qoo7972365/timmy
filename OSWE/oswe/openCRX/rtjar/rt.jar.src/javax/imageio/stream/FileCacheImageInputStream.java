...
/* 102 */       this.cacheFile = Files.createTempFile("imageio", ".tmp", (FileAttribute<?>[])new FileAttribute[0]).toFile();
/*     */     } else {
/* 104 */       this
/* 105 */         .cacheFile = Files.createTempFile(paramFile.toPath(), "imageio", ".tmp", (FileAttribute<?>[])new FileAttribute[0]).toFile();
...
/*     */ 
/*     */       
/* 142 */       int i = this.stream.read(this.buf, 0, (int)Math.min(l, 1024L));
/* 143 */       if (i == -1) {
...
/* 272 */       this.cacheFile = param1File;
/* 273 */       this.cache = param1RandomAccessFile;
/*     */     }
/*     */     
/*     */     public synchronized void dispose() {
/* 277 */       if (this.cache != null) {
/*     */         
/* 279 */         try { this.cache.close(); }
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/javax/imageio/stream/FileCacheImageInputStream.class
