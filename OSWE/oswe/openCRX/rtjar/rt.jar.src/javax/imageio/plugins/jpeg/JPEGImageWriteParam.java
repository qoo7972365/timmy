...
/*  98 */   private String[] compressionNames = new String[] { "JPEG" };
/*  99 */   private float[] qualityVals = new float[] { 0.0F, 0.3F, 0.75F, 1.0F };
/* 100 */   private String[] qualityDescs = new String[] { "Low quality", "Medium quality", "Visually lossless" };
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 267 */     return (this.DCHuffmanTables != null) ? (JPEGHuffmanTable[])this.DCHuffmanTables
/* 268 */       .clone() : null;
/*     */   }
/*     */ 
/*     */ 
...
/* 283 */     return (this.ACHuffmanTables != null) ? (JPEGHuffmanTable[])this.ACHuffmanTables
/* 284 */       .clone() : null;
/*     */   }
/*     */ 
/*     */ 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/javax/imageio/plugins/jpeg/JPEGImageWriteParam.class
