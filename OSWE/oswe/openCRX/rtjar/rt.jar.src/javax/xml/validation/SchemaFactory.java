...
/* 205 */     ClassLoader cl = ss.getContextClassLoader();
/*     */     
/* 207 */     if (cl == null)
/*     */     {
/*     */       
...
/* 214 */     if (f == null) {
/* 215 */       throw new IllegalArgumentException("No SchemaFactory that implements the schema language specified by: " + schemaLanguage + " could be loaded");
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 273 */     if (f == null) {
/* 274 */       throw new IllegalArgumentException("Factory " + factoryClassName + " could not be loaded to implement the schema language specified by: " + schemaLanguage);
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 280 */       return f;
/*     */     }
/* 282 */     throw new IllegalArgumentException("Factory " + f
/* 283 */         .getClass().getName() + " does not implement the schema language specified by: " + schemaLanguage);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/javax/xml/validation/SchemaFactory.class
