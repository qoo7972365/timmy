...
/*     */   static {
/*     */     try {
/* 110 */       String valueUseCompatibleSerialVersionUID = AccessController.<String>doPrivileged(new PrivilegedAction<String>()
/*     */           {
/*     */             public Object run() {
...
/*     */     
/* 369 */     return (this.localPart.equals(qName.localPart) && this.namespaceURI
/* 370 */       .equals(qName.namespaceURI));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 493 */       throw new IllegalArgumentException("Namespace URI .equals(XMLConstants.NULL_NS_URI), .equals(\"\"), only the local part, \"" + qNameAsString
/*     */ 
/*     */ 
/*     */ 
/*     */           
/* 498 */           .substring(2 + "".length()) + "\", should be provided.");
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 511 */     return new QName(qNameAsString
/* 512 */         .substring(1, endOfNamespaceURI), qNameAsString
/* 513 */         .substring(endOfNamespaceURI + 1), "");
/*     */   }
/*     */ }


/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/javax/xml/namespace/QName.class
