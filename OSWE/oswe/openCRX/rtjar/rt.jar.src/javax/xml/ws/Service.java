...
/*  77 */     this.delegate = Provider.provider().createServiceDelegate(wsdlDocumentLocation, serviceName, 
/*     */         
/*  79 */         getClass());
/*     */   }
/*     */   
/*     */   protected Service(URL wsdlDocumentLocation, QName serviceName, WebServiceFeature... features) {
/*  83 */     this.delegate = Provider.provider().createServiceDelegate(wsdlDocumentLocation, serviceName, 
/*     */         
/*  85 */         getClass(), features);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 119 */     return (T)this.delegate.getPort(portName, serviceEndpointInterface);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 160 */     return (T)this.delegate.getPort(portName, serviceEndpointInterface, features);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 188 */     return (T)this.delegate.getPort(serviceEndpointInterface);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 226 */     return (T)this.delegate.getPort(serviceEndpointInterface, features);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 304 */     return (T)this.delegate.getPort(endpointReference, serviceEndpointInterface, features);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/javax/xml/ws/Service.class
