...
/* 110 */         getClass().getName() + "\", does not support the reset functionality.  Specification \"" + 
/* 111 */         getClass().getPackage().getSpecificationTitle() + "\" version \"" + 
/* 112 */         getClass().getPackage().getSpecificationVersion() + "\"");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 522 */     throw new UnsupportedOperationException("This parser does not support specification \"" + 
/*     */         
/* 524 */         getClass().getPackage().getSpecificationTitle() + "\" version \"" + 
/*     */         
/* 526 */         getClass().getPackage().getSpecificationVersion() + "\"");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 547 */     throw new UnsupportedOperationException("This parser does not support specification \"" + 
/*     */         
/* 549 */         getClass().getPackage().getSpecificationTitle() + "\" version \"" + 
/*     */         
/* 551 */         getClass().getPackage().getSpecificationVersion() + "\"");
/*     */   }
/*     */ }


/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/javax/xml/parsers/SAXParser.class
