...
/*  83 */     super(message);
/*  84 */     if (locator != null) {
/*  85 */       init(locator.getPublicId(), locator.getSystemId(), locator
/*  86 */           .getLineNumber(), locator.getColumnNumber());
/*     */     } else {
...
/* 110 */     super(message, e);
/* 111 */     if (locator != null) {
/* 112 */       init(locator.getPublicId(), locator.getSystemId(), locator
/* 113 */           .getLineNumber(), locator.getColumnNumber());
/*     */     } else {
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/org/xml/sax/SAXParseException.class
