...
/*  512 */     Vector<SAXException> exceptions = null;
/*      */ 
/*      */ 
/*      */     
...
/*  532 */       String prefix, attQName = qAtts.getName(i);
/*      */       
...
/*      */         
/*  583 */         if (prefix != null) {
/*  584 */           if (this.prefixes) {
/*  585 */             if (this.uris) {
/*      */ 
/*      */ 
/*      */               
/*  589 */               this.atts.addAttribute("http://www.w3.org/XML/1998/namespace", prefix, attQName
/*  590 */                   .intern(), type, value);
/*      */             } else {
/*  592 */               this.atts.addAttribute("", "", attQName
/*  593 */                   .intern(), type, value);
/*      */             } 
/*      */           }
/*      */           
/*      */           continue;
...
/*  614 */       for (i = 0; i < exceptions.size(); i++) {
/*  615 */         this.errorHandler.error((SAXParseException)exceptions
/*  616 */             .elementAt(i));
/*      */       }
/*      */     }
/*      */     
...
/*  652 */       Enumeration<String> prefixes = this.nsSupport.getDeclaredPrefixes();
/*  653 */       while (prefixes.hasMoreElements()) {
/*  654 */         String prefix = prefixes.nextElement();
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/org/xml/sax/helpers/ParserAdapter.class
