    ...
    if (!Util.isLocal(this)) {
      try {
        ...
        try {
          ...
          _invoke((OutputStream)outputStream);
          ...
          _releaseReply((InputStream)inputStream);
        } 
    ...
    if (!Util.isLocal(this))
      try {
        ...
        try {
          ...
          inputStream = (InputStream)_invoke((OutputStream)outputStream);
    ...
    if (!Util.isLocal(this))
      try {
        ...
        try {
          ...
          outputStream.write_value(paramSubject, Subject.class);
          inputStream = (InputStream)_invoke((OutputStream)outputStream);
          return Util.readAny((InputStream)inputStream);
        } catch (ApplicationException applicationException) {
          inputStream = (InputStream)applicationException.getInputStream();
          String str = inputStream.read_string();
          if (str.equals("IDL:javax/management/MBeanEx:1.0"))
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/org/omg/stub/javax/management/remote/rmi/_RMIConnection_Stub.class
