...
/* 50 */   public int get_request() { log.finest(""); return Native.getInt(this.pData + 40L); }
/* 51 */   public void set_request(int paramInt) { log.finest(""); Native.putInt(this.pData + 40L, paramInt); }
/* 52 */   public int get_first_keycode() { log.finest(""); return Native.getInt(this.pData + 44L); }
/* 53 */   public void set_first_keycode(int paramInt) { log.finest(""); Native.putInt(this.pData + 44L, paramInt); }
/* 54 */   public int get_count() { log.finest(""); return Native.getInt(this.pData + 48L); } public void set_count(int paramInt) {
/* 55 */     log.finest(""); Native.putInt(this.pData + 48L, paramInt);
/*    */   }
/*    */   
/*    */   String getName() {
...
/* 71 */     stringBuilder.append("request = ").append(get_request()).append(", ");
/* 72 */     stringBuilder.append("first_keycode = ").append(get_first_keycode()).append(", ");
/* 73 */     stringBuilder.append("count = ").append(get_count()).append(", ");
/* 74 */     return stringBuilder.toString();
/*    */   }
/*    */ }


/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/sun/awt/X11/XMappingEvent.class
