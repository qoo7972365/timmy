...
/*    */   }
/*    */   
/*    */   public XCreateWindowEvent(long paramLong) {
...
/* 62 */   public boolean get_override_redirect() { log.finest(""); return Native.getBool(this.pData + 68L); } public void set_override_redirect(boolean paramBoolean) {
/* 63 */     log.finest(""); Native.putBool(this.pData + 68L, paramBoolean);
/*    */   }
/*    */   
/*    */   String getName() {
/* 67 */     return "XCreateWindowEvent";
/*    */   }
/*    */ 
/*    */   
...
/* 78 */     stringBuilder.append("parent = ").append(get_parent()).append(", ");
/* 79 */     stringBuilder.append("window = ").append(getWindow(get_window())).append(", ");
/* 80 */     stringBuilder.append("x = ").append(get_x()).append(", ");
/* 81 */     stringBuilder.append("y = ").append(get_y()).append(", ");
/* 82 */     stringBuilder.append("width = ").append(get_width()).append(", ");
/* 83 */     stringBuilder.append("height = ").append(get_height()).append(", ");
/* 84 */     stringBuilder.append("border_width = ").append(get_border_width()).append(", ");
/* 85 */     stringBuilder.append("override_redirect = ").append(get_override_redirect()).append(", ");
/* 86 */     return stringBuilder.toString();
/*    */   }
/*    */ }


/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/sun/awt/X11/XCreateWindowEvent.class
