...
/* 52 */   public long get_time() { log.finest(""); return Native.getULong(this.pData + 48L); } public void set_time(long paramLong) {
/* 53 */     log.finest(""); Native.putULong(this.pData + 48L, paramLong);
/*    */   }
/*    */   
/*    */   String getName() {
...
/* 69 */     stringBuilder.append("selection = ").append(XAtom.get(get_selection())).append(", ");
/* 70 */     stringBuilder.append("time = ").append(get_time()).append(", ");
/* 71 */     return stringBuilder.toString();
/*    */   }
/*    */ }


/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/sun/awt/X11/XSelectionClearEvent.class
