...
/*    */   }
/*    */   
/*    */   public XFocusChangeEvent(long paramLong) {
...
/* 50 */   public int get_mode() { log.finest(""); return Native.getInt(this.pData + 40L); }
/* 51 */   public void set_mode(int paramInt) { log.finest(""); Native.putInt(this.pData + 40L, paramInt); }
/* 52 */   public int get_detail() { log.finest(""); return Native.getInt(this.pData + 44L); } public void set_detail(int paramInt) {
/* 53 */     log.finest(""); Native.putInt(this.pData + 44L, paramInt);
/*    */   }
/*    */   
/*    */   String getName() {
/* 57 */     return "XFocusChangeEvent";
/*    */   }
/*    */ 
/*    */   
...
/* 68 */     stringBuilder.append("window = ").append(getWindow(get_window())).append(", ");
/* 69 */     stringBuilder.append("mode = ").append(get_mode()).append(", ");
/* 70 */     stringBuilder.append("detail = ").append(get_detail()).append(", ");
/* 71 */     return stringBuilder.toString();
/*    */   }
/*    */ }


/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/sun/awt/X11/XFocusChangeEvent.class
