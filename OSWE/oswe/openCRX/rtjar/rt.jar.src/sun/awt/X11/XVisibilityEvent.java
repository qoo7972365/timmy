...
/* 50 */   public int get_state() { log.finest(""); return Native.getInt(this.pData + 40L); } public void set_state(int paramInt) {
/* 51 */     log.finest(""); Native.putInt(this.pData + 40L, paramInt);
/*    */   }
/*    */   
/*    */   String getName() {
...
/* 66 */     stringBuilder.append("window = ").append(getWindow(get_window())).append(", ");
/* 67 */     stringBuilder.append("state = ").append(get_state()).append(", ");
/* 68 */     return stringBuilder.toString();
/*    */   }
/*    */ }


/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/sun/awt/X11/XVisibilityEvent.class
