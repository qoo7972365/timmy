...
/*    */ 
/*    */ public class XkbCompatMapNotifyEvent
...
/*    */   }
/*    */   
/*    */   public XkbCompatMapNotifyEvent(long paramLong) {
...
/* 54 */   public int get_changed_groups() { log.finest(""); return Native.getInt(this.pData + 48L); }
/* 55 */   public void set_changed_groups(int paramInt) { log.finest(""); Native.putInt(this.pData + 48L, paramInt); }
/* 56 */   public int get_first_si() { log.finest(""); return Native.getInt(this.pData + 52L); }
/* 57 */   public void set_first_si(int paramInt) { log.finest(""); Native.putInt(this.pData + 52L, paramInt); }
/* 58 */   public int get_num_si() { log.finest(""); return Native.getInt(this.pData + 56L); }
/* 59 */   public void set_num_si(int paramInt) { log.finest(""); Native.putInt(this.pData + 56L, paramInt); }
/* 60 */   public int get_num_total_si() { log.finest(""); return Native.getInt(this.pData + 60L); } public void set_num_total_si(int paramInt) {
/* 61 */     log.finest(""); Native.putInt(this.pData + 60L, paramInt);
/*    */   }
/*    */   
/*    */   String getName() {
/* 65 */     return "XkbCompatMapNotifyEvent";
/*    */   }
/*    */ 
/*    */   
...
/* 79 */     stringBuilder.append("changed_groups = ").append(get_changed_groups()).append(", ");
/* 80 */     stringBuilder.append("first_si = ").append(get_first_si()).append(", ");
/* 81 */     stringBuilder.append("num_si = ").append(get_num_si()).append(", ");
/* 82 */     stringBuilder.append("num_total_si = ").append(get_num_total_si()).append(", ");
/* 83 */     return stringBuilder.toString();
/*    */   }
/*    */ }


/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/sun/awt/X11/XkbCompatMapNotifyEvent.class
