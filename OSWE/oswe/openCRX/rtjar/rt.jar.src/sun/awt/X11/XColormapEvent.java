...
/* 50 */   public long get_colormap() { log.finest(""); return Native.getLong(this.pData + 40L); }
/* 51 */   public void set_colormap(long paramLong) { log.finest(""); Native.putLong(this.pData + 40L, paramLong); }
/* 52 */   public boolean get_new() { log.finest(""); return Native.getBool(this.pData + 48L); }
/* 53 */   public void set_new(boolean paramBoolean) { log.finest(""); Native.putBool(this.pData + 48L, paramBoolean); }
/* 54 */   public int get_state() { log.finest(""); return Native.getInt(this.pData + 52L); } public void set_state(int paramInt) {
...
/* 71 */     stringBuilder.append("colormap = ").append(get_colormap()).append(", ");
/* 72 */     stringBuilder.append("new = ").append(get_new()).append(", ");
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/sun/awt/X11/XColormapEvent.class
