...
/*    */   }
/*    */   
/*    */   public XNoExposeEvent(long paramLong) {
...
/* 50 */   public int get_major_code() { log.finest(""); return Native.getInt(this.pData + 40L); }
/* 51 */   public void set_major_code(int paramInt) { log.finest(""); Native.putInt(this.pData + 40L, paramInt); }
/* 52 */   public int get_minor_code() { log.finest(""); return Native.getInt(this.pData + 44L); } public void set_minor_code(int paramInt) {
/* 53 */     log.finest(""); Native.putInt(this.pData + 44L, paramInt);
/*    */   }
/*    */   
/*    */   String getName() {
/* 57 */     return "XNoExposeEvent";
/*    */   }
/*    */ 
/*    */   
...
/* 68 */     stringBuilder.append("drawable = ").append(get_drawable()).append(", ");
/* 69 */     stringBuilder.append("major_code = ").append(get_major_code()).append(", ");
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/sun/awt/X11/XNoExposeEvent.class
