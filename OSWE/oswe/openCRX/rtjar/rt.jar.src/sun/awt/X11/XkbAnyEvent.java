...
/* 52 */   public int get_device() { log.finest(""); return Native.getInt(this.pData + 44L); } public void set_device(int paramInt) {
...
/* 68 */     stringBuilder.append("time = ").append(get_time()).append(", ");
/* 69 */     stringBuilder.append("xkb_type = ").append(get_xkb_type()).append(", ");
/* 70 */     stringBuilder.append("device = ").append(get_device()).append(", ");
/* 71 */     return stringBuilder.toString();
/*    */   }
/*    */ }


/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/sun/awt/X11/XkbAnyEvent.class
