...
/* 50 */   public int get_width() { log.finest(""); return Native.getInt(this.pData + 40L); }
/* 51 */   public void set_width(int paramInt) { log.finest(""); Native.putInt(this.pData + 40L, paramInt); }
/* 52 */   public int get_height() { log.finest(""); return Native.getInt(this.pData + 44L); } public void set_height(int paramInt) {
...
/* 69 */     stringBuilder.append("width = ").append(get_width()).append(", ");
/* 70 */     stringBuilder.append("height = ").append(get_height()).append(", ");
/* 71 */     return stringBuilder.toString();
/*    */   }
/*    */ }


/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/sun/awt/X11/XResizeRequestEvent.class
