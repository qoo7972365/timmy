...
/*     */     
/* 146 */     if (this.elementData.getClass() != Object[].class) {
/* 147 */       this.elementData = Arrays.copyOf(this.elementData, this.size, Object[].class);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 222 */     for (byte b = 0; b < this.size; b++) {
/* 223 */       if (paramObject == this.elementData[b]) {
/* 224 */         return b;
/*     */       }
/*     */     } 
/* 227 */     return -1;
...
/*     */     {
/* 291 */       return (T[])Arrays.<Object, Object>copyOf(this.elementData, this.size, (Class)paramArrayOfT.getClass()); } 
...
/*     */     
/* 310 */     return (E)this.elementData[paramInt];
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/* 325 */     Object object = this.elementData[paramInt];
...
/*     */     
/* 373 */     this.modCount++;
/* 374 */     Object object = this.elementData[paramInt];
/*     */     
...
/* 399 */     for (byte b = 0; b < this.size; b++) {
/* 400 */       if (paramObject == this.elementData[b]) {
/* 401 */         fastRemove(b);
/* 402 */         return true;
/*     */       } 
/*     */     } 
...
/*     */ 
/*     */     
/* 429 */     for (byte b = 0; b < this.size; b++) {
/* 430 */       this.elementData[b] = null;
/*     */     }
/* 432 */     this.size = 0;
/*     */   }
/*     */ 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/sun/awt/util/IdentityArrayList.class
