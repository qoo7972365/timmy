...
/* 158 */     double d5, d6, d7, d8, d1 = paramCrossings.getXLo();
...
/*     */     }
/* 223 */     Order1 order1 = (Order1)paramCurve;
/* 224 */     if (paramArrayOfdouble[1] <= paramArrayOfdouble[0]) {
/* 225 */       throw new InternalError("yrange already screwed up...");
/*     */     }
/* 227 */     paramArrayOfdouble[1] = Math.min(Math.min(paramArrayOfdouble[1], this.y1), order1.y1);
...
/*     */     }
/* 231 */     if (this.xmax <= order1.xmin) {
/* 232 */       return (this.xmin == order1.xmax) ? 0 : -1;
/*     */     }
/* 234 */     if (this.xmin >= order1.xmax) {
/* 235 */       return 1;
/*     */     }
/*     */ 
/*     */ 
...
/* 271 */     double d3 = order1.x1 - order1.x0;
/* 272 */     double d4 = order1.y1 - order1.y0;
/* 273 */     double d5 = d3 * d2 - d1 * d4;
/*     */     
/* 275 */     if (d5 != 0.0D) {
/* 276 */       double d = (this.x0 - order1.x0) * d2 * d4 - this.y0 * d1 * d4 + order1.y0 * d3 * d2;
/*     */ 
/*     */       
/* 279 */       d6 = d / d5;
...
/*     */ 
/*     */         
/* 283 */         d6 = Math.min(this.y1, order1.y1);
/*     */       } else {
/*     */         
...
/*     */         }
/*     */         
/* 291 */         d6 = Math.max(this.y0, order1.y0);
/*     */       }
/*     */     
/*     */     }
/*     */     else {
/*     */       
/* 297 */       d6 = Math.max(this.y0, order1.y0);
/*     */     } 
/* 299 */     return orderof(XforY(d6), order1.XforY(d6));
/*     */   }
/*     */   
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/sun/awt/geom/Order1.class
