...
/* 131 */     this.params = (String[])paramVarArgs.clone();
/*     */   }
/*     */   
/*     */   public AgentConfigurationError(String paramString, Throwable paramThrowable, String... paramVarArgs) {
/* 135 */     super(paramThrowable);
/* 136 */     this.error = paramString;
/* 137 */     this.params = (String[])paramVarArgs.clone();
/*     */   }
/*     */   
...
/* 145 */     return (String[])this.params.clone();
/*     */   }
/*     */ }


/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/sun/management/AgentConfigurationError.class
