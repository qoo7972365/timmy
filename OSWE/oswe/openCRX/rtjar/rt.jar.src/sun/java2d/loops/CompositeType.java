...
/*     */ 
/*     */   
/* 174 */   public static final CompositeType OpaqueSrcOverNoEa = SrcOverNoEa.deriveSubType("Porter-Duff Src")
/* 175 */     .deriveSubType("Porter-Duff Src, No Extra Alpha");
/*     */ 
/*     */   
...
/* 246 */     Integer integer = compositeUIDMap.get(paramString);
/*     */     
/* 248 */     if (integer == null) {
/* 249 */       if (unusedUID > 255) {
/* 250 */         throw new InternalError("composite type id overflow");
/*     */       }
/* 252 */       integer = Integer.valueOf(unusedUID++);
/* 253 */       compositeUIDMap.put(paramString, integer);
/*     */     } 
/* 255 */     return integer.intValue();
/*     */   }
/*     */   
...
/* 275 */     CompositeType compositeType = this;
/*     */     while (true) {
/* 277 */       if (compositeType.desc == paramCompositeType.desc) {
/* 278 */         return true;
/*     */       }
/* 280 */       compositeType = compositeType.next;
/* 281 */       if (compositeType == null)
/* 282 */         return false; 
/*     */     } 
/*     */   }
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/sun/java2d/loops/CompositeType.class
