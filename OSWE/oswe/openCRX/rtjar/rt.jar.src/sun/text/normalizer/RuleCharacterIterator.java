...
/*     */         
/* 171 */         String str = this.sym.parseReference(this.text, this.pos, this.text.length());
/*     */ 
/*     */         
/* 174 */         if (str == null) {
/*     */           break;
/*     */         }
/* 177 */         this.bufPos = 0;
/* 178 */         this.buf = this.sym.lookup(str);
/* 179 */         if (this.buf == null) {
/* 180 */           throw new IllegalArgumentException("Undefined variable: " + str);
/*     */         }
/*     */ 
/*     */         
...
/*     */         continue;
/*     */       } 
/* 190 */       if ((paramInt & 0x4) != 0 && 
/* 191 */         UCharacterProperty.isRuleWhiteSpace(i)) {
/*     */         continue;
/*     */       }
/*     */       
/* 195 */       if (i == 92 && (paramInt & 0x2) != 0) {
/* 196 */         int[] arrayOfInt = { 0 };
/* 197 */         i = Utility.unescapeAt(lookahead(), arrayOfInt);
/* 198 */         jumpahead(arrayOfInt[0]);
...
/*     */       while (true) {
/* 283 */         int i = _current();
/* 284 */         if (!UCharacterProperty.isRuleWhiteSpace(i))
/* 285 */           break;  _advance(UTF16.getCharCount(i));
/*     */       } 
/*     */     }
/*     */   }
/*     */ 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/sun/text/normalizer/RuleCharacterIterator.class
