...
/* 319 */       return false; 
/* 320 */     KeepAliveKey keepAliveKey = (KeepAliveKey)paramObject;
/* 321 */     return (this.host.equals(keepAliveKey.host) && this.port == keepAliveKey.port && this.protocol
/*     */       
/* 323 */       .equals(keepAliveKey.protocol) && this.obj == keepAliveKey.obj);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 334 */     return (this.obj == null) ? str.hashCode() : (str
/* 335 */       .hashCode() + this.obj.hashCode());
/*     */   }
/*     */ }


/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/sun/net/www/http/KeepAliveKey.class
