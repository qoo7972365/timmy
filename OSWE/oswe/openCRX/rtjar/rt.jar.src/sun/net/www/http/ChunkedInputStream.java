...
/*     */       int i; int j; String str1; int k; String str2; String str3; String str4;
...
/*     */ 
/*     */           
/* 310 */           str1 = new String(this.rawData, this.rawPos, i - this.rawPos + 1, "US-ASCII");
...
/*     */ 
/*     */           
/* 355 */           k = Math.min(this.chunkSize - this.chunkRead, this.rawCount - this.rawPos);
/*     */ 
/*     */ 
/*     */ 
/*     */           
...
/* 363 */               byte[] arrayOfByte = new byte[m + k];
/* 364 */               System.arraycopy(this.chunkData, this.chunkPos, arrayOfByte, 0, m);
/* 365 */               this.chunkData = arrayOfByte;
/*     */             } else {
...
/*     */ 
/*     */           
/* 464 */           str2 = new String(this.rawData, this.rawPos, i - this.rawPos, "US-ASCII");
/* 465 */           j = str2.indexOf(':');
/* 466 */           if (j == -1) {
/* 467 */             throw new IOException("Malformed tailer - format should be key:value");
/*     */           }
/* 469 */           str3 = str2.substring(0, j).trim();
/* 470 */           str4 = str2.substring(j + 1, str2.length()).trim();
/*     */           
/* 472 */           this.responses.add(str3, str4);
/*     */ 
/*     */ 
/*     */ 
/*     */           
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/sun/net/www/http/ChunkedInputStream.class
