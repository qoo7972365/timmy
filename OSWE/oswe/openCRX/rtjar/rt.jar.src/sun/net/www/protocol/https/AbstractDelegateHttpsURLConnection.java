...
/*     */ {
/*     */   protected AbstractDelegateHttpsURLConnection(URL paramURL, Handler paramHandler) throws IOException {
/*  50 */     this(paramURL, (Proxy)null, paramHandler);
/*     */   }
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/*     */   public void setNewClient(URL paramURL) throws IOException {
...
/*  96 */     this.http = HttpsClient.New(getSSLSocketFactory(), paramURL, 
/*     */         
/*  98 */         getHostnameVerifier(), paramBoolean, this);
/*     */     
...
/*     */ 
/*     */   
/*     */   public void setProxiedClient(URL paramURL, String paramString, int paramInt) throws IOException {
...
/*     */       return; 
/* 149 */     this.http = HttpsClient.New(getSSLSocketFactory(), paramURL, 
/*     */         
/* 151 */         getHostnameVerifier(), paramString, paramInt, paramBoolean, this);
/*     */     
...
/* 191 */     return HttpsClient.New(getSSLSocketFactory(), paramURL, 
/* 192 */         getHostnameVerifier(), paramProxy, true, paramInt, this);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 200 */     return HttpsClient.New(getSSLSocketFactory(), paramURL, 
/* 201 */         getHostnameVerifier(), paramProxy, paramBoolean, paramInt, this);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 225 */       List<Certificate> list = ((SecureCacheResponse)this.cachedResponse).getLocalCertificateChain();
/* 226 */       if (list == null) {
/* 227 */         return null;
/*     */       }
/* 229 */       return list.<Certificate>toArray(new Certificate[0]);
/*     */     } 
/*     */     
...
/* 247 */       List<Certificate> list = ((SecureCacheResponse)this.cachedResponse).getServerCertificateChain();
/* 248 */       if (list == null) {
/* 249 */         return null;
/*     */       }
/* 251 */       return list.<Certificate>toArray(new Certificate[0]);
/*     */     } 
/*     */ 
/*     */     
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/sun/net/www/protocol/https/AbstractDelegateHttpsURLConnection.class
