...
/* 387 */     return (this.u1.hasMoreElements() || this.u2
/* 388 */       .hasMoreElements() || this.g1
/* 389 */       .hasMoreElements() || this.g2
/* 390 */       .hasMoreElements());
/*     */   }
/*     */ 
/*     */ 
...
/* 398 */         return this.u1.nextElement(); 
/* 399 */       if (this.u2.hasMoreElements())
/* 400 */         return this.u2.nextElement(); 
/* 401 */       if (this.g1.hasMoreElements())
/* 402 */         return this.g1.nextElement(); 
/* 403 */       if (this.g2.hasMoreElements())
/* 404 */         return this.g2.nextElement(); 
/*     */     } 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/sun/security/acl/AclEnumerator.class
