...
/*     */   public Object clone() {
/*     */     try {
/*  49 */       crc32 crc321 = (crc32)super.clone();
/*  50 */       crc321.init();
/*  51 */       return crc321;
/*     */     }
/*  53 */     catch (CloneNotSupportedException cloneNotSupportedException) {
/*     */       
/*  55 */       return null;
/*     */     } 
/*     */   }
...
/* 198 */     int i = this.seed;
/* 199 */     for (byte b = 0; b < paramInt2; b++)
/* 200 */       i = i >>> 8 ^ crc32Table[(i ^ paramArrayOfbyte[b]) & 0xFF]; 
/* 201 */     this.seed = i;
/*     */   }
/*     */   
...
/* 218 */     String str = "00000000";
/*     */     
/* 220 */     System.out.print("\tpublic static int[] crc32Table = {");
/* 221 */     for (byte b = 0; b < 'Ā'; b++) {
/* 222 */       if (b % 4 == 0)
/* 223 */         System.out.print("\n\t\t"); 
/* 224 */       String str1 = Integer.toHexString(int2crc32(b));
/* 225 */       System.out.print("0x" + str
/* 226 */           .substring(str1.length()) + str1);
/* 227 */       if (b != 'ÿ')
...
/* 237 */       i = i >>> 8 ^ crc32Table[(i ^ paramArrayOfbyte[b]) & 0xFF]; 
/* 238 */     return i;
/*     */   }
/*     */   
...
/* 271 */     for (byte b = 0; b < 4; b++) {
/* 272 */       arrayOfByte[b] = (byte)(int)(paramLong >>> b * 8 & 0xFFL);
/*     */     }
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/sun/security/krb5/internal/crypto/crc32.class
