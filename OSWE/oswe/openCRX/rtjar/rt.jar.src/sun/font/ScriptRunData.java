...
/*     */   
/*     */   public static final int getScript(int paramInt) {
/*  44 */     if (paramInt >= data[cache] && paramInt < data[cache + 2]) {
/*  45 */       return data[cache + 1];
/*     */     }
/*  47 */     if (paramInt >= 0 && paramInt < 1114112) {
/*  48 */       int i = 1024;
/*  49 */       int j = 0;
/*     */       
/*  51 */       if (paramInt >= data[dataExtra]) {
/*  52 */         j = dataExtra;
/*     */       }
/*     */       
/*  55 */       while (i > 2) {
/*  56 */         i >>= 1;
/*  57 */         if (paramInt >= data[j + i]) {
/*  58 */           j += i;
/*     */         }
/*     */       } 
/*     */       
...
/*     */ 
/*     */   
/* 794 */   private static final int dataExtra = data.length - 1024;
/*     */ }


/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/sun/font/ScriptRunData.class
