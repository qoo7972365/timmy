...
/* 168 */       boolean bool = (k == 0) ? getPairIndex(j) : true;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */           } 
/*     */           
/* 186 */           this.stack[this.parenSP++] = bool;
/* 187 */           this.stack[this.parenSP++] = this.scriptCode;
/* 188 */         } else if (this.parenSP > 0) {
/* 189 */           int m = bool & 0xFFFFFFFE;
/*     */           
/* 191 */           while ((this.parenSP -= 2) >= 0 && this.stack[this.parenSP] != m);
/*     */           
...
/*     */ 
/*     */         
/* 218 */         if (bool && (bool & true) != 0 && this.parenSP > 0) {
/* 219 */           this.parenSP -= 2;
/*     */         }
/*     */         
/*     */         continue;
...
/* 251 */       char c = this.text[this.scriptLimit];
/* 252 */       if (c >= '?' && c < '') {
/* 253 */         this.scriptLimit++;
/* 254 */         i = (i << 10) + c + -56613888;
/*     */       } 
/*     */     } 
/* 257 */     return i;
/*     */   }
...
/*     */ 
/*     */   
/* 357 */   private static int[] pairedChars = new int[] { 40, 41, 60, 62, 91, 93, 123, 125, 171, 187, 8216, 8217, 8220, 8221, 8249, 8250, 12296, 12297, 12298, 12299, 12300, 12301, 12302, 12303, 12304, 12305, 12308, 12309, 12310, 12311, 12312, 12313, 12314, 12315 };
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/sun/font/ScriptRun.class
