...
/* 174 */     if (this.nativeScaler != 0L) {
/* 175 */       disposeNativeScaler(this.font.get(), this.nativeScaler);
/* 176 */       this.nativeScaler = 0L;
/*     */     } 
/*     */   }
/*     */   
/*     */   public synchronized void disposeScaler() {
/* 181 */     if (this.nativeScaler != 0L)
/*     */     {
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */       
/* 191 */       (new Thread(null, () -> dispose(), "free scaler", 0L)).start();
/*     */     }
/*     */   }
/*     */   
/*     */   synchronized int getNumGlyphs() throws FontScalerException {
/* 196 */     if (this.nativeScaler != 0L) {
/* 197 */       return getNumGlyphsNative(this.nativeScaler);
/*     */     }
/* 199 */     return FontScaler.getNullScaler().getNumGlyphs();
/*     */   }
/*     */   
/*     */   synchronized int getMissingGlyphCode() throws FontScalerException {
/* 203 */     if (this.nativeScaler != 0L) {
/* 204 */       return getMissingGlyphCodeNative(this.nativeScaler);
/*     */     }
/* 206 */     return FontScaler.getNullScaler().getMissingGlyphCode();
/*     */   }
/*     */   
/*     */   synchronized int getGlyphCode(char paramChar) throws FontScalerException {
/* 210 */     if (this.nativeScaler != 0L) {
/* 211 */       return getGlyphCodeNative(this.font.get(), this.nativeScaler, paramChar);
/*     */     }
/* 213 */     return FontScaler.getNullScaler().getGlyphCode(paramChar);
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   synchronized Point2D.Float getGlyphPoint(long paramLong, int paramInt1, int paramInt2) throws FontScalerException {
/* 219 */     if (this.nativeScaler != 0L) {
/* 220 */       return getGlyphPointNative(this.font.get(), paramLong, this.nativeScaler, paramInt1, paramInt2);
/*     */     }
/*     */     
/* 223 */     return FontScaler.getNullScaler().getGlyphPoint(paramLong, paramInt1, paramInt2);
/*     */   }
/*     */ 
/*     */   
/*     */   synchronized long getUnitsPerEm() {
/* 228 */     return getUnitsPerEMNative(this.nativeScaler);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 234 */     if (this.nativeScaler != 0L) {
/* 235 */       return createScalerContextNative(this.nativeScaler, paramArrayOfdouble, paramInt1, paramInt2, paramFloat1, paramFloat2);
/*     */     }
/*     */     
/* 238 */     return NullFontScaler.getNullScalerContext();
/*     */   }
/*     */   
...
/*     */   
/*     */   private native long createScalerContextNative(long paramLong, double[] paramArrayOfdouble, int paramInt1, int paramInt2, float paramFloat1, float paramFloat2);
/*     */ }


/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/sun/font/FreetypeFontScaler.class
