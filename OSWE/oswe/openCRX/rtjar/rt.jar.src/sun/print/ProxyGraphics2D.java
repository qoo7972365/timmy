...
/*  901 */       BufferedImage bufferedImage = getBufferedImageCopy(paramImage, paramColor);
/*  902 */       bool = this.mGraphics.drawImage(bufferedImage, paramInt1, paramInt2, (ImageObserver)null);
/*      */     } else {
...
/*  961 */       BufferedImage bufferedImage = getBufferedImageCopy(paramImage, paramColor);
/*  962 */       bool = this.mGraphics.drawImage(bufferedImage, paramInt1, paramInt2, paramInt3, paramInt4, null);
/*      */     } else {
...
/* 1092 */       BufferedImage bufferedImage = getBufferedImageCopy(paramImage, paramColor);
/* 1093 */       bool = this.mGraphics.drawImage(bufferedImage, paramInt1, paramInt2, paramInt3, paramInt4, paramInt6, paramInt6, paramInt7, paramInt8, null);
/*      */     
/*      */     }
/*      */     else {
/*      */       
...
/* 1121 */     AffineTransform affineTransform = getTransform();
/*      */     
/* 1123 */     return ((affineTransform.getType() & 0x30) != 0);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1141 */     BufferedImage bufferedImage = null;
/*      */     
...
/* 1155 */         BufferedImage bufferedImage1 = (BufferedImage)paramImage;
/* 1156 */         b = bufferedImage1.getType();
/*      */       } else {
/* 1158 */         b = 2;
/*      */       } 
/*      */       
/* 1161 */       bufferedImage = new BufferedImage(i, j, b);
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*      */       
/* 1168 */       Graphics2D graphics2D = bufferedImage.createGraphics();
/* 1169 */       graphics2D.drawImage(paramImage, 0, 0, paramColor, null);
/* 1170 */       graphics2D.dispose();
/*      */     
/*      */     }
/*      */     else {
/*      */ 
/*      */       
/* 1176 */       bufferedImage = null;
/*      */     } 
/*      */     
/* 1179 */     return bufferedImage;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     }
/*      */     
/* 1214 */     AffineTransform affineTransform1 = getTransform();
/* 1215 */     AffineTransform affineTransform2 = new AffineTransform(paramAffineTransform);
/* 1216 */     affineTransform2.concatenate(affineTransform1);
/*      */ 
/*      */     
/* 1219 */     RenderContext renderContext = new RenderContext(affineTransform2);
/*      */     
/*      */     try {
/* 1222 */       affineTransform3 = affineTransform1.createInverse();
/* 1223 */     } catch (NoninvertibleTransformException noninvertibleTransformException) {
/* 1224 */       renderContext = new RenderContext(affineTransform1);
/* 1225 */       affineTransform3 = new AffineTransform();
/*      */     } 
/*      */     
/* 1228 */     RenderedImage renderedImage = paramRenderableImage.createRendering(renderContext);
/* 1229 */     drawRenderedImage(renderedImage, affineTransform3);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/sun/print/ProxyGraphics2D.class
