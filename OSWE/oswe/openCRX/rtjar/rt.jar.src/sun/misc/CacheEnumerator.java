...
/* 334 */       if (this.entry == null)
/* 335 */         while (--this.index >= 0 && (this.entry = this.table[this.index]) == null); 
/* 336 */       if (this.entry != null) {
/* 337 */         CacheEntry cacheEntry = this.entry;
/* 338 */         this.entry = cacheEntry.next;
/* 339 */         if (cacheEntry.check() != null)
/* 340 */           return this.keys ? cacheEntry.key : cacheEntry.check(); 
/*     */       } 
/*     */     } 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/sun/misc/CacheEnumerator.class
