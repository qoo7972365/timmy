...
/*      */ 
/*      */     
/* 1649 */     this.theThread = null;
/* 1650 */     this.theLockCount = 0;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/* 1692 */   private static class CallBackLock { private State lockState = State.Unlocked;
/*      */ 
/*      */     
/*      */     void check() {
/* 1696 */       if (this.lockState != State.Unlocked) {
/* 1697 */         throw new IllegalStateException("Access to the reader is not allowed");
/*      */       }
/*      */     }
/*      */     
/*      */     private void lock() {
/* 1702 */       this.lockState = State.Locked;
/*      */     }
/*      */     
/*      */     private void unlock() {
/* 1706 */       this.lockState = State.Unlocked;
/*      */     }
/*      */     
/*      */     private enum State {
/* 1710 */       Unlocked,
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/imageio/plugins/jpeg/JPEGImageReader.class
