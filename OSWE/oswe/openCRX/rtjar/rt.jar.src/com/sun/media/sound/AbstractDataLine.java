...
/*  71 */     this(paramInfo, paramAbstractMixer, paramArrayOfControl, (AudioFormat)null, -1);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 124 */           setOpen(true);
/*     */         }
/* 126 */         catch (LineUnavailableException lineUnavailableException) {
/*     */           
/* 128 */           this.mixer.close(this);
/* 129 */           throw lineUnavailableException;
/*     */         
/*     */         }
/*     */ 
/*     */       
...
/* 138 */           throw new IllegalStateException("Line is already open with format " + getFormat() + " and bufferSize " + 
/* 139 */               getBufferSize());
/*     */         }
/*     */         
/* 142 */         if (paramInt > 0) {
...
/*     */ 
/*     */   
/*     */   public final void open(AudioFormat paramAudioFormat) throws LineUnavailableException {
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/media/sound/AbstractDataLine.class
