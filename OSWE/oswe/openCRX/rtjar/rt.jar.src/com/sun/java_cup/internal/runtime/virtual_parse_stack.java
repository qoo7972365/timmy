...
/* 108 */     if (this.real_next >= this.real_stack.size()) {
/*     */       return;
/*     */     }
/* 111 */     Symbol stack_sym = this.real_stack.elementAt(this.real_stack.size() - 1 - this.real_next);
/*     */ 
/*     */     
/* 114 */     this.real_next++;
/*     */ 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/java_cup/internal/runtime/virtual_parse_stack.class
