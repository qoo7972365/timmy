...
/*      */ 
/*      */           
/*  627 */           done_parsing(); continue;
/*      */         } 
/*  629 */         lhs_sym = this.stack.peek();
/*      */       } 
/*      */     } 
/*      */     
/*  633 */     return lhs_sym;
...
/*      */     {
/*  664 */       debug_message("Symbol: " + ((Symbol)this.stack.elementAt(i)).sym + " State: " + ((Symbol)this.stack
/*  665 */           .elementAt(i)).parse_state);
/*      */     }
/*  667 */     debug_message("==========================================");
/*      */   }
/*      */ 
...
/*  703 */       Symbol s = this.stack.elementAt(i);
...
/*  802 */         debug_message("# Reduce rule: top state " + ((Symbol)this.stack
/*  803 */             .peek()).parse_state + ", lhs sym " + lhs_sym_num + " -> state " + act);
/*      */ 
/*      */ 
/*      */         
...
/*      */ 
/*      */           
/*  827 */           done_parsing(); continue;
/*      */         } 
/*  829 */         lhs_sym = this.stack.peek();
/*      */       } 
/*      */     } 
/*      */     
/*  833 */     return lhs_sym;
...
/*      */       
/*  946 */       if (debug)
/*  947 */         debug_message("# Pop stack by one, state was # " + ((Symbol)this.stack
/*  948 */             .peek()).parse_state); 
...
/*  962 */     if (debug) {
/*      */       
/*  964 */       debug_message("# Recover state found (#" + ((Symbol)this.stack
/*  965 */           .peek()).parse_state + ")");
...
/*      */       }
/* 1105 */       if (debug) {
/* 1106 */         debug_message("# Parse-ahead reduces: handle size = " + rhs_size + " lhs = #" + lhs + " from state #" + vstack
/* 1107 */             .top());
/*      */       }
/*      */       
...
/* 1147 */       debug_message("# Current state is #" + ((Symbol)this.stack
/* 1148 */           .peek()).parse_state);
/*      */     } 
/*      */ 
/*      */     
...
/*      */ 
/*      */       
/* 1158 */       int act = get_action(((Symbol)this.stack.peek()).parse_state, (cur_err_token()).sym);
/*      */ 
/*      */       
/* 1161 */       if (act > 0) {
/*      */ 
...
/* 1239 */       sb.append(sa[i]); 
/* 1240 */     int n = 0;
/* 1241 */     int size1 = sb.charAt(n) << 16 | sb.charAt(n + 1); n += 2;
/* 1242 */     short[][] result = new short[size1][];
/* 1243 */     for (int j = 0; j < size1; j++) {
/* 1244 */       int size2 = sb.charAt(n) << 16 | sb.charAt(n + 1); n += 2;
/* 1245 */       result[j] = new short[size2];
/* 1246 */       for (int k = 0; k < size2; k++)
/* 1247 */         result[j][k] = (short)(sb.charAt(n++) - 2); 
/*      */     } 
/* 1249 */     return result;
/*      */   }
/*      */ }
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/java_cup/internal/runtime/lr_parser.class
