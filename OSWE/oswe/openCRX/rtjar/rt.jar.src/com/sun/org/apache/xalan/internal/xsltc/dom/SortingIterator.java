...
/*     */     try {
/* 101 */       SortingIterator clone = (SortingIterator)clone();
...
/* 111 */       BasisLibrary.runTimeError("ITERATOR_CLONE_ERR", e
/* 112 */           .toString());
/* 113 */       return null;
/*     */     } 
/*     */   }
...
/* 140 */         continue;  while (x.compareTo(this._data[++i]) > 0);
/* 141 */       if (i < j) {
/* 142 */         NodeSortRecord t = this._data[i];
/* 143 */         this._data[i] = this._data[j];
/* 144 */         this._data[j] = t; continue;
/*     */       }  break;
/*     */     } 
/* 147 */     return j;
/*     */   }
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xalan/internal/xsltc/dom/SortingIterator.class
