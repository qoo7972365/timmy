...
/* 163 */         int index = (hash & Integer.MAX_VALUE) % this.fGrammars.length; Entry entry;
/* 164 */         for (entry = this.fGrammars[index]; entry != null; entry = entry.next) {
...
/*     */           } 
/*     */         } 
/* 173 */         entry = new Entry(hash, index, desc, grammar, this.fGrammars[index], this.fReferenceQueue);
/* 174 */         this.fGrammars[index] = entry;
/* 175 */         this.fGrammarCount++;
/*     */       } 
/*     */     }
/*     */   }
/*     */ 
...
/* 191 */       int index = (hash & Integer.MAX_VALUE) % this.fGrammars.length;
...
/* 219 */       int index = (hash & Integer.MAX_VALUE) % this.fGrammars.length;
...
/* 241 */       int index = (hash & Integer.MAX_VALUE) % this.fGrammars.length;
...
/*     */ 
/*     */     
/*     */     protected SoftGrammarReference(SoftReferenceGrammarPool.Entry entry, Grammar grammar, ReferenceQueue<? super T> queue) {
/* 429 */       super((T)grammar, queue);
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xerces/internal/jaxp/validation/SoftReferenceGrammarPool.class
