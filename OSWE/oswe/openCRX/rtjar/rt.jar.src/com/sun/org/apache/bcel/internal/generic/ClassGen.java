...
/* 107 */       addAttribute(new SourceFile(cp.addUtf8("SourceFile"), 2, cp
/* 108 */             .addUtf8(file_name), cp.getConstantPool()));
/*     */     }
...
/*     */     int i;
/* 152 */     for (i = 0; i < interfaces.length; i++) {
/* 153 */       addInterface(interfaces[i]);
/*     */     }
/* 155 */     for (i = 0; i < attributes.length; i++) {
/* 156 */       addAttribute(attributes[i]);
/*     */     }
/* 158 */     for (i = 0; i < methods.length; i++) {
/* 159 */       addMethod(methods[i]);
/*     */     }
/* 161 */     for (i = 0; i < fields.length; i++) {
...
/* 259 */     return this.field_vec.contains(f);
/*     */   }
/*     */ 
/*     */   
/*     */   public Field containsField(String name) {
/* 264 */     for (Iterator<Field> e = this.field_vec.iterator(); e.hasNext(); ) {
/* 265 */       Field f = e.next();
...
/* 276 */     for (Iterator<Method> e = this.method_vec.iterator(); e.hasNext(); ) {
/* 277 */       Method m = e.next();
...
/* 334 */   public String getSuperclassName() { return this.super_class_name; } public String getFileName() {
/* 335 */     return this.file_name;
/*     */   }
...
/* 349 */     this.method_vec.toArray((Object[])methods);
/* 350 */     return methods;
/*     */   }
/*     */   
...
/* 364 */     return this.method_vec.get(pos);
/*     */   }
/*     */   
...
/*     */     
/* 371 */     this.interface_vec.toArray((Object[])interfaces);
...
/* 387 */     this.field_vec.toArray((Object[])fields);
/* 388 */     return fields;
/*     */   }
/*     */   
/*     */   public Attribute[] getAttributes() {
/* 392 */     Attribute[] attributes = new Attribute[this.attribute_vec.size()];
/* 393 */     this.attribute_vec.toArray((Object[])attributes);
/* 394 */     return attributes;
/*     */   }
/*     */   public ConstantPoolGen getConstantPool() {
/* 397 */     return this.cp;
/*     */   } public void setConstantPool(ConstantPoolGen constant_pool) {
/* 399 */     this.cp = constant_pool;
/*     */   }
/*     */   
/*     */   public void setClassNameIndex(int class_name_index) {
/* 403 */     this.class_name_index = class_name_index;
/* 404 */     this
/* 405 */       .class_name = this.cp.getConstantPool().getConstantString(class_name_index, (byte)7).replace('/', '.');
/*     */   }
/*     */   
/*     */   public void setSuperclassNameIndex(int superclass_name_index) {
/* 409 */     this.superclass_name_index = superclass_name_index;
/* 410 */     this
/* 411 */       .super_class_name = this.cp.getConstantPool().getConstantString(superclass_name_index, (byte)7).replace('/', '.');
/*     */   }
/*     */   public int getSuperclassNameIndex() {
/* 414 */     return this.superclass_name_index;
/*     */   } public int getClassNameIndex() {
/* 416 */     return this.class_name_index;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 442 */       for (Iterator<ClassObserver> e = this.observers.iterator(); e.hasNext();)
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/bcel/internal/generic/ClassGen.class
