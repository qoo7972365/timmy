...
/*     */           
/* 159 */           for (; ++i < nChars && (c = pat.charAt(i)) != '"'; i++);
/*     */           
/* 161 */           if (c == '"' && i < nChars) {
/*     */             
...
/*     */           
/* 193 */           for (; ++i < nChars && (c = pat.charAt(i)) != '\''; i++);
/*     */           
/* 195 */           if (c == '\'' && i < nChars) {
/*     */             
...
/* 343 */             isNum = Character.isDigit(c); break;
/*     */           } 
/* 345 */           if (isNum)
/*     */           {
...
/*     */       
/* 357 */       if (-1 != posOfNSSep || (this.m_namespaceContext != null && this.m_namespaceContext
/* 358 */         .handlesNullPrefixes())) {
/*     */         
...
/* 404 */       if (!isStart)
/*     */       {
/* 406 */         this.m_patternMap[this.m_patternMapSize - 1] = this.m_patternMap[this.m_patternMapSize - 1] - 10000;
/*     */       }
/* 408 */       this.m_patternMap[this.m_patternMapSize] = this.m_compiler
/* 409 */         .getTokenQueueSize() - (isAttrName ? 1 : 0) + 10000;
/*     */       
/* 411 */       this.m_patternMapSize++;
/*     */       
/* 413 */       isStart = false;
/*     */     } 
/*     */     
...
/*     */     
/* 444 */     this.m_processor.m_queueMark = (mark > 0) ? ((mark <= qsz) ? (mark - 1) : mark) : 0;
/*     */ 
/*     */     
/* 447 */     if (this.m_processor.m_queueMark < qsz) {
/*     */       
/* 449 */       this.m_processor
/* 450 */         .m_token = (String)this.m_compiler.getTokenQueue().elementAt(this.m_processor.m_queueMark++);
/* 451 */       this.m_processor.m_tokenChar = this.m_processor.m_token.charAt(0);
/*     */     }
/*     */     else {
/*     */       
/* 455 */       this.m_processor.m_token = null;
/* 456 */       this.m_processor.m_tokenChar = Character.MIN_VALUE;
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*     */   private void recordTokenString(Vector<String> targetStrings) {
...
/*     */ 
/*     */     
/* 585 */     if (null != this.m_namespaceContext && !prefix.equals("*") && 
...
/*     */ 
/*     */           
/* 613 */           uName = this.m_namespaceContext.getNamespaceForPrefix(prefix);
/*     */         
/*     */         }
/*     */       
/*     */       }
...
/*     */       {
/* 620 */         uName = this.m_namespaceContext.getNamespaceForPrefix(prefix);
/*     */       }
/*     */     
/*     */     } else {
/*     */       
...
/*     */     else {
/*     */       
/* 642 */       this.m_processor.errorForDOM3("ER_PREFIX_MUST_RESOLVE", (Object[])new String[] { prefix });
/*     */     } 
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xpath/internal/compiler/Lexer.class
