...
/*     */       
/* 152 */       if (suffixLength == "security-manager".length() && propertyId
/* 153 */         .endsWith("security-manager")) {
/* 154 */         this.fSecurityManager = (XMLSecurityManager)value;
/* 155 */         this
/* 156 */           .maxNodeLimit = (this.fSecurityManager != null) ? (this.fSecurityManager.getLimit(XMLSecurityManager.Limit.MAX_OCCUR_NODE_LIMIT) * 1) : 0;
/*     */         return;
/*     */       } 
/* 159 */       if (suffixLength == "internal/error-reporter".length() && propertyId
/* 160 */         .endsWith("internal/error-reporter")) {
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xerces/internal/impl/xs/models/CMNodeFactory.class
