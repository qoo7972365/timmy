...
/*  624 */     int kidhandle = this.dtm.getFirstChild(dochandle);
/*  625 */     for (; kidhandle != -1; 
...
/*  783 */     Vector<Node> listVector = new Vector();
...
/*  791 */         for (int j = 0; j < nodeList.getLength(); j++)
/*      */         {
/*  793 */           traverseChildren(listVector, nodeList.item(j), tagname, isTagNameWildCard);
/*      */         }
/*      */       }
...
/*      */     {
/*  805 */       nodeSet.addNode(listVector.elementAt(i));
/*      */     }
/*  807 */     return nodeSet;
/*      */   }
/*      */ 
...
/*      */ 
/*      */   
/*      */   private final void traverseChildren(Vector<Node> listVector, Node tempNode, String tagname, boolean isTagNameWildCard) {
...
/*      */ 
/*      */     
/*  832 */     if (tempNode.getNodeType() == 1 && (isTagNameWildCard || tempNode
/*  833 */       .getNodeName().equals(tagname)))
/*      */     {
...
/*  914 */     Vector<Node> listVector = new Vector();
...
/*  923 */         for (int j = 0; j < nodeList.getLength(); j++)
/*      */         {
/*  925 */           traverseChildren(listVector, nodeList.item(j), namespaceURI, localName, isNamespaceURIWildCard, isLocalNameWildCard);
/*      */         }
/*      */       }
...
/*      */     {
/*  937 */       nodeSet.addNode(listVector.elementAt(i));
/*      */     }
/*  939 */     return nodeSet;
/*      */   }
/*      */ 
...
/*      */ 
/*      */   
/*      */   private final void traverseChildren(Vector<Node> listVector, Node tempNode, String namespaceURI, String localname, boolean isNamespaceURIWildCard, boolean isLocalNameWildCard) {
...
/*      */ 
/*      */     
/*  968 */     if (tempNode.getNodeType() == 1 && (isLocalNameWildCard || tempNode
/*      */       
/*  970 */       .getLocalName().equals(localname))) {
/*      */       
/*  972 */       String nsURI = tempNode.getNamespaceURI();
/*  973 */       if ((namespaceURI == null && nsURI == null) || isNamespaceURIWildCard || (namespaceURI != null && namespaceURI
/*      */         
/*  975 */         .equals(nsURI)))
/*      */       {
...
/* 1578 */       if (("CORE".equals(feature.toUpperCase()) || "XML".equals(feature.toUpperCase())) && ("1.0"
/*      */         
/* 1580 */         .equals(version) || "2.0".equals(version)))
/* 1581 */         return true; 
/* 1582 */       return false;
/*      */     }
/*      */ 
...
/*      */       
/*      */       case 1:
/* 1792 */         namespace = getNamespaceURI();
/* 1793 */         prefix = getPrefix();
...
/*      */               
/* 1814 */               if (specifiedPrefix == null && attr
/* 1815 */                 .getNodeName().equals("xmlns"))
/*      */               {
/* 1817 */                 return value; } 
/* 1818 */               if (attrPrefix != null && attrPrefix
/* 1819 */                 .equals("xmlns") && attr
/* 1820 */                 .getLocalName().equals(specifiedPrefix))
/*      */               {
/* 1822 */                 return value;
/*      */               }
/*      */             } 
...
/* 2119 */     return this.dtm.getStringValue(this.node).toString();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xml/internal/dtm/ref/DTMNodeProxy.class
