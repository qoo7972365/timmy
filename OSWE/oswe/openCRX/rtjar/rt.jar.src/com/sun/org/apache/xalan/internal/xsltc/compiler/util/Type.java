...
/*     */ 
/*     */   
/*     */   public static Type newObjectType(Class<Object> clazz) {
...
/* 134 */     return (type == this) ? 0 : Integer.MAX_VALUE;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 150 */     ErrorMsg err = new ErrorMsg("DATA_CONVERSION_ERR", toString(), type.toString());
...
/* 183 */     ErrorMsg err = new ErrorMsg("DATA_CONVERSION_ERR", toString(), type.toString());
...
/* 196 */     ErrorMsg err = new ErrorMsg("DATA_CONVERSION_ERR", toString(), clazz.getClass().toString());
...
/* 208 */     ErrorMsg err = new ErrorMsg("DATA_CONVERSION_ERR", clazz.getClass().toString(), toString());
...
/* 218 */     ErrorMsg err = new ErrorMsg("DATA_CONVERSION_ERR", toString(), "[" + toString() + "]");
...
/* 228 */     ErrorMsg err = new ErrorMsg("DATA_CONVERSION_ERR", "[" + toString() + "]", toString());
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xalan/internal/xsltc/compiler/util/Type.class
