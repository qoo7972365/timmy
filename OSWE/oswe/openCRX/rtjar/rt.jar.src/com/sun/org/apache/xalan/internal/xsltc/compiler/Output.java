...
/*     */     {
/* 125 */       addAttribute("cdata-section-elements", previous
/* 126 */           .getAttribute("cdata-section-elements") + ' ' + 
...
/* 171 */       if (this._method.equals("xml") || this._method
/* 172 */         .equals("html") || this._method
/* 173 */         .equals("text") || (
/* 174 */         XML11Char.isXML11ValidQName(this._method) && this._method.indexOf(":") > 0)) {
/* 175 */         outputProperties.setProperty("method", this._method);
/*     */       } else {
/* 177 */         reportError(this, parser, "INVALID_METHOD_IN_OUTPUT", this._method);
/*     */       } 
/*     */     } 
/*     */ 
/*     */     
...
/* 191 */         OutputStreamWriter outputStreamWriter = new OutputStreamWriter(System.out, canonicalEncoding);
/*     */       
/*     */       }
...
/*     */         } 
/* 254 */         expandedNames.append(parser
/* 255 */             .getQName(qname).toString()).append(' ');
/*     */       } 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xalan/internal/xsltc/compiler/Output.class
