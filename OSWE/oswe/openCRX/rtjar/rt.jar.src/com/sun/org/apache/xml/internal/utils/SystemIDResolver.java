...
/* 168 */       return false;
/*     */     }
/* 170 */     if (systemId.length() > 2 && systemId
/* 171 */       .charAt(1) == ':' && 
/* 172 */       Character.isLetter(systemId.charAt(0)) && (systemId
/* 173 */       .charAt(2) == '\\' || systemId.charAt(2) == '/')) {
/* 174 */       return true;
/*     */     }
/* 176 */     return false;
/*     */   }
...
/*     */                 {
/* 243 */                   absoluteURI = systemId.substring(0, secondColonIndex - 1) + getAbsolutePathFromRelativePath(localPath);
/*     */                 }
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xml/internal/utils/SystemIDResolver.class
