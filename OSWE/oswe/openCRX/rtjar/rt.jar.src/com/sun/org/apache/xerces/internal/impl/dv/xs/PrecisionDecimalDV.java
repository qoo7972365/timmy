...
/*     */       int lastNonZero;
/* 164 */       for (lastNonZero = flen0; lastNonZero > 0 && 
/* 165 */         fvalue.charAt(lastNonZero - 1) == '0'; lastNonZero--);
/*     */       
/* 167 */       int flen = lastNonZero;
/*     */       
/* 169 */       int exponent = pvalue; int iStart;
/* 170 */       for (iStart = 0; iStart < ilen && 
...
/*     */       int i;
/* 252 */       for (i = fValue.length() - 1; i >= 0 && 
/* 253 */         fValue.charAt(i) == '0'; i--) {
/* 254 */         fValue.deleteCharAt(i);
/*     */       }
/*     */ 
/*     */       
/* 258 */       for (i = otherFValue.length() - 1; i >= 0 && 
...
/* 309 */           int j = this.pvalue - val.pvalue;
/* 310 */           StringBuffer stringBuffer1 = new StringBuffer(this.ivalue);
/* 311 */           StringBuffer stringBuffer2 = new StringBuffer(this.fvalue);
/* 312 */           for (int k = 0; k < j; k++) {
/* 313 */             if (k < this.fracDigits) {
/* 314 */               stringBuffer1.append(this.fvalue.charAt(k));
/* 315 */               stringBuffer2.deleteCharAt(k);
/*     */             } else {
/*     */               
/* 318 */               stringBuffer1.append('0');
/*     */             } 
/* 320 */           }  return compareDecimal(stringBuffer1.toString(), val.ivalue, stringBuffer2.toString(), val.fvalue);
/*     */         } 
/*     */         
...
/* 395 */         return true;
/*     */       }
/* 397 */       if (this.sign == decimal.sign && this.intDigits == decimal.intDigits && this.fracDigits == decimal.fracDigits && this.pvalue == decimal.pvalue && this.ivalue
/* 398 */         .equals(decimal.ivalue) && this.fvalue.equals(decimal.fvalue))
/* 399 */         return true; 
/* 400 */       return false;
/*     */     }
/*     */   }
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xerces/internal/impl/dv/xs/PrecisionDecimalDV.class
