...
/* 176 */   public static final int S_BUILTIN_OLD_EXTENSIONS_UNIVERSAL_LEN = "{http://xml.apache.org/xslt}"
/* 177 */     .length();
/*     */ 
/*     */ 
/*     */ 
...
/*     */           
/* 302 */           m_html_properties = loadPropertiesFile(fileName, m_xml_properties);
/*     */         } 
/*     */         
...
/*     */           
/* 313 */           m_text_properties = loadPropertiesFile(fileName, m_xml_properties);
/* 314 */           if (null == m_text_properties
/* 315 */             .getProperty("encoding")) {
/*     */             
...
/*     */           
/* 332 */           m_unknown_properties = loadPropertiesFile(fileName, m_xml_properties);
/*     */         } 
/*     */         
...
/*     */       
/* 345 */       throw new WrappedRuntimeException(Utils.messages
/* 346 */           .createMessage("ER_COULD_NOT_LOAD_METHOD_PROPERTY", new Object[] { fileName, method }), ioe);
/*     */     } 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */         
/* 388 */         is = AccessController.<InputStream>doPrivileged(new PrivilegedAction<InputStream>()
/*     */             {
/*     */               public Object run() {
...
/*     */ 
/*     */         
/* 400 */         is = OutputPropertiesFactory.class.getResourceAsStream(resourceName);
/*     */       } 
/*     */       
...
/*     */ 
/*     */       
/* 414 */       throw new WrappedRuntimeException(Utils.messages
/* 415 */           .createMessage("ER_COULD_NOT_LOAD_RESOURCE", new Object[] { resourceName }), ioe);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */       
/* 431 */       throw new WrappedRuntimeException(Utils.messages
/* 432 */           .createMessage("ER_COULD_NOT_LOAD_RESOURCE", new Object[] { resourceName }), se);
/*     */ 
/*     */ 
/*     */     
/*     */     }
...
/*     */ 
/*     */     
/* 465 */     Enumeration<Object> keys = ((Properties)props.clone()).keys();
...
/*     */       }
/* 477 */       catch (SecurityException securityException) {}
/*     */ 
/*     */ 
/*     */       
/* 481 */       if (value == null) {
...
/*     */ 
/*     */       
/* 528 */       s = "{http://xml.apache.org/xalan}" + s.substring(S_XALAN_PREFIX_LEN); } 
/*     */     int index;
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xml/internal/serializer/OutputPropertiesFactory.class
