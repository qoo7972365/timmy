...
/* 214 */       addAttribute(new ConstantValue(this.cp.addUtf8("ConstantValue"), 2, index, this.cp
/* 215 */             .getConstantPool()));
/*     */     } 
/*     */     
/* 218 */     return new Field(this.access_flags, name_index, signature_index, getAttributes(), this.cp
/* 219 */         .getConstantPool());
/*     */   }
/*     */   
/*     */   private int addConstant() {
/* 223 */     switch (this.type.getType()) { case 4: case 5: case 8:
/*     */       case 9:
/*     */       case 10:
...
/* 271 */       for (Iterator<FieldObserver> e = this.observers.iterator(); e.hasNext();)
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/bcel/internal/generic/FieldGen.class
