...
/*  65 */   private static final String[] ClassNames = new String[] { "com.sun.org.apache.xalan.internal.xsltc.dom.SingleNodeCounter", "com.sun.org.apache.xalan.internal.xsltc.dom.MultipleNodeCounter", "com.sun.org.apache.xalan.internal.xsltc.dom.AnyNodeCounter" };
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*  71 */   private static final String[] FieldNames = new String[] { "___single_node_counter", "___multiple_node_counter", "___any_node_counter" };
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 186 */       Type tvalue = this._value.typeCheck(stable);
/* 187 */       if (!(tvalue instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.util.RealType)) {
/* 188 */         this._value = new CastExpr(this._value, Type.Real);
/*     */       }
/*     */     } 
...
/*     */ 
/*     */       
/* 243 */       Field defaultNode = new Field(2, cpg.addUtf8(FieldNames[this._level]), cpg.addUtf8("Lcom/sun/org/apache/xalan/internal/xsltc/dom/NodeCounter;"), null, cpg.getConstantPool());
/*     */ 
/*     */       
...
/*     */ 
/*     */     
/* 342 */     LocalVariableGen local = matchGen.addLocalVariable("iterator", 
/* 343 */         Util.getJCRefType("Lcom/sun/org/apache/xml/internal/dtm/DTMAxisIterator;"), null, null);
/*     */     
...
/* 354 */         Util.getJCRefType("Lcom/sun/org/apache/xalan/internal/xsltc/runtime/AbstractTranslet;"), null, null);
/*     */     
...
/* 366 */         Util.getJCRefType("Lcom/sun/org/apache/xalan/internal/xsltc/DOM;"), null, null);
/*     */     
...
/*     */ 
/*     */     
/* 391 */     NodeCounterGenerator nodeCounterGen = new NodeCounterGenerator(this._className, ClassNames[this._level], toString(), 33, null, classGen.getStylesheet());
/* 392 */     InstructionList il = null;
/* 393 */     ConstantPoolGen cpg = nodeCounterGen.getConstantPool();
/*     */ 
/*     */ 
/*     */     
/* 397 */     int closureLen = (this._closureVars == null) ? 0 : this._closureVars.size();
/*     */     
/* 399 */     for (int i = 0; i < closureLen; i++) {
/*     */       
/* 401 */       VariableBase var = ((VariableRefBase)this._closureVars.get(i)).getVariable();
/*     */       
/* 403 */       nodeCounterGen.addField(new Field(1, cpg
/* 404 */             .addUtf8(var.getEscapedName()), cpg
/* 405 */             .addUtf8(var.getType().toSignature()), null, cpg
/* 406 */             .getConstantPool()));
/*     */     } 
/*     */ 
/*     */     
...
/* 417 */       MatchGenerator matchGen = new MatchGenerator(17, Type.BOOLEAN, new Type[] { Type.INT }, new String[] { "node" }, "matchesFrom", this._className, il, cpg);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 444 */       MatchGenerator matchGen = new MatchGenerator(17, Type.BOOLEAN, new Type[] { Type.INT }, new String[] { "node" }, "matchesCount", this._className, il, cpg);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 486 */     for (int j = 0; j < closureLen; j++) {
/* 487 */       VariableRefBase varRef = this._closureVars.get(j);
/* 488 */       VariableBase var = varRef.getVariable();
/* 489 */       Type varType = var.getType();
/*     */ 
/*     */       
/* 492 */       il.append(DUP);
/* 493 */       il.append(var.loadInstruction());
/* 494 */       il.append(new PUTFIELD(cpg
/* 495 */             .addFieldref(this._className, var.getEscapedName(), varType
/* 496 */               .toSignature())));
/*     */     } 
/*     */   }
/*     */ 
...
/*     */     } else {
/*     */       
/* 584 */       int index = cpg.addMethodref("com.sun.org.apache.xalan.internal.xsltc.dom.NodeCounter", "setDefaultFormatting", "()Lcom/sun/org/apache/xalan/internal/xsltc/dom/NodeCounter;");
/*     */       
...
/* 595 */     int i = cpg.addMethodref("com.sun.org.apache.xalan.internal.xsltc.runtime.AbstractTranslet", "characters", "(Ljava/lang/String;Lcom/sun/org/apache/xml/internal/serializer/SerializationHandler;)V");
/*     */ 
/*     */     
/* 598 */     il.append(new INVOKEVIRTUAL(i));
/*     */   }
/*     */ }


/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xalan/internal/xsltc/compiler/Number.class
