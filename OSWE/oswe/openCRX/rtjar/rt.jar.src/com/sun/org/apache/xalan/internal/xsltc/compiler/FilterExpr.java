...
/*  83 */         Expression exp = this._predicates.elementAt(i);
...
/*     */     
/* 105 */     if (!(ptype instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.util.NodeSetType)) {
/* 106 */       if (ptype instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.util.ReferenceType) {
...
/* 117 */       Predicate pred = this._predicates.elementAt(i);
/*     */       
/* 119 */       if (!canOptimize) {
...
/*     */     else {
/*     */       
/* 164 */       Predicate predicate = this._predicates.get(predicateIndex--);
/*     */ 
/*     */       
...
/*     */ 
/*     */         
/* 186 */         LocalVariableGen iteratorTemp = methodGen.addLocalVariable("filter_expr_tmp1", 
/* 187 */             Util.getJCRefType("Lcom/sun/org/apache/xml/internal/dtm/DTMAxisIterator;"), null, null);
/*     */         
/* 189 */         iteratorTemp.setStart(il
/* 190 */             .append(new ASTORE(iteratorTemp.getIndex())));
/*     */         
/* 192 */         predicate.translate(classGen, methodGen);
/*     */         
/* 194 */         LocalVariableGen predicateValueTemp = methodGen.addLocalVariable("filter_expr_tmp2", 
/* 195 */             Util.getJCRefType("I"), null, null);
/*     */         
/* 197 */         predicateValueTemp.setStart(il
/* 198 */             .append(new ISTORE(predicateValueTemp.getIndex())));
/*     */         
/* 200 */         il.append(new NEW(cpg.addClass("com.sun.org.apache.xalan.internal.xsltc.dom.NthIterator")));
/* 201 */         il.append(DUP);
/* 202 */         iteratorTemp.setEnd(il
/* 203 */             .append(new ALOAD(iteratorTemp.getIndex())));
/* 204 */         predicateValueTemp.setEnd(il
/* 205 */             .append(new ILOAD(predicateValueTemp.getIndex())));
...
/*     */ 
/*     */         
/* 226 */         LocalVariableGen nodeIteratorTemp = methodGen.addLocalVariable("filter_expr_tmp1", 
/* 227 */             Util.getJCRefType("Lcom/sun/org/apache/xml/internal/dtm/DTMAxisIterator;"), null, null);
/*     */         
/* 229 */         nodeIteratorTemp.setStart(il
/* 230 */             .append(new ASTORE(nodeIteratorTemp.getIndex())));
/*     */         
/* 232 */         predicate.translate(classGen, methodGen);
/*     */         
/* 234 */         LocalVariableGen filterTemp = methodGen.addLocalVariable("filter_expr_tmp2", 
/* 235 */             Util.getJCRefType("Lcom/sun/org/apache/xalan/internal/xsltc/dom/CurrentNodeListFilter;"), null, null);
/*     */         
...
/*     */ 
/*     */         
/* 244 */         nodeIteratorTemp.setEnd(il
/* 245 */             .append(new ALOAD(nodeIteratorTemp.getIndex())));
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xalan/internal/xsltc/compiler/FilterExpr.class
