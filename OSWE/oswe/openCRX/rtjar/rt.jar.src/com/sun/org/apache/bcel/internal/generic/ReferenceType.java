...
/* 121 */           return true;
/*     */         }
/* 123 */         if (Repository.instanceOf(((ObjectType)this).getClassName(), ((ObjectType)T)
/* 124 */             .getClassName())) {
/* 125 */           return true;
/*     */         }
/*     */       } 
...
/* 131 */         Repository.implementationOf(((ObjectType)this).getClassName(), ((ObjectType)T)
/* 132 */           .getClassName())) {
/* 133 */         return true;
/*     */       }
/*     */     } 
...
/* 151 */         if (Repository.implementationOf(((ObjectType)this).getClassName(), ((ObjectType)T)
/* 152 */             .getClassName())) {
/* 153 */           return true;
/*     */         }
/*     */       } 
...
/*     */ 
/*     */         
/* 182 */         if (tc instanceof ReferenceType && sc instanceof ReferenceType && ((ReferenceType)sc)
/* 183 */           .isAssignmentCompatibleWith(tc)) {
/* 184 */           return true;
/*     */         }
/*     */       } 
/*     */ 
...
/* 234 */       if (arrType1
/* 235 */         .getDimensions() == arrType2.getDimensions() && arrType1
/* 236 */         .getBasicType() instanceof ObjectType && arrType2
/* 237 */         .getBasicType() instanceof ObjectType) {
/* 238 */         return new ArrayType(((ObjectType)arrType1
/* 239 */             .getBasicType()).getFirstCommonSuperclass((ObjectType)arrType2.getBasicType()), arrType1
/* 240 */             .getDimensions());
/*     */       }
/*     */     } 
/*     */ 
...
/*     */     }
/*     */     
/* 250 */     if ((this instanceof ObjectType && ((ObjectType)this).referencesInterface()) || (t instanceof ObjectType && ((ObjectType)t)
/* 251 */       .referencesInterface())) {
...
/*     */     }
/*     */     
/* 317 */     if ((this instanceof ObjectType && ((ObjectType)this).referencesInterface()) || (t instanceof ObjectType && ((ObjectType)t)
/* 318 */       .referencesInterface())) {
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/bcel/internal/generic/ReferenceType.class
