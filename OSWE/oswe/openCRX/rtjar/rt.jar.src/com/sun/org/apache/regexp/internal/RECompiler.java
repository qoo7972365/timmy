...
/*      */   
/*      */   public RECompiler() {
/*   97 */     this.instruction = new char[128];
...
/*  156 */     this.instruction[insertAt + 2] = Character.MIN_VALUE;
...
/*  207 */     this.instruction[this.lenInstruction + 2] = Character.MIN_VALUE;
...
/*      */         
/*  250 */         this.bracketOpt[i] = -1; this.bracketMin[i] = -1; this.bracketEnd[i] = -1; this.bracketStart[i] = -1;
/*      */       } 
/*      */     } 
/*      */   }
/*      */ 
...
/*  269 */       new_bO[i] = -1; new_bM[i] = -1; new_bE[i] = -1; new_bS[i] = -1;
/*      */     } 
...
/*      */       case 'u':
/*      */       case 'x':
/*  427 */         hexDigits = (escapeChar == 'u') ? 4 : 2;
/*      */ 
/*      */         
/*  430 */         val = 0;
/*  431 */         for (; this.idx < this.len && hexDigits-- > 0; this.idx++) {
/*      */ 
/*      */           
...
/*      */ 
/*      */         
/*  550 */         Character character = (Character)hashPOSIX.get(charClass);
...
/*      */ 
/*      */           
/*  557 */           return node('P', character.charValue());
/*      */         } 
...
/*  570 */     char simpleChar = Character.MIN_VALUE;
...
/*      */ 
/*      */           
/*  666 */           rangeStart = (last == CHAR_INVALID) ? Character.MIN_VALUE : last;
/*      */ 
/*      */           
...
/*      */       int idxBeforeEscape, c;
/*      */       
/*  751 */       if (this.idx + 1 < this.len) {
/*      */         
/*  753 */         char c1 = this.pattern.charAt(this.idx + 1);
/*      */ 
/*      */         
...
/*      */           {
/*  762 */             c1 = this.pattern.charAt(this.idx);
/*      */           }
...
/*  919 */         flags[0] = flags[0] & 0xFFFFFFFE;
/*      */         break;
/*      */     } 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/*  927 */     flags[0] = flags[0] & 0xFFFFFFFE;
/*  928 */     return atom();
/*      */   }
/*      */ 
/*      */ 
...
/*  940 */     int opcode, idxBeforeTerminal = this.idx;
/*      */ 
/*      */     
...
/*      */ 
/*      */     
/*  949 */     flags[0] = flags[0] | terminalFlags[0];
/*      */ 
/*      */     
...
/*      */       
/*      */       case '{':
/*  974 */         opcode = this.instruction[ret + 0];
...
/*      */           
/* 1003 */           allocBrackets();
/* 1004 */           for (i = 0; i < this.brackets; i++) {
/*      */             
...
/*      */ 
/*      */           
/* 1027 */           this.bracketMin[i] = this.bracketMin[i] - 1; if (this.bracketMin[i] > 0) {
/*      */             
...
/*      */           } else {
/*      */             
/* 1061 */             this.bracketOpt[i] = this.bracketOpt[i] - 1; if (this.bracketOpt[i] > 0) {
/*      */               
...
/* 1114 */             setNextOfEnd(ret, node('N', 0));
/*      */           } 
/*      */           break;
/*      */ 
/*      */ 
...
/*      */       } 
/*      */     }
/* 1235 */     flags[0] = flags[0] & 0xFFFFFFFD;
/*      */ 
/*      */     
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/regexp/internal/RECompiler.class
