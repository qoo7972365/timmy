...
/*  64 */     if (!(tvalue instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.util.RealType)) {
/*  65 */       this._value = new CastExpr(this._value, Type.Real);
/*     */     }
/*  67 */     Type tformat = this._format.typeCheck(stable);
/*  68 */     if (!(tformat instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.util.StringType)) {
...
/*  76 */         this
/*  77 */           ._resolvedQName = getParser().getQNameIgnoreDefaultNs(literal.getValue());
/*     */       }
/*  79 */       else if (!(tname instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.util.StringType)) {
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xalan/internal/xsltc/compiler/FormatNumberCall.class
