...
/* 141 */     return (stack != null && !stack.isEmpty()) ? ((MappingRecord)stack
/* 142 */       .peek()).m_uri : null;
/*     */   }
/*     */   
/*     */   MappingRecord getMappingFromPrefix(String prefix) {
/* 146 */     Stack<MappingRecord> stack = (Stack)this.m_namespaces.get(prefix);
/* 147 */     return (stack != null && !stack.isEmpty()) ? stack
/* 148 */       .peek() : null;
/*     */   }
/*     */ 
/*     */ 
...
/* 162 */     Iterator<String> itr = this.m_namespaces.keySet().iterator();
...
/* 178 */     Iterator<String> itr = this.m_namespaces.keySet().iterator();
...
/*     */         return; 
/* 257 */       MappingRecord map = this.m_nodeStack.peek();
...
/*     */         }
/* 274 */         catch (SAXException sAXException) {}
/*     */       }
/*     */     } 
/*     */   }
/*     */ 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xml/internal/serializer/NamespaceMappings.class
