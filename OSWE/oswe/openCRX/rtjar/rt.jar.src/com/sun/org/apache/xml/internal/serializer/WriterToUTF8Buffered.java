...
/*     */ 
/*     */         
/* 205 */         int chunks, split = length / 5461;
/*     */         
...
/* 276 */       } else if (c < 'ࠀ') {
/*     */         
/* 278 */         buf_loc[count_loc++] = (byte)(192 + (c >> 6));
/* 279 */         buf_loc[count_loc++] = (byte)(128 + (c & 0x3F));
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */         
/* 295 */         buf_loc[count_loc++] = (byte)(0xF0 | high + 64 >> 8 & 0xF0);
/* 296 */         buf_loc[count_loc++] = (byte)(0x80 | high + 64 >> 2 & 0x3F);
/* 297 */         buf_loc[count_loc++] = (byte)(0x80 | (low >> 6 & 0xF) + (high << 4 & 0x30));
/* 298 */         buf_loc[count_loc++] = (byte)(0x80 | low & 0x3F);
/*     */       }
/*     */       else {
/*     */         
/* 302 */         buf_loc[count_loc++] = (byte)(224 + (c >> 12));
/* 303 */         buf_loc[count_loc++] = (byte)(128 + (c >> 6 & 0x3F));
/* 304 */         buf_loc[count_loc++] = (byte)(128 + (c & 0x3F));
/*     */       } 
/*     */     } 
/*     */     
...
/*     */ 
/*     */           
/* 357 */           char c1 = this.m_inputChars[len_chunk - 1];
/* 358 */           if (c1 >= '?' && c1 <= '?') {
/*     */ 
/*     */ 
/*     */             
...
/* 404 */       } else if (c < 'ࠀ') {
/*     */         
/* 406 */         buf_loc[count_loc++] = (byte)(192 + (c >> 6));
/* 407 */         buf_loc[count_loc++] = (byte)(128 + (c & 0x3F));
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */         
/* 423 */         buf_loc[count_loc++] = (byte)(0xF0 | high + 64 >> 8 & 0xF0);
/* 424 */         buf_loc[count_loc++] = (byte)(0x80 | high + 64 >> 2 & 0x3F);
/* 425 */         buf_loc[count_loc++] = (byte)(0x80 | (low >> 6 & 0xF) + (high << 4 & 0x30));
/* 426 */         buf_loc[count_loc++] = (byte)(0x80 | low & 0x3F);
/*     */       }
/*     */       else {
/*     */         
/* 430 */         buf_loc[count_loc++] = (byte)(224 + (c >> 12));
/* 431 */         buf_loc[count_loc++] = (byte)(128 + (c >> 6 & 0x3F));
/* 432 */         buf_loc[count_loc++] = (byte)(128 + (c & 0x3F));
/*     */       } 
/*     */     } 
/*     */     
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xml/internal/serializer/WriterToUTF8Buffered.class
