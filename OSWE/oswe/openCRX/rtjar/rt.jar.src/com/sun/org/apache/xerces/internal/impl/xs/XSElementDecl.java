...
/*     */ 
/*     */         
/* 142 */         StringBuffer buffer = new StringBuffer(this.fTargetNamespace.length() + ((this.fName != null) ? this.fName.length() : 4) + 3);
/* 143 */         buffer.append('"');
...
/* 281 */     return new XSNamedMapImpl((XSObject[])this.fIDConstraints, this.fIDCPos);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xerces/internal/impl/xs/XSElementDecl.class
