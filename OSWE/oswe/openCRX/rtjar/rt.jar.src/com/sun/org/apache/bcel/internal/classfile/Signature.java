...
/* 158 */       super(data.getBytes());
/* 159 */     } final int mark() { return this.pos; }
/* 160 */     final String getData() { return new String(this.buf); }
/* 161 */     final void reset(int p) { this.pos = p; } final void unread() {
/* 162 */       if (this.pos > 0) this.pos--; 
/*     */     } }
/*     */   
...
/* 187 */         stringBuffer.append((char)ch);
/* 188 */         count++;
/* 189 */         ch = in.read();
/*     */       } 
/*     */       
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/bcel/internal/classfile/Signature.class
