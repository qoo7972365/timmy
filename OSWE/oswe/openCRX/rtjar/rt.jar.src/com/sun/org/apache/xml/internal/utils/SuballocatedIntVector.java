...
/*  97 */     for (this.m_SHIFT = 0; 0 != (blocksize >>>= 1); this.m_SHIFT++);
/*     */     
...
/*     */         
/* 289 */         int push, copylen = this.m_blocksize - offset - 1;
...
/*     */       
/* 482 */       int[] arrayOfInt = this.m_map[bindex];
/* 483 */       if (arrayOfInt != null)
/* 484 */         for (int i = boffset; i < this.m_blocksize; i++) {
/* 485 */           if (arrayOfInt[i] == elem)
/* 486 */             return i + bindex * this.m_blocksize; 
/* 487 */         }   boffset = 0;
/*     */     } 
/*     */     
...
/* 527 */     int index = this.m_firstFree >>> this.m_SHIFT;
/* 528 */     for (; index >= 0; 
/* 529 */       index--) {
/*     */       
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xml/internal/utils/SuballocatedIntVector.class
