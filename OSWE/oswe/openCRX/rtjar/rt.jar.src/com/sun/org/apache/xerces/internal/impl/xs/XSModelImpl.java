...
/*  66 */   private static final boolean[] GLOBAL_COMP = new boolean[] { 
...
/* 145 */     for (j = 0; j < len; j++) {
/*     */       
/* 147 */       SchemaGrammar sg1 = grammarList[j];
/* 148 */       Vector<SchemaGrammar> gs = sg1.getImportedGrammars();
/*     */       
/* 150 */       for (int k = (gs == null) ? -1 : (gs.size() - 1); k >= 0; k--) {
/* 151 */         SchemaGrammar sg2 = gs.elementAt(k);
/*     */         int m;
/* 153 */         for (m = 0; m < len && 
/* 154 */           sg2 != grammarList[m]; m++);
/*     */ 
/*     */ 
/*     */ 
/*     */         
...
/* 182 */     for (j = 0; j < len; j++) {
/* 183 */       this.fGrammarMap.put(null2EmptyString(this.fNamespaces[j]), this.fGrammarList[j]);
/*     */       
/* 185 */       if (this.fGrammarList[j].hasIDConstraints()) {
/* 186 */         hasIDC = true;
/*     */       }
/*     */     } 
/*     */     
...
/* 212 */       XSElementDecl head = (XSElementDecl)elements.item(j);
/* 213 */       XSElementDecl[] arrayOfXSElementDecl = sgHandler.getSubstitutionGroup(head);
/* 214 */       subGroupMap.put(head, (arrayOfXSElementDecl.length > 0) ? new XSObjectListImpl((XSObject[])arrayOfXSElementDecl, arrayOfXSElementDecl.length) : XSObjectListImpl.EMPTY_LIST);
/*     */     } 
/*     */     
...
/* 232 */       XSElementDecl head = (XSElementDecl)elements.item(j);
/* 233 */       XSElementDecl[] arrayOfXSElementDecl = sgHandler.getSubstitutionGroup(head);
/* 234 */       subGroupMap.put(head, (arrayOfXSElementDecl.length > 0) ? new XSObjectListImpl((XSObject[])arrayOfXSElementDecl, arrayOfXSElementDecl.length) : XSObjectListImpl.EMPTY_LIST);
/*     */     } 
/*     */     
...
/*     */     
/* 255 */     int start = 0;
/* 256 */     for (int j = 0; j < this.fGrammarCount; j++) {
/* 257 */       tables[j].getValues((Object[])components, start);
/* 258 */       start += tables[j].getLength();
/*     */     } 
/*     */     
...
/* 300 */     if (objectType <= 0 || objectType > 16 || !GLOBAL_COMP[objectType])
/*     */     {
...
/*     */       
/*     */       } 
/* 334 */       if (objectType == 15 || objectType == 16) {
/*     */         
...
/* 360 */     if (objectType <= 0 || objectType > 16 || !GLOBAL_COMP[objectType])
/*     */     {
...
/* 368 */       for (; i < this.fGrammarCount && 
/* 369 */         !namespace.equals(this.fNamespaces[i]); i++);
/*     */     
/*     */     }
/*     */     else {
/*     */ 
/*     */       
/* 375 */       for (; i < this.fGrammarCount && 
/* 376 */         this.fNamespaces[i] != null; i++);
/*     */     } 
/*     */ 
/*     */ 
/*     */     
...
/*     */ 
/*     */       
/* 413 */       if (objectType == 15 || objectType == 16) {
/*     */         
...
/* 641 */     int currPos = 0;
/* 642 */     for (int j = 0; j < this.fGrammarCount; j++) {
/* 643 */       SchemaGrammar currGrammar = this.fGrammarList[j];
...
/*     */       } 
/*     */     } 
/* 649 */     this.fAnnotations = new XSObjectListImpl((XSObject[])annotations, annotations.length);
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xerces/internal/impl/xs/XSModelImpl.class
