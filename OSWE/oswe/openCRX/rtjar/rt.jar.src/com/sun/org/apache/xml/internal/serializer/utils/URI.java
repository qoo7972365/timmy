...
/*      */ 
/*      */     
/*  226 */     if (p_schemeSpecificPart == null || p_schemeSpecificPart
/*  227 */       .trim().length() == 0)
/*      */     {
...
/*      */       {
/*  302 */         throw new MalformedURIException(Utils.messages
/*  303 */             .createMessage("ER_NO_USERINFO_IF_NO_HOST", null));
/*      */       }
/*      */       
/*  306 */       if (p_port != -1)
/*      */       {
/*  308 */         throw new MalformedURIException(Utils.messages
/*  309 */             .createMessage("ER_NO_PORT_IF_NO_HOST", null));
/*      */       }
/*      */     } 
/*      */     
/*  313 */     if (p_path != null) {
...
/*      */       {
/*  317 */         throw new MalformedURIException(Utils.messages
/*  318 */             .createMessage("ER_NO_QUERY_STRING_IN_PATH", null));
/*      */       }
/*      */       
/*  321 */       if (p_path.indexOf('#') != -1 && p_fragment != null)
/*      */       {
/*  323 */         throw new MalformedURIException(Utils.messages
/*  324 */             .createMessage("ER_NO_FRAGMENT_STRING_IN_PATH", null));
/*      */       }
/*      */     } 
/*      */     
...
/*  374 */     if (p_base == null && (p_uriSpec == null || p_uriSpec
/*  375 */       .trim().length() == 0))
/*      */     {
/*  377 */       throw new MalformedURIException(Utils.messages
/*  378 */           .createMessage("ER_CANNOT_INIT_URI_EMPTY_PARMS", null));
/*      */     }
/*      */ 
/*      */     
...
/*      */ 
/*      */     
/*  410 */     if (index + 1 < uriSpecLen && uriSpec
/*  411 */       .substring(index).startsWith("//")) {
/*      */       
/*  413 */       index += 2;
/*      */       
...
/*      */ 
/*      */       
/*  418 */       char testChar = Character.MIN_VALUE;
/*      */       
...
/*  589 */     char testChar = Character.MIN_VALUE;
/*      */     
...
/*  631 */     char testChar = Character.MIN_VALUE;
...
/*  740 */     char testChar = Character.MIN_VALUE;
/*      */ 
/*      */     
/*  743 */     while (index < end) {
/*      */       
...
/*      */         {
/*  758 */           throw new MalformedURIException(Utils.messages
/*  759 */               .createMessage("ER_PATH_CONTAINS_INVALID_ESCAPE_SEQUENCE", null));
/*      */         }
/*      */       }
...
/* 1063 */       char testChar = Character.MIN_VALUE;
/*      */       
...
/*      */       {
/* 1136 */         throw new MalformedURIException(Utils.messages
/* 1137 */             .createMessage("ER_PORT_WHEN_HOST_NULL", null));
/*      */       }
/*      */     }
...
/*      */       {
/* 1298 */         throw new MalformedURIException(Utils.messages
/* 1299 */             .createMessage("ER_FRAG_FOR_GENERIC_URI", null));
/*      */       }
/* 1301 */       if (getPath() == null)
/*      */       {
/* 1303 */         throw new MalformedURIException(Utils.messages
/* 1304 */             .createMessage("ER_FRAG_WHEN_PATH_NULL", null));
/*      */       }
...
/*      */       
/* 1332 */       if (((this.m_scheme == null && testURI.m_scheme == null) || (this.m_scheme != null && testURI.m_scheme != null && this.m_scheme.equals(testURI.m_scheme))) && ((this.m_userinfo == null && testURI.m_userinfo == null) || (this.m_userinfo != null && testURI.m_userinfo != null && this.m_userinfo
/* 1333 */         .equals(testURI.m_userinfo))) && ((this.m_host == null && testURI.m_host == null) || (this.m_host != null && testURI.m_host != null && this.m_host
/* 1334 */         .equals(testURI.m_host))) && this.m_port == testURI.m_port && ((this.m_path == null && testURI.m_path == null) || (this.m_path != null && testURI.m_path != null && this.m_path
/* 1335 */         .equals(testURI.m_path))) && ((this.m_queryString == null && testURI.m_queryString == null) || (this.m_queryString != null && testURI.m_queryString != null && this.m_queryString
/* 1336 */         .equals(testURI.m_queryString))) && ((this.m_fragment == null && testURI.m_fragment == null) || (this.m_fragment != null && testURI.m_fragment != null && this.m_fragment
/* 1337 */         .equals(testURI.m_fragment))))
/*      */       {
/*      */         
/* 1340 */         return true;
/*      */       }
...
/* 1490 */         if (testChar == '.') {
/*      */           
/* 1492 */           if (!isDigit(address.charAt(i - 1)) || (i + 1 < addrLength && 
/* 1493 */             !isDigit(address.charAt(i + 1))))
/*      */           {
/* 1495 */             return false;
/*      */           }
/*      */           
...
/* 1638 */     char testChar = Character.MIN_VALUE;
/*      */     
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xml/internal/serializer/utils/URI.class
