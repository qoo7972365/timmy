...
/*      */     }
/*  872 */     return getString(new StringBuffer(length), startChunk, startColumn, length)
/*  873 */       .toString();
/*      */   }
/*      */ 
/*      */   
...
/*      */         
/* 1060 */         stateForNextChunk = this.m_innerFSB.sendNormalizedSAXcharacters(ch, startColumn, this.m_chunkSize - startColumn);
/*      */       }
/*      */       else {
/*      */         
/* 1064 */         stateForNextChunk = sendNormalizedSAXcharacters(this.m_array[i], startColumn, this.m_chunkSize - startColumn, ch, stateForNextChunk);
/*      */       } 
/*      */ 
/*      */       
/* 1068 */       startColumn = 0;
...
/*      */       
/* 1074 */       stateForNextChunk = this.m_innerFSB.sendNormalizedSAXcharacters(ch, startColumn, stopColumn - startColumn);
/* 1075 */     } else if (stopColumn > startColumn) {
/*      */ 
/*      */       
/* 1078 */       stateForNextChunk = sendNormalizedSAXcharacters(this.m_array[stopChunk], startColumn, stopColumn - startColumn, ch, stateForNextChunk | 0x2);
/*      */     } 
/*      */ 
/*      */     
...
/*      */   }
/*      */   
/* 1085 */   static final char[] SINGLE_SPACE = new char[] { ' ' };
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xml/internal/utils/FastStringBuffer.class
