...
/* 188 */         pos += this.fMaps[i].getValues((Object[])this.fArray, pos);
/*     */       }
/*     */     } 
...
/* 241 */                   return (this.index < length);
/*     */                 }
/*     */                 public Object next() {
/* 244 */                   if (this.index < length) {
/* 245 */                     return entries[this.index++];
/*     */                   }
...
/* 284 */         return (((this.key == null) ? (otherKey == null) : this.key.equals(otherKey)) && ((this.value == null) ? (otherValue == null) : this.value
/* 285 */           .equals(otherValue)));
/*     */       } 
/* 287 */       return false;
/*     */     }
/*     */     public int hashCode() {
/* 290 */       return ((this.key == null) ? 0 : this.key.hashCode()) ^ ((this.value == null) ? 0 : this.value
/* 291 */         .hashCode());
/*     */     }
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xerces/internal/impl/xs/util/XSNamedMapImpl.class
