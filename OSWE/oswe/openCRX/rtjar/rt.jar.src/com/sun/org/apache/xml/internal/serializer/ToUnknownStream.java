...
/*  471 */     startElement((String)null, (String)null, qName, (Attributes)null);
/*      */   }
/*      */ 
/*      */   
/*      */   public void startElement(String namespaceURI, String localName, String qName) throws SAXException {
/*  476 */     startElement(namespaceURI, localName, qName, (Attributes)null);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */       
/* 1015 */       Properties htmlProperties = OutputPropertiesFactory.getDefaultMethodProperties("html");
/*      */       
/* 1017 */       Serializer serializer = SerializerFactory.getSerializer(htmlProperties);
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */       } 
/*      */       
/* 1084 */       this.m_handler.startElement(this.m_firstElementURI, (String)null, this.m_firstElementName, this.m_attributes);
/*      */       
...
/*      */ 
/*      */           
/* 1095 */           String prefix = this.m_namespacePrefix.elementAt(i);
/* 1096 */           String uri = this.m_namespaceURI.elementAt(i);
...
/* 1148 */     boolean isHTML = getLocalNameUnknown(this.m_firstElementName).equalsIgnoreCase("html");
/*      */ 
/*      */     
/* 1151 */     if (isHTML && this.m_firstElementURI != null && 
/*      */       
/* 1153 */       !"".equals(this.m_firstElementURI))
/*      */     {
/*      */       
/* 1156 */       isHTML = false;
/*      */     }
...
/*      */         
/* 1168 */         String prefix = this.m_namespacePrefix.elementAt(i);
/* 1169 */         String uri = this.m_namespaceURI.elementAt(i);
/*      */         
/* 1171 */         if (this.m_firstElementPrefix != null && this.m_firstElementPrefix
/* 1172 */           .equals(prefix) && 
/* 1173 */           !"".equals(uri)) {
/*      */ 
/*      */           
...
/* 1287 */     if (t instanceof SerializerTrace && ((SerializerTrace)t)
/* 1288 */       .hasTraceListeners()) {
/* 1289 */       this.m_tracer = (SerializerTrace)t;
/*      */     } else {
/* 1291 */       this.m_tracer = null;
/*      */     } 
/*      */   }
/*      */   
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xml/internal/serializer/ToUnknownStream.class
