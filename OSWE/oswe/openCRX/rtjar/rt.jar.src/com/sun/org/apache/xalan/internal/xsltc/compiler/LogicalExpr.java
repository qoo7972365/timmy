...
/*  49 */   private static final String[] Ops = new String[] { "or", "and" };
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/* 142 */       Type arg1 = haveType.argsType().elementAt(0);
/* 143 */       if (!arg1.identicalTo(tleft)) {
/* 144 */         this._left = new CastExpr(this._left, arg1);
/*     */       }
/* 146 */       Type arg2 = haveType.argsType().elementAt(1);
...
/*     */ 
/*     */       
/* 192 */       if (this._left instanceof LogicalExpr && ((LogicalExpr)this._left)
/* 193 */         .getOp() == 0) {
...
/*     */ 
/*     */       
/* 205 */       if (this._right instanceof LogicalExpr && ((LogicalExpr)this._right)
/* 206 */         .getOp() == 0) {
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xalan/internal/xsltc/compiler/LogicalExpr.class
