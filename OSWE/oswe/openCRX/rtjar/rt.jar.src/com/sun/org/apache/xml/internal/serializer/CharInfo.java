...
/*     */ 
/*     */   
/*  93 */   private boolean[] isSpecialAttrASCII = new boolean[128];
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*  98 */   private boolean[] isSpecialTextASCII = new boolean[128];
/*     */   
/* 100 */   private boolean[] isCleanTextASCII = new boolean[128];
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 183 */         if (cl != null) {
/* 184 */           entities = PropertyResourceBundle.getBundle(entitiesResource, 
/* 185 */               Locale.getDefault(), cl);
/*     */         }
/*     */       } 
/* 188 */     } catch (Exception exception) {}
/*     */     
/* 190 */     if (entities != null) {
/* 191 */       Enumeration<String> keys = entities.getKeys();
/* 192 */       while (keys.hasMoreElements()) {
/* 193 */         String name = keys.nextElement();
...
/*     */         
/* 231 */         if (is == null) {
/* 232 */           throw new RuntimeException(Utils.messages
/* 233 */               .createMessage("ER_RESOURCE_COULD_NOT_FIND", new Object[] { entitiesResource, err }));
/*     */         }
/*     */ 
/*     */ 
/*     */ 
...
/* 303 */         throw new RuntimeException(Utils.messages
/* 304 */             .createMessage("ER_RESOURCE_COULD_NOT_LOAD", new Object[] {
/*     */ 
/*     */                 
/* 307 */                 entitiesResource, e.toString(), entitiesResource, e
/*     */                 
/* 309 */                 .toString() }));
/*     */       } finally {
/* 311 */         if (is != null) {
...
/*     */         
/* 523 */         absoluteEntitiesFileName = SystemIDResolver.getAbsoluteURIFromRelative(entitiesFileName);
/*     */       } else {
/*     */         
/*     */         try {
/* 527 */           absoluteEntitiesFileName = SystemIDResolver.getAbsoluteURI(entitiesFileName, null);
...
/*     */     }
/* 586 */     this.array_of_bits[j] = this.array_of_bits[j] | 1 << (i & 0x1F);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xml/internal/serializer/CharInfo.class
