...
/*     */ 
/*     */     
/*  71 */     for (int j = 0; j < 65536; j++) {
/*  72 */       int lc = Character.toLowerCase(j);
/*  73 */       int uc = Character.toUpperCase(j);
/*     */ 
/*     */       
/*  76 */       if (lc != uc || lc != j) {
...
/*  84 */           if (lcMap != null) {
/*  85 */             map = updateMap(j, map, lc, lcMap, LOWER_CASE_MATCH);
/*     */           }
/*     */         } 
/*     */         
/*  89 */         if (uc != j) {
...
/*  96 */           if (ucMap != null) {
/*  97 */             map = updateMap(j, map, uc, ucMap, UPPER_CASE_MATCH);
/*     */           }
/*     */         } 
/*     */         
/* 101 */         set(j, map);
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xerces/internal/impl/xpath/regex/CaseInsensitiveMap.class
