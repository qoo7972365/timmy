...
/* 430 */     char[] re1Instructions = { '|', Character.MIN_VALUE, '\032', '|', Character.MIN_VALUE, '\r', 'A', '\001', '\004', 'a', '|', Character.MIN_VALUE, '\003', 'G', Character.MIN_VALUE, '￶', '|', Character.MIN_VALUE, '\003', 'N', Character.MIN_VALUE, '\003', 'A', '\001', '\004', 'b', 'E', Character.MIN_VALUE, Character.MIN_VALUE };
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 476 */     RE r = new RE("a*b");
/* 477 */     String[] s = r.split("xxxxaabxxxxbyyyyaaabzzz"); int i;
/* 478 */     for (i = 0; i < expected.length && i < s.length; i++) {
...
/* 486 */     s = r.grep((Object[])s);
/* 487 */     for (i = 0; i < s.length; i++) {
/*     */       
/* 489 */       say("s[" + i + "] = " + s[i]);
...
/* 531 */     if ((expected != null && !expected.equals(actual)) || (actual != null && 
/* 532 */       !actual.equals(expected)))
/*     */     {
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/regexp/internal/RETest.class
