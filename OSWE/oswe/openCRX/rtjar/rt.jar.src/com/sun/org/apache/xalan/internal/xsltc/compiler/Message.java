...
/*  87 */         il.append(DUP);
/*  88 */         il.append(DUP);
/*  89 */         il.append(new INVOKESPECIAL(cpg
/*  90 */               .addMethodref("java.io.StringWriter", "<init>", "()V")));
/*     */ 
/*     */         
/*  93 */         il.append(methodGen.loadHandler());
/*  94 */         il.append(new INVOKESPECIAL(cpg
/*  95 */               .addMethodref("com.sun.org.apache.xml.internal.serializer.ToXMLStream", "<init>", "()V")));
/*     */ 
/*     */ 
/*     */         
/*  99 */         il.append(methodGen.loadHandler());
/* 100 */         il.append(SWAP);
/* 101 */         il.append(new INVOKEINTERFACE(cpg
/* 102 */               .addInterfaceMethodref("com.sun.org.apache.xml.internal.serializer.SerializationHandler", "setWriter", "(Ljava/io/Writer;)V"), 2));
/*     */ 
/*     */ 
/*     */ 
/*     */         
...
/* 109 */         il.append(new INVOKEINTERFACE(cpg
/* 110 */               .addInterfaceMethodref("com.sun.org.apache.xml.internal.serializer.SerializationHandler", "setEncoding", "(Ljava/lang/String;)V"), 2));
/*     */ 
/*     */ 
/*     */ 
/*     */         
...
/* 117 */         il.append(new INVOKEINTERFACE(cpg
/* 118 */               .addInterfaceMethodref("com.sun.org.apache.xml.internal.serializer.SerializationHandler", "setOmitXMLDeclaration", "(Z)V"), 2));
/*     */ 
/*     */ 
/*     */         
/* 122 */         il.append(methodGen.loadHandler());
/* 123 */         il.append(new INVOKEINTERFACE(cpg
/* 124 */               .addInterfaceMethodref("com.sun.org.apache.xml.internal.serializer.SerializationHandler", "startDocument", "()V"), 1));
/*     */ 
/*     */ 
/*     */ 
/*     */         
...
/* 132 */         il.append(new INVOKEINTERFACE(cpg
/* 133 */               .addInterfaceMethodref("com.sun.org.apache.xml.internal.serializer.SerializationHandler", "endDocument", "()V"), 1));
/*     */ 
/*     */ 
/*     */ 
/*     */         
/* 138 */         il.append(new INVOKEVIRTUAL(cpg
/* 139 */               .addMethodref("java.io.StringWriter", "toString", "()Ljava/lang/String;")));
/*     */ 
/*     */ 
/*     */         
/* 143 */         il.append(SWAP);
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xalan/internal/xsltc/compiler/Message.class
