...
/* 309 */         throw new DOMException((short)7, 
/* 310 */             DOMMessageFormatter.formatMessage("http://www.w3.org/dom/DOMTR", "NO_MODIFICATION_ALLOWED_ERR", null));
/*     */       }
/*     */ 
/*     */ 
/*     */ 
...
/* 317 */         throw new DOMException((short)7, 
/* 318 */             DOMMessageFormatter.formatMessage("http://www.w3.org/dom/DOMTR", "NO_MODIFICATION_ALLOWED_ERR", null));
/*     */       }
/*     */     } 
/*     */ 
/*     */ 
...
/*     */ 
/*     */       
/* 347 */       if (prev.getNodeType() == 3 || prev
/* 348 */         .getNodeType() == 4 || (prev
/* 349 */         .getNodeType() == 5 && hasTextOnlyChildren(prev))) {
...
/*     */ 
/*     */       
/* 365 */       if (next.getNodeType() == 3 || next
/* 366 */         .getNodeType() == 4 || (next
/* 367 */         .getNodeType() == 5 && hasTextOnlyChildren(next))) {
...
/* 617 */     if (isReadOnly()) {
/* 618 */       throw new DOMException((short)7, 
/*     */           
/* 620 */           DOMMessageFormatter.formatMessage("http://www.w3.org/dom/DOMTR", "NO_MODIFICATION_ALLOWED_ERR", null));
/*     */     }
/*     */     
...
/* 627 */       throw new DOMException((short)1, 
/* 628 */           DOMMessageFormatter.formatMessage("http://www.w3.org/dom/DOMTR", "INDEX_SIZE_ERR", null));
/*     */     }
/*     */ 
/*     */ 
/*     */     
/* 633 */     Text newText = getOwnerDocument().createTextNode(this.data.substring(offset));
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xerces/internal/dom/TextImpl.class
