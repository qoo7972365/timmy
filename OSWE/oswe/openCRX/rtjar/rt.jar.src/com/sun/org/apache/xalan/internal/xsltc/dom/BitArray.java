...
/*     */   private int _mask;
/*  47 */   private static final int[] _masks = new int[] { Integer.MIN_VALUE, 1073741824, 536870912, 268435456, 134217728, 67108864, 33554432, 16777216, 8388608, 4194304, 2097152, 1048576, 524288, 262144, 131072, 65536, 32768, 16384, 8192, 4096, 2048, 1024, 512, 256, 128, 64, 32, 16, 8, 4, 2, 1 };
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 153 */       this._int = this._bit = this._pos = 0;
/*     */     }
/*     */ 
/*     */     
/* 157 */     for (; this._int <= this._intSize; this._int++) {
/* 158 */       int bits = this._bits[this._int];
/* 159 */       if (bits != 0) {
/* 160 */         for (; this._bit < 32; this._bit++) {
...
/*     */   }
/*     */   
/* 181 */   int _first = Integer.MAX_VALUE;
/* 182 */   int _last = Integer.MIN_VALUE;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 195 */     if (bit >= this._bitSize)
/* 196 */       return;  int i = bit >>> 5;
/* 197 */     if (i < this._first) this._first = i; 
/* 198 */     if (i > this._last) this._last = i; 
/* 199 */     this._bits[i] = this._bits[i] | _masks[bit % 32];
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 220 */           other._bits[i] = other._bits[i] | this._bits[i]; 
...
/* 227 */           this._bits[i] = this._bits[i] | other._bits[i]; 
/*     */       } 
/*     */     } 
/* 230 */     return this;
/*     */   }
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xalan/internal/xsltc/dom/BitArray.class
