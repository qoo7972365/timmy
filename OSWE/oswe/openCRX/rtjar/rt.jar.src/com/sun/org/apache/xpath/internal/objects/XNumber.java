...
/*     */     
/* 333 */     if (exp >= nDigits) {
/* 334 */       return sign + s.substring(0, 1) + s.substring(2, e) + 
...
/*     */     }
/* 341 */     if (exp > 0) {
/* 342 */       return sign + s.substring(0, 1) + s.substring(2, 2 + exp) + "." + s
/* 343 */         .substring(2 + exp, e);
/*     */     }
/* 345 */     return sign + "0." + zeros(-1 - exp) + s.substring(0, 1) + s
/* 346 */       .substring(2, e);
/*     */   }
/*     */ 
/*     */ 
...
/*     */     }
/* 411 */     catch (TransformerException te) {
/*     */       
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xpath/internal/objects/XNumber.class
