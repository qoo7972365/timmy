...
/*      */ 
/*      */     
/*  814 */     char[] instruction = this.program.instruction; int node;
/*  815 */     for (node = firstNode; node < lastNode; ) {
/*      */       int idxNew, once, s; char cLast, c1; int lenAtom, type; boolean isXDigit; char c; short nextBranch; int e; char cNext; int startAtom; boolean caseFold; int l; boolean bool1; int idxRange; boolean bool2; int i, idxEnd, j; boolean match;
/*  817 */       int k, opcode = instruction[node + 0];
...
/*      */           do {
/*      */             int m;
/*  829 */             if ((m = matchNodes(next, 65536, idx)) != -1)
/*      */             {
/*  831 */               return m;
/*      */             }
/*      */           }
...
/*      */             int m;
/*      */             
/*  842 */             if ((m = matchNodes(next, 65536, idx)) != -1)
/*      */             {
/*  844 */               return m;
/*      */             }
/*      */           } 
...
/*      */           while (true) {
/*      */             int m;
/*  853 */             if ((m = matchNodes(next, 65536, idx)) != -1)
/*      */             {
/*  855 */               return m;
/*      */             }
/*      */             
/*  858 */             if ((idx = matchNodes(node + 3, next, idx)) == -1) {
/*  859 */               return -1;
/*      */             }
/*      */           } 
/*      */         
...
/*      */         
/*      */         case 35:
/*  915 */           s = this.startBackref[opdata];
/*  916 */           e = this.endBackref[opdata];
/*      */ 
/*      */           
/*  919 */           if (s == -1 || e == -1)
/*      */           {
...
/*      */ 
/*      */           
/*  940 */           bool2 = ((this.matchFlags & 0x1) != 0);
/*      */ 
/*      */           
/*  943 */           for (j = 0; j < l; j++) {
/*      */             
/*  945 */             if (compareChars(this.search.charAt(idx++), this.search.charAt(s + j), bool2) != 0)
/*      */             {
/*  947 */               return -1;
/*      */             }
/*      */           } 
...
/* 1001 */               cNext = this.search.isEnd(idx) ? '\n' : this.search.charAt(idx);
/* 1002 */               if (((Character.isLetterOrDigit(cLast) == Character.isLetterOrDigit(cNext)) ? true : false) == ((opdata == 98) ? true : false))
/*      */               {
/* 1004 */                 return -1;
/*      */               }
/*      */               break;
...
/*      */               }
/*      */               
/* 1023 */               c1 = this.search.charAt(idx);
/*      */ 
/*      */               
/* 1026 */               switch (opdata) {
/*      */                 
/*      */                 case 87:
/*      */                 case 119:
/* 1030 */                   if (((Character.isLetterOrDigit(c1) || c1 == '_') ? true : false) != ((opdata == 119) ? true : false))
/*      */                   {
/* 1032 */                     return -1;
/*      */                   }
/*      */                   break;
...
/*      */                 case 68:
/*      */                 case 100:
/* 1038 */                   if (Character.isDigit(c1) != ((opdata == 100)))
/*      */                   {
/* 1040 */                     return -1;
/*      */                   }
/*      */                   break;
...
/*      */                 case 83:
/*      */                 case 115:
/* 1046 */                   if (Character.isWhitespace(c1) != ((opdata == 115)))
/*      */                   {
/* 1048 */                     return -1;
/*      */                   }
/*      */                   break;
...
/*      */ 
/*      */           
/* 1099 */           bool1 = ((this.matchFlags & 0x1) != 0);
/*      */ 
/*      */           
/* 1102 */           for (i = 0; i < lenAtom; i++) {
/*      */             
/* 1104 */             if (compareChars(this.search.charAt(idx++), instruction[startAtom + i], bool1) != 0)
/*      */             {
/* 1106 */               return -1;
/*      */             }
/*      */           } 
...
/*      */             
/*      */             case 33:
/* 1201 */               type = Character.getType(this.search.charAt(idx));
/* 1202 */               switch (type) {
/*      */                 case 20:
/*      */                 case 21:
/*      */                 case 22:
...
/*      */             
/*      */             case 120:
/* 1221 */               isXDigit = ((this.search.charAt(idx) >= '0' && this.search.charAt(idx) <= '9') || (this.search.charAt(idx) >= 'a' && this.search.charAt(idx) <= 'f') || (this.search.charAt(idx) >= 'A' && this.search.charAt(idx) <= 'F'));
/* 1222 */               if (!isXDigit)
/*      */               {
/* 1224 */                 return -1;
/*      */               }
...
/*      */ 
/*      */           
/* 1262 */           c = this.search.charAt(idx);
/* 1263 */           caseFold = ((this.matchFlags & 0x1) != 0);
/*      */           
/* 1265 */           idxRange = node + 3;
/* 1266 */           idxEnd = idxRange + opdata * 2;
/* 1267 */           match = false;
/* 1268 */           for (k = idxRange; !match && k < idxEnd; ) {
/*      */ 
/*      */             
/* 1271 */             char c2 = instruction[k++];
/* 1272 */             char c3 = instruction[k++];
/*      */ 
/*      */             
/* 1275 */             match = (compareChars(c, c2, caseFold) >= 0 && compareChars(c, c3, caseFold) <= 0);
/*      */           } 
/*      */ 
/*      */           
/* 1279 */           if (!match)
...
/* 1492 */     Vector<String> v = new Vector();
/*      */ 
/*      */     
/* 1495 */     int pos = 0;
...
/* 1705 */     Vector<String> v = new Vector();
/*      */ 
/*      */     
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/regexp/internal/RE.class
