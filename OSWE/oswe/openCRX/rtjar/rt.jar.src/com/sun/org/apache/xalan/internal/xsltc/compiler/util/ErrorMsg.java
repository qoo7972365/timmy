...
/* 185 */   private static ResourceBundle _bundle = SecuritySupport.getResourceBundle("com.sun.org.apache.xalan.internal.xsltc.compiler.util.ErrorMessages", 
/*     */       
/* 187 */       Locale.getDefault()); public static final String ERROR_MESSAGES_KEY = "ERROR_MESSAGES_KEY";
...
/* 285 */     String suffix = (this._params == null) ? ((null != this._code) ? getErrorMessage() : this._message) : MessageFormat.format(getErrorMessage(), this._params);
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xalan/internal/xsltc/compiler/util/ErrorMsg.class
