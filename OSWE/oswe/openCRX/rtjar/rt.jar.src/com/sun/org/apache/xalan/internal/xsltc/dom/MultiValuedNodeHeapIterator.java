...
/*     */       HeapNode clone;
/*     */       try {
/*  79 */         clone = (HeapNode)clone();
/*  80 */       } catch (CloneNotSupportedException e) {
/*  81 */         BasisLibrary.runTimeError("ITERATOR_CLONE_ERR", e
/*  82 */             .toString());
/*  83 */         return null;
/*     */       } 
/*     */       
...
/*     */     
/*     */     try {
/* 157 */       MultiValuedNodeHeapIterator clone = (MultiValuedNodeHeapIterator)clone();
/*     */       
...
/* 167 */       BasisLibrary.runTimeError("ITERATOR_CLONE_ERR", e
/* 168 */           .toString());
/* 169 */       return null;
/*     */     } 
/*     */   }
...
/* 213 */       this._startNode = node; int i;
/* 214 */       for (i = 0; i < this._free; i++) {
...
/*     */       } 
/*     */       
/* 222 */       for (i = (this._heapSize = this._free) / 2; i >= 0; i--) {
/* 223 */         heapify(i);
/*     */       }
...
/*     */     while (true) {
/* 245 */       int r = i + 1 << 1, l = r - 1;
/*     */       
/* 247 */       int smallest = (l < this._heapSize && this._heap[l].isLessThan(this._heap[i])) ? l : i;
...
/*     */   public void gotoMark() {
/*     */     int i;
/* 271 */     for (i = 0; i < this._free; i++) {
/* 272 */       this._heap[i].gotoMark();
/*     */     }
/*     */     
/* 275 */     for (i = (this._heapSize = this._cachedHeapSize) / 2; i >= 0; i--) {
/* 276 */       heapify(i);
/*     */     }
...
/*     */     int i;
/* 282 */     for (i = 0; i < this._free; i++) {
/* 283 */       this._heap[i].reset();
/* 284 */       this._heap[i].step();
/*     */     } 
/*     */ 
/*     */     
/* 288 */     for (i = (this._heapSize = this._free) / 2; i >= 0; i--) {
/* 289 */       heapify(i);
/*     */     }
/*     */     
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xalan/internal/xsltc/dom/MultiValuedNodeHeapIterator.class
