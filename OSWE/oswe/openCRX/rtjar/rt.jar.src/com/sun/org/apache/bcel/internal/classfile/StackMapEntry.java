...
/*     */     
/*  90 */     this.types_of_locals = new StackMapType[this.number_of_locals]; int i;
/*  91 */     for (i = 0; i < this.number_of_locals; i++) {
...
/*  96 */     for (i = 0; i < this.number_of_stack_items; i++) {
...
/*     */     
/* 123 */     file.writeShort(this.number_of_locals); int i;
/* 124 */     for (i = 0; i < this.number_of_locals; i++) {
/* 125 */       this.types_of_locals[i].dump(file);
/*     */     }
/* 127 */     file.writeShort(this.number_of_stack_items);
/* 128 */     for (i = 0; i < this.number_of_stack_items; i++) {
...
/* 176 */   public void setTypesOfStackItems(StackMapType[] t) { this.types_of_stack_items = t; } public StackMapType[] getTypesOfStackItems() {
/* 177 */     return this.types_of_stack_items;
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 185 */     } catch (CloneNotSupportedException cloneNotSupportedException) {
/*     */       
/* 187 */       return null;
/*     */     } 
/*     */   }
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/bcel/internal/classfile/StackMapEntry.class
