...
/*      */ {
/*   96 */   private static String fEpsilonString = "<<CMNODE_EPSILON>>";
/*      */ 
/*      */   
/*   99 */   private static String fEOCString = "<<CMNODE_EOC>>";
/*      */   private static final boolean DEBUG_VALIDATE_CONTENT = false;
/*      */   
/*      */   static {
/*  103 */     fEpsilonString = fEpsilonString.intern();
/*  104 */     fEOCString = fEOCString.intern();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */         
/*  347 */         int elemIndex = 0;
/*  348 */         for (; elemIndex < this.fElemMapSize; elemIndex++) {
/*      */           
...
/*      */ 
/*      */     
/*  411 */     if (!this.fFinalStateFlags[curState]) {
/*  412 */       return length;
/*      */     }
/*      */     
/*  415 */     return -1;
...
/*      */       
/*  549 */       int inIndex = 0;
/*  550 */       for (; inIndex < this.fElemMapSize; inIndex++) {
/*      */         
...
/*      */ 
/*      */     
/*  640 */     HashMap<Object, Object> stateTable = new HashMap<>();
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */       
/*  669 */       for (int i = 0; i < this.fElemMapSize; i++) {
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/*      */     }
/*  865 */     else if (nodeCur.type() == 2 || nodeCur
/*  866 */       .type() == 3) {
/*      */ 
/*      */       
...
/*      */       
/*  946 */       System.out
/*  947 */         .print("Leaf: (pos=" + ((CMLeaf)nodeCur)
/*      */           
/*  949 */           .getPosition() + "), " + ((CMLeaf)nodeCur)
/*      */           
/*  951 */           .getElement() + "(elemIndex=" + ((CMLeaf)nodeCur)
/*      */           
/*  953 */           .getElement() + ") ");
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/*  992 */     if ((nodeCur.type() & 0xF) == 6 || (nodeCur
/*  993 */       .type() & 0xF) == 8 || (nodeCur
/*  994 */       .type() & 0xF) == 7) {
/*      */       
...
/*  999 */       curIndex++;
/*      */     }
/* 1001 */     else if (nodeCur.type() == 4 || nodeCur
/* 1002 */       .type() == 5) {
/*      */       
...
/*      */     }
/* 1007 */     else if (nodeCur.type() == 2 || nodeCur
/* 1008 */       .type() == 3 || nodeCur
/* 1009 */       .type() == 1) {
/*      */       
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xerces/internal/impl/dtd/models/DFAContentModel.class
