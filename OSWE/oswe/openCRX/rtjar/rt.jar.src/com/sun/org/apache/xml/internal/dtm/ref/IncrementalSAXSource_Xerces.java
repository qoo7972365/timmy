...
/* 107 */       Constructor<SAXParser> ctor = SAXParser.class.getConstructor(args1);
/*     */ 
/*     */ 
/*     */ 
/*     */       
...
/* 117 */       this.fIncrementalParser = ctor.newInstance(args2);
/*     */ 
/*     */ 
/*     */ 
/*     */       
...
/*     */     
/*     */     }
/* 242 */     catch (SAXNotRecognizedException sAXNotRecognizedException) {
/*     */ 
/*     */     
/*     */     }
/* 246 */     catch (SAXNotSupportedException sAXNotSupportedException) {}
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 365 */   private static final Object[] parmsfalse = new Object[] { Boolean.FALSE };
/*     */ 
/*     */ 
/*     */ 
/*     */   
...
/*     */       
/* 373 */       Object object = this.fConfigParse.invoke(this.fPullParserConfig, parmsfalse);
/* 374 */       return ((Boolean)object).booleanValue();
/*     */     } 
/*     */ 
/*     */     
...
/*     */       return;
/*     */     } 
/* 400 */     IncrementalSAXSource parser = createIncrementalSAXSource();
/*     */ 
/*     */ 
/*     */     
...
/* 418 */         result = parser.deliverMoreNodes(more);
/* 419 */         for (; result == Boolean.TRUE; 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xml/internal/dtm/ref/IncrementalSAXSource_Xerces.class
