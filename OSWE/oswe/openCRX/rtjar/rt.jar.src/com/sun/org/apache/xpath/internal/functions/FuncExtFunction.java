...
/*     */         
/*  96 */         Expression arg = this.m_argVec.elementAt(i);
/*     */         
...
/* 141 */       return this.m_argVec.elementAt(n);
/*     */     }
/* 143 */     return null;
/*     */   }
/*     */ 
...
/* 189 */           XPATHMessages.createXPATHMessage("ER_EXTENSION_FUNCTION_CANNOT_BE_INVOKED", new Object[] {
/*     */               
/* 191 */               toString()
/*     */             }));
/*     */     }
/* 194 */     Vector<XObject> argVec = new Vector();
/* 195 */     int nArgs = this.m_argVec.size();
/*     */     
/* 197 */     for (int i = 0; i < nArgs; i++) {
/*     */       
/* 199 */       Expression arg = this.m_argVec.elementAt(i);
/*     */       
...
/*     */       
/* 289 */       Expression exp = this.m_argVec.elementAt(i);
...
/*     */       
/* 311 */       Expression arg = this.m_argVec.elementAt(i);
/*     */       
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xpath/internal/functions/FuncExtFunction.class
