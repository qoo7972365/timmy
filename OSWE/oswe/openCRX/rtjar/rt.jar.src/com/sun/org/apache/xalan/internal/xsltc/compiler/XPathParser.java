...
/*      */ 
/*      */   
/*      */   public StepPattern createStepPattern(int axis, Object test, Vector<Predicate> predicates) {
/*      */     int nodeType;
/*  932 */     if (test == null) {
/*  933 */       nodeType = (axis == 2) ? 2 : ((axis == 9) ? -1 : 1);
/*      */ 
/*      */       
...
/*  947 */     if (axis == 9) {
/*      */       
/*  949 */       nodeType = name.toString().equals("*") ? -1 : this._xsltc.registerNamespacePrefix(name);
/*      */     } else {
/*      */       
...
/*      */       else {
/*      */         
/*  982 */         nodeType = (axis == 2) ? this._xsltc.registerAttribute(name) : this._xsltc.registerElement(name);
/*      */       } 
/*      */     } 
/*      */     
...
/*  998 */     if (test == null) {
/*  999 */       return (axis == 2) ? 2 : ((axis == 9) ? -1 : 1);
/*      */     }
/*      */ 
/*      */     
...
/*      */     
/* 1009 */     if (axis == 9) {
/* 1010 */       return name.toString().equals("*") ? -1 : this._xsltc
/* 1011 */         .registerNamespacePrefix(name);
/*      */     }
/*      */     
...
/*      */     } 
/*      */     
/* 1026 */     return (axis == 2) ? this._xsltc.registerAttribute(name) : this._xsltc
/* 1027 */       .registerElement(name);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1086 */       return new ParentLocationPath(step, rlp);
/*      */     }
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xalan/internal/xsltc/compiler/XPathParser.class
