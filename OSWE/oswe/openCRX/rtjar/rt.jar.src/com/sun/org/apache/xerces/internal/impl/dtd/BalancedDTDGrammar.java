...
/* 174 */       if (occurrence == 2) {
/* 175 */         this.fGroupIndexStack[this.fDepth][currentIndex] = addContentSpecNode((short)1, this.fGroupIndexStack[this.fDepth][currentIndex], -1);
/*     */       }
/* 177 */       else if (occurrence == 3) {
/* 178 */         this.fGroupIndexStack[this.fDepth][currentIndex] = addContentSpecNode((short)2, this.fGroupIndexStack[this.fDepth][currentIndex], -1);
/*     */       }
/* 180 */       else if (occurrence == 4) {
/* 181 */         this.fGroupIndexStack[this.fDepth][currentIndex] = addContentSpecNode((short)3, this.fGroupIndexStack[this.fDepth][currentIndex], -1);
/*     */       } 
/*     */     } 
/*     */   }
/*     */ 
...
/* 238 */     return addContentSpecNode(this.fOpStack[this.fDepth], 
...
/* 274 */     this.fGroupIndexStackSizes[this.fDepth] = this.fGroupIndexStackSizes[this.fDepth] + 1; int length = this.fGroupIndexStackSizes[this.fDepth];
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xerces/internal/impl/dtd/BalancedDTDGrammar.class
