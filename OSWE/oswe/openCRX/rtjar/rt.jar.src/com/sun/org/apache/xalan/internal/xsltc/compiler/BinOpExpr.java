...
/*  45 */   private static final String[] Ops = new String[] { "+", "-", "*", "/", "%" };
/*     */   
/*     */   private int _op;
/*     */   
...
/*     */     
/*  87 */     if (ptype != null) {
/*  88 */       Type arg1 = ptype.argsType().elementAt(0);
/*  89 */       if (!arg1.identicalTo(tleft)) {
/*  90 */         this._left = new CastExpr(this._left, arg1);
/*     */       }
/*  92 */       Type arg2 = ptype.argsType().elementAt(1);
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xalan/internal/xsltc/compiler/BinOpExpr.class
