...
/*     */         }
/* 184 */         buf.append("(").append(this.match[i]).append(", ")
/* 185 */           .append(s).append(" = {").append(this.indices[i]).append("})");
/*     */       } 
/*     */     } else {
/*     */       
/* 189 */       buf.append(" ...");
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/bcel/internal/generic/Select.class
