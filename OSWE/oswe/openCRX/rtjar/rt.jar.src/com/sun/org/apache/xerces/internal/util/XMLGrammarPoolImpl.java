...
/* 175 */         int index = (hash & Integer.MAX_VALUE) % this.fGrammars.length; Entry entry;
/* 176 */         for (entry = this.fGrammars[index]; entry != null; entry = entry.next) {
...
/*     */           } 
/*     */         } 
/* 183 */         entry = new Entry(hash, desc, grammar, this.fGrammars[index]);
/* 184 */         this.fGrammars[index] = entry;
/* 185 */         this.fGrammarCount++;
/*     */       } 
/*     */     }
/*     */   }
/*     */ 
...
/* 200 */       int index = (hash & Integer.MAX_VALUE) % this.fGrammars.length;
...
/* 222 */       int index = (hash & Integer.MAX_VALUE) % this.fGrammars.length;
/* 223 */       for (Entry entry = this.fGrammars[index], prev = null; entry != null; prev = entry, entry = entry.next) {
...
/* 252 */       int index = (hash & Integer.MAX_VALUE) % this.fGrammars.length;
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xerces/internal/util/XMLGrammarPoolImpl.class
