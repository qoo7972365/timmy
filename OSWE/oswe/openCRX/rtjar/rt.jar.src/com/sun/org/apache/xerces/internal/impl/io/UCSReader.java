...
/* 173 */       for (int j = 0; j < numToRead; j++) {
/* 174 */         int charRead = this.fInputStream.read();
/* 175 */         if (charRead == -1) {
/* 176 */           for (int k = j; k < numToRead; k++)
/* 177 */             this.fBuffer[count + k] = 0; 
/*     */           break;
/*     */         } 
/* 180 */         this.fBuffer[count + j] = (byte)charRead;
/*     */       } 
/*     */       
/* 183 */       count += numToRead;
/*     */     } else {
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xerces/internal/impl/io/UCSReader.class
