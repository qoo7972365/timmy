...
/*     */     
/* 145 */     Vector<String> annotationLocalAttrs = (Vector)parentAttrs[XSAttributeChecker.ATTIDX_NONSCHEMA];
/*     */     
...
/* 153 */         String prefix, localpart, rawname = annotationLocalAttrs.elementAt(i++);
...
/* 170 */           .append("=\"");
/* 171 */         String value = annotationLocalAttrs.elementAt(i++);
/*     */         
...
/*     */     
/* 208 */     Vector<String> annotationLocalAttrs = (Vector)parentAttrs[XSAttributeChecker.ATTIDX_NONSCHEMA];
/*     */     
...
/* 261 */     this.fPattern = new StringBuffer();
/* 262 */     this.xsFacets = new XSFacets();
...
/* 287 */     Vector<String> enumData = null;
/* 288 */     XSObjectListImpl enumAnnotations = null;
/* 289 */     XSObjectListImpl patternAnnotations = null;
/* 290 */     Vector<NamespaceSupport> enumNSDecls = hasQName ? new Vector() : null;
...
/*     */ 
/*     */         
/* 313 */         if (baseValidator.getVariety() == 1 && baseValidator
/* 314 */           .getPrimitiveKind() == 20) {
/*     */           
/* 316 */           schemaDoc.fValidationContext.setNamespaceSupport(nsDecls);
/* 317 */           Object notation = null;
/*     */           try {
/* 319 */             QName temp = (QName)fQNameDV.validate(enumVal, schemaDoc.fValidationContext, (ValidatedInfo)null);
/*     */ 
/*     */             
...
/*     */ 
/*     */           
/* 461 */           if (content.getAttributeNodeNS((String)null, "value") == null) {
...
/* 563 */       this.xsFacets.enumNSDecls = (List)enumNSDecls;
...
/*     */           } else {
/*     */             
/* 624 */             otherUse = attrGrp.getAttributeUseNoProhibited(tempAttrUse.fAttrDecl
/* 625 */                 .getNamespace(), tempAttrUse.fAttrDecl
/* 626 */                 .getName());
...
/*     */             } else {
/*     */               
/* 655 */               otherUse = attrGrp.getAttributeUseNoProhibited(oneAttrUse.fAttrDecl
/* 656 */                   .getNamespace(), oneAttrUse.fAttrDecl
/* 657 */                   .getName());
...
/*     */               
/* 679 */               attrGrp
/* 680 */                 .fAttributeWC = attrGrp.fAttributeWC.performIntersectionWith(tempAttrGrp.fAttributeWC, attrGrp.fAttributeWC.fProcessContents);
...
/*     */         
/* 697 */         XSWildcardDecl tempAttrWC = this.fSchemaHandler.fWildCardTraverser.traverseAnyAttribute(child, schemaDoc, grammar);
...
/*     */           
/* 703 */           attrGrp
/* 704 */             .fAttributeWC = tempAttrWC.performIntersectionWith(attrGrp.fAttributeWC, tempAttrWC.fProcessContents);
...
/* 729 */     if (typeDecl.getTypeCategory() == 16 && ((XSSimpleType)typeDecl)
/* 730 */       .getVariety() == 1 && ((XSSimpleType)typeDecl)
/* 731 */       .getPrimitiveKind() == 20 && ((
/* 732 */       (XSSimpleType)typeDecl).getDefinedFacets() & 0x800) == 0) {
...
/* 781 */       if (max != 1) {
/* 782 */         reportSchemaError("cos-all-limited.2", new Object[] { (max == -1) ? "unbounded" : 
/* 783 */               Integer.toString(max), ((XSElementDecl)particle.fValue)
/* 784 */               .getName() }, parent);
/* 785 */         max = 1;
/* 786 */         if (min > 1) {
/* 787 */           min = 1;
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xerces/internal/impl/xs/traversers/XSDAbstractTraverser.class
