...
/*     */ 
/*     */       
/* 193 */       if (this._format.getLineWidth() > 0 && this._thisIndent + this._line
/* 194 */         .length() + this._spaces + this._text.length() > this._format.getLineWidth()) {
/* 195 */         flushLine(false);
/*     */         
/*     */         try {
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xml/internal/serialize/IndentPrinter.class
