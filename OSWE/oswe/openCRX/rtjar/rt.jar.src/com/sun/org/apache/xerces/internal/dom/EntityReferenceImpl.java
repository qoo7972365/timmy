...
/* 169 */       if (null != (doctype = getOwnerDocument().getDoctype()) && null != (
/* 170 */         entities = doctype.getEntities())) {
/*     */         
...
/*     */     
/*     */     NamedNodeMap entities;
/* 264 */     if (null != (doctype = getOwnerDocument().getDoctype()) && null != (
/* 265 */       entities = doctype.getEntities())) {
/*     */       
...
/* 275 */       Node defkid = entDef.getFirstChild();
/* 276 */       for (; defkid != null; 
/* 277 */         defkid = defkid.getNextSibling()) {
/* 278 */         Node newkid = defkid.cloneNode(true);
/* 279 */         insertBefore(newkid, (Node)null);
/*     */       } 
...
/*     */       }
/*     */       
/* 302 */       ChildNode mykid = this.firstChild;
/* 303 */       for (; mykid != null; 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xerces/internal/dom/EntityReferenceImpl.class
