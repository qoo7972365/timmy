...
/*     */   
/*     */   public Code(Code c) {
/*  98 */     this(c.getNameIndex(), c.getLength(), c.getMaxStack(), c.getMaxLocals(), c
/*  99 */         .getCode(), c.getExceptionTable(), c.getAttributes(), c
/* 100 */         .getConstantPool());
/*     */   }
/*     */ 
/*     */ 
...
/* 113 */     this(name_index, length, file
/* 114 */         .readUnsignedShort(), file.readUnsignedShort(), (byte[])null, (CodeException[])null, (Attribute[])null, constant_pool);
/*     */ 
/*     */ 
/*     */     
...
/*     */     int i;
/* 128 */     for (i = 0; i < this.exception_table_length; i++) {
...
/* 136 */     for (i = 0; i < this.attributes_count; i++) {
...
/*     */     
/* 199 */     file.writeShort(this.exception_table_length); int i;
/* 200 */     for (i = 0; i < this.exception_table_length; i++) {
/* 201 */       this.exception_table[i].dump(file);
/*     */     }
/* 203 */     file.writeShort(this.attributes_count);
/* 204 */     for (i = 0; i < this.attributes_count; i++) {
...
/* 332 */     StringBuffer buf = new StringBuffer("Code(max_stack = " + this.max_stack + ", max_locals = " + this.max_locals + ", code_length = " + this.code_length + ")\n" + Utility.codeToString(this.code, this.constant_pool, 0, -1, verbose));
/*     */     
...
/*     */     
/* 366 */     c.exception_table = new CodeException[this.exception_table_length]; int i;
/* 367 */     for (i = 0; i < this.exception_table_length; i++) {
/* 368 */       c.exception_table[i] = this.exception_table[i].copy();
/*     */     }
/* 370 */     c.attributes = new Attribute[this.attributes_count];
/* 371 */     for (i = 0; i < this.attributes_count; i++) {
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/bcel/internal/classfile/Code.class
