...
/*  490 */     appendStartElement(this.m_nsNames.stringToIndex(namespaceURI), this.m_localNames
/*  491 */         .stringToIndex(localName), this.m_prefixNames
/*  492 */         .stringToIndex(prefix));
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*      */ 
/*      */         
/*  517 */         appendNSDeclaration(this.m_prefixNames
/*  518 */             .stringToIndex(prefix), this.m_nsNames
/*  519 */             .stringToIndex(atts.getValue(i)), atts
/*  520 */             .getType(i).equalsIgnoreCase("ID"));
/*      */       } 
/*      */     } 
/*      */     
/*  524 */     for (i = nAtts - 1; i >= 0; i--) {
/*      */       
...
/*  550 */           appendAttribute(this.m_nsNames.stringToIndex(atts.getURI(i)), this.m_localNames
/*  551 */               .stringToIndex(localName), this.m_prefixNames
/*  552 */               .stringToIndex(prefix), atts
/*  553 */               .getType(i).equalsIgnoreCase("ID"), this.m_char_current_start, contentEnd - this.m_char_current_start);
/*      */         }
...
/* 1201 */     nodeHandle &= 0x7FFFFF;
/*      */     
/* 1203 */     if (nodeHandle == 0) {
/* 1204 */       return -1;
/*      */     }
/* 1206 */     int parent = this.nodes.readEntry(nodeHandle, 1);
/* 1207 */     int kid = -1; int nextkid;
/* 1208 */     for (nextkid = getFirstChild(parent); nextkid != nodeHandle; 
...
/* 1269 */     subtreeRootHandle &= 0x7FFFFF;
/* 1270 */     nodeHandle &= 0x7FFFFF;
/*      */     
...
/*      */ 
/*      */   
/* 1588 */   private static final String[] fixednames = new String[] { null, null, null, "#text", "#cdata_section", null, null, null, "#comment", "#document", null, "#document-fragment", null };
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xml/internal/dtm/ref/DTMDocumentImpl.class
