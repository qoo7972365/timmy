...
/* 131 */     return (this.fCatalogsList != null) ? (String[])this.fCatalogsList
/* 132 */       .clone() : null;
/*     */   }
/*     */ 
/*     */ 
...
/* 146 */     this
/* 147 */       .fCatalogsList = (catalogs != null) ? (String[])catalogs.clone() : null;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/*     */       }
/* 283 */       catch (MalformedURIException malformedURIException) {}
/*     */     }
/*     */     
...
/*     */         
/*     */         }
/* 353 */         catch (MalformedURIException malformedURIException) {}
/*     */       }
/*     */ 
/*     */ 
/*     */ 
...
/* 397 */       return new XMLInputSource(resourceIdentifier.getPublicId(), resolvedId, resourceIdentifier
/*     */           
/* 399 */           .getBaseSystemId());
/*     */     }
/* 401 */     return null;
...
/*     */ 
/*     */       
/* 437 */       String systemId = getUseLiteralSystemId() ? resourceIdentifier.getLiteralSystemId() : resourceIdentifier.getExpandedSystemId();
...
/*     */     } 
/* 471 */     return (this.fCatalog != null) ? this.fCatalog
/* 472 */       .resolveSystem(systemId) : null;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     } 
/* 497 */     return (this.fCatalog != null) ? this.fCatalog
/* 498 */       .resolvePublic(publicId, systemId) : null;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     } 
/* 526 */     return (this.fCatalog != null) ? this.fCatalog
/* 527 */       .resolveURI(uri) : null;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 577 */     SAXParserFactory spf = JdkXmlUtils.getSAXFactory(catalog
/* 578 */         .getCatalogManager().overrideDefaultParser());
...
/*     */     
/* 584 */     catalog.addReader("application/xml", (CatalogReader)saxReader);
/*     */   }
/*     */ }


/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xerces/internal/util/XMLCatalogResolver.class
