...
/*      */     
/*  145 */     if (deep) {
/*  146 */       ChildNode child = this.firstChild;
/*  147 */       for (; child != null; 
...
/*      */     }
/*  182 */     ChildNode child = this.firstChild;
/*  183 */     for (; child != null; child = child.nextSibling) {
...
/*  320 */         Node kid = newChild.getFirstChild();
/*  321 */         for (; kid != null; kid = kid.getNextSibling()) {
/*      */           
/*  323 */           if (!this.ownerDocument.isKidOK(this, kid)) {
/*  324 */             throw new DOMException((short)3, 
/*      */                 
/*  326 */                 DOMMessageFormatter.formatMessage("http://www.w3.org/dom/DOMTR", "HIERARCHY_REQUEST_ERR", null));
/*      */           }
/*      */         } 
/*      */       } 
/*      */       
...
/*  350 */       if (isReadOnly()) {
/*  351 */         throw new DOMException((short)7, 
/*      */             
/*  353 */             DOMMessageFormatter.formatMessage("http://www.w3.org/dom/DOMTR", "NO_MODIFICATION_ALLOWED_ERR", null));
/*      */       }
/*  355 */       if (newChild.getOwnerDocument() != this.ownerDocument && newChild != this.ownerDocument) {
/*  356 */         throw new DOMException((short)4, 
/*  357 */             DOMMessageFormatter.formatMessage("http://www.w3.org/dom/DOMTR", "WRONG_DOCUMENT_ERR", null));
/*      */       }
/*  359 */       if (!this.ownerDocument.isKidOK(this, newChild)) {
/*  360 */         throw new DOMException((short)3, 
/*  361 */             DOMMessageFormatter.formatMessage("http://www.w3.org/dom/DOMTR", "HIERARCHY_REQUEST_ERR", null));
/*      */       }
/*      */       
/*  364 */       if (refChild != null && refChild.getParentNode() != this) {
/*  365 */         throw new DOMException((short)8, 
/*  366 */             DOMMessageFormatter.formatMessage("http://www.w3.org/dom/DOMTR", "NOT_FOUND_ERR", null));
/*      */       }
/*      */ 
/*      */ 
/*      */ 
...
/*      */         }
/*  378 */         if (!treeSafe) {
/*  379 */           throw new DOMException((short)3, 
/*  380 */               DOMMessageFormatter.formatMessage("http://www.w3.org/dom/DOMTR", "HIERARCHY_REQUEST_ERR", null));
/*      */         }
/*      */       } 
/*      */     } 
/*      */ 
...
/*  446 */         this.fNodeListCache.fLength++;
/*      */       }
...
/*  497 */       if (isReadOnly()) {
/*  498 */         throw new DOMException((short)7, 
/*      */             
/*  500 */             DOMMessageFormatter.formatMessage("http://www.w3.org/dom/DOMTR", "NO_MODIFICATION_ALLOWED_ERR", null));
/*      */       }
/*  502 */       if (oldChild != null && oldChild.getParentNode() != this) {
/*  503 */         throw new DOMException((short)8, 
/*  504 */             DOMMessageFormatter.formatMessage("http://www.w3.org/dom/DOMTR", "NOT_FOUND_ERR", null));
/*      */       }
/*      */     } 
/*      */     
...
/*  653 */     return (child.getNodeType() != 8 && child
/*  654 */       .getNodeType() != 7 && (child
/*  655 */       .getNodeType() != 3 || 
/*  656 */       !((TextImpl)child).isIgnorableWhitespace()));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */         
/*  704 */         l = this.fNodeListCache.fChildIndex;
...
/*      */ 
/*      */       
/*  909 */       ChildNode mykid = this.firstChild;
/*  910 */       for (; mykid != null; 
...
/*      */ 
/*      */       
/*  954 */       if ((prev != null && prev.getNodeType() == 3) || (next != null && next
/*  955 */         .getNodeType() == 3)) {
...
/*  984 */     if (previousSibling != null && previousSibling
/*  985 */       .getNodeType() == 3) {
/*      */       
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xerces/internal/dom/ParentNode.class
