...
/*  61 */       public Node item(int index) { return null; } public int getLength() {
/*  62 */         return 0;
/*     */       }
/*     */     };
/*     */ 
...
/*     */     
/*     */     try {
/* 250 */       String value = this.data.substring(0, offset) + ((tailLength > 0) ? this.data.substring(offset + count, offset + count + tailLength) : "");
/*     */       
...
/*     */     
/*     */     try {
/* 302 */       String value = (new StringBuffer(this.data)).insert(offset, data).toString();
/*     */ 
/*     */       
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xerces/internal/dom/CharacterDataImpl.class
