...
/*  80 */     if (!(ftype instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.util.NodeSetType)) {
/*  81 */       if (ftype instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.util.ReferenceType) {
...
/*     */       
/*     */       }
/*  89 */       else if (ftype instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.util.NodeType) {
...
/*  99 */     if (!(ptype instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.util.NodeSetType)) {
...
/*     */     
/* 129 */     LocalVariableGen filterTemp = methodGen.addLocalVariable("filter_parent_path_tmp1", 
/* 130 */         Util.getJCRefType("Lcom/sun/org/apache/xml/internal/dtm/DTMAxisIterator;"), null, null);
/*     */     
/* 132 */     filterTemp.setStart(il.append(new ASTORE(filterTemp.getIndex())));
/*     */     
/* 134 */     this._path.translate(classGen, methodGen);
/*     */     
/* 136 */     LocalVariableGen pathTemp = methodGen.addLocalVariable("filter_parent_path_tmp2", 
/* 137 */         Util.getJCRefType("Lcom/sun/org/apache/xml/internal/dtm/DTMAxisIterator;"), null, null);
/*     */     
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xalan/internal/xsltc/compiler/FilterParentPath.class
