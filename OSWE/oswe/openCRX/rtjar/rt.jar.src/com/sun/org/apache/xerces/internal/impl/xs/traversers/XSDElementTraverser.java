...
/*     */     } else {
/* 130 */       traverseLocal(particle, elmDecl, schemaDoc, grammar, allContextFlags, parent, (String[])null);
/*     */       
...
/* 220 */     checkOccurrences(particle, SchemaSymbols.ELT_ELEMENT, (Element)elmDecl
/* 221 */         .getParentNode(), allContextFlags, defaultVals
/* 222 */         .longValue());
/*     */     
...
/* 242 */     XSElementDecl element = traverseNamedElement(elmDecl, attrValues, schemaDoc, grammar, true, (XSObject)null);
...
/* 316 */         element.fBlock = (short)(element.fBlock & 0x7);
/*     */       }
/*     */     } else {
/*     */       
...
/*     */     
/* 335 */     element.fFinal = (short)(element.fFinal & 0x3);
/*     */     
...
/* 427 */       while (child != null && (childName
/* 428 */         .equals(SchemaSymbols.ELT_KEY) || childName
/* 429 */         .equals(SchemaSymbols.ELT_KEYREF) || childName
/* 430 */         .equals(SchemaSymbols.ELT_UNIQUE))) {
/*     */         
/* 432 */         if (childName.equals(SchemaSymbols.ELT_KEY) || childName
/* 433 */           .equals(SchemaSymbols.ELT_UNIQUE)) {
/*     */ 
/*     */           
...
/* 439 */             this.fSchemaHandler.checkForDuplicateNames((schemaDoc.fTargetNamespace == null) ? ("," + 
/* 440 */                 DOMUtil.getAttrValue(child, SchemaSymbols.ATT_NAME)) : (schemaDoc.fTargetNamespace + "," + 
/* 441 */                 DOMUtil.getAttrValue(child, SchemaSymbols.ATT_NAME)), 1, this.fSchemaHandler
/* 442 */                 .getIDRegistry(), this.fSchemaHandler.getIDRegistry_sub(), child, schemaDoc);
/*     */           }
/*     */         }
...
/* 518 */       elementType.getTypeCategory() == 16 && ((XSSimpleType)elementType)
/* 519 */       .isIDType()) || (elementType
/* 520 */       .getTypeCategory() == 15 && ((XSComplexTypeDecl)elementType)
/* 521 */       .containsTypeID()))) {
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xerces/internal/impl/xs/traversers/XSDElementTraverser.class
