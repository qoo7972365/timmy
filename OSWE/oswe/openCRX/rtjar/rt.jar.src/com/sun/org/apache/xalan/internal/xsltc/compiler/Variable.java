...
/* 130 */         this._local = methodGen.addLocalVariable2(getEscapedName(), this._type
/* 131 */             .toJCType(), null);
/*     */       }
/*     */ 
/*     */       
/* 135 */       if (this._type instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.util.IntType || this._type instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.util.NodeType || this._type instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.util.BooleanType) {
/*     */ 
/*     */         
/* 138 */         il.append(new ICONST(0));
/* 139 */       } else if (this._type instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.util.RealType) {
...
/*     */       }
/*     */       
/* 175 */       InstructionHandle storeInst = il.append(this._type.STORE(this._local.getIndex()));
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 190 */         classGen.addField(new Field(1, cpg
/* 191 */               .addUtf8(name), cpg
/* 192 */               .addUtf8(signature), null, cpg
/* 193 */               .getConstantPool()));
/*     */ 
/*     */         
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xalan/internal/xsltc/compiler/Variable.class
