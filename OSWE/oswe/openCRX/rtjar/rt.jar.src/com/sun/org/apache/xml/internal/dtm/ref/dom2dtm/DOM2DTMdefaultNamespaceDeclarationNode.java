...
/*     */ {
/*  57 */   final String NOT_SUPPORTED_ERR = "Unsupported operation on pseudonode"; Element pseudoparent;
/*     */   String prefix;
/*     */   String uri;
/*     */   String nodename;
/*     */   int handle;
...
/*  76 */   public String getValue() { return this.uri; } public Element getOwnerElement() {
/*  77 */     return this.pseudoparent;
/*     */   }
...
/*  86 */   public Node getNextSibling() { return null; } public boolean getSpecified() {
/*  87 */     return false;
/*     */   }
/*  89 */   public NodeList getChildNodes() { return null; } public void normalize() {} public NamedNodeMap getAttributes() {
/*  90 */     return null; }
...
/*  99 */   public Document getOwnerDocument() { return this.pseudoparent.getOwnerDocument(); } public Node cloneNode(boolean deep) {
/* 100 */     throw new DTMException("Unsupported operation on pseudonode");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/*     */       case 1:
/* 316 */         namespace = getNamespaceURI();
/* 317 */         prefix = getPrefix();
...
/*     */               
/* 338 */               if (specifiedPrefix == null && attr
/* 339 */                 .getNodeName().equals("xmlns"))
/*     */               {
/* 341 */                 return value; } 
/* 342 */               if (attrPrefix != null && attrPrefix
/* 343 */                 .equals("xmlns") && attr
/* 344 */                 .getLocalName().equals(specifiedPrefix))
/*     */               {
/* 346 */                 return value;
/*     */               }
/*     */             } 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xml/internal/dtm/ref/dom2dtm/DOM2DTMdefaultNamespaceDeclarationNode.class
