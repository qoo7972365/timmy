...
/* 197 */       il.append(I2C);
/*     */     }
/* 199 */     else if (clazz == byte.class) {
/* 200 */       il.append(I2B);
/*     */     }
/* 202 */     else if (clazz == short.class) {
/* 203 */       il.append(I2S);
/*     */     }
/* 205 */     else if (clazz == int.class) {
/* 206 */       il.append(NOP);
/*     */     }
/* 208 */     else if (clazz == long.class) {
/* 209 */       il.append(I2L);
/*     */     }
/* 211 */     else if (clazz == float.class) {
/* 212 */       il.append(I2F);
/*     */     }
/* 214 */     else if (clazz == double.class) {
/* 215 */       il.append(I2D);
/*     */     
/*     */     }
...
/*     */     else {
/*     */       
/* 224 */       ErrorMsg err = new ErrorMsg("DATA_CONVERSION_ERR", toString(), clazz.getName());
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xalan/internal/xsltc/compiler/util/IntType.class
