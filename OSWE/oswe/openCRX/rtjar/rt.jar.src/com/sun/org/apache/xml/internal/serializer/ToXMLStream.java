...
/*  61 */   private static CharInfo m_xmlcharInfo = CharInfo.getCharInfoInternal("com.sun.org.apache.xml.internal.serializer.XMLEntities", "xml");
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */         
/* 138 */         String standalone, encoding = Encodings.getMimeEncoding(getEncoding());
...
/* 164 */             this.m_standaloneWasSpecified || 
/* 165 */             getDoctypePublic() != null || 
/* 166 */             getDoctypeSystem() != null || this.m_isStandalone))
/*     */           {
/*     */ 
/*     */ 
/*     */ 
...
/* 356 */       fireEscapingEvent(target, data);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */ 
/*     */         
/* 476 */         String prefixUsed = ensureAttributesNamespaceIsDeclared(uri, localName, rawName);
/*     */ 
/*     */ 
/*     */         
/* 480 */         if (prefixUsed != null && rawName != null && 
/*     */           
...
/*     */       
/*     */       try {
/* 513 */         Transformer tran = getTransformer();
...
/* 532 */     endElement((String)null, (String)null, elemName);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/*     */       try {
/* 643 */         Transformer tran = getTransformer();
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xml/internal/serializer/ToXMLStream.class
