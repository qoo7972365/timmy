...
/*     */       
/* 172 */       if (!this.fIsOptionalElement[i] && currentState[i + 1] == 0) {
/* 173 */         return false;
/*     */       }
/*     */     } 
/* 176 */     return true;
...
/*     */         {
/* 191 */           throw new XMLSchemaException("cos-nonambig", new Object[] { this.fAllElements[i].toString(), this.fAllElements[j]
/* 192 */                 .toString() });
/*     */         }
/*     */       } 
/*     */     } 
...
/* 210 */     Vector<XSElementDecl> ret = new Vector();
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xerces/internal/impl/xs/models/XSAllCM.class
