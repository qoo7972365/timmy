...
/* 153 */             if (JAXPValidatorComponent.this.fEntityResolver == null) return null; 
/*     */             try {
...
/* 410 */             str1 = this.fNamespaceContext.getURI(prefix);
/* 411 */             this.fContentHandler.startPrefixMapping(prefix, (str1 == null) ? "" : str1);
/*     */           } 
/*     */         } 
/*     */         
...
/*     */         } 
/*     */         
/* 518 */         j = this.fCurrentAttributes.addAttribute(new QName(prefix, 
/*     */ 
/*     */               
/* 521 */               symbolize(atts.getLocalName(i)), 
/* 522 */               symbolize(aqn), 
/* 523 */               symbolize(atts.getURI(i))), atts
/* 524 */             .getType(i), av);
/*     */       
/*     */       }
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xerces/internal/jaxp/JAXPValidatorComponent.class
