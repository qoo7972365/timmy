...
/* 155 */         this.fByteArray[index] = (byte)(this.fByteArray[index] & setToAnd.fByteArray[index]);
/*     */       }
/*     */     } 
/*     */   }
/*     */   
...
/*     */       
/* 166 */       int i = 1 << bitToGet % 32;
/* 167 */       if (bitToGet < 32) {
/* 168 */         return ((this.fBits1 & i) != 0);
/*     */       }
/* 170 */       return ((this.fBits2 & i) != 0);
/*     */     } 
/*     */ 
/*     */ 
/*     */     
...
/* 230 */         this.fByteArray[index] = (byte)(this.fByteArray[index] | setToOr.fByteArray[index]);
/*     */       }
/*     */     } 
/*     */   }
/*     */   
...
/*     */ 
/*     */       
/* 260 */       this.fByteArray[ofs] = (byte)(this.fByteArray[ofs] & (mask ^ 0xFFFFFFFF));
/* 261 */       this.fByteArray[ofs] = (byte)(this.fByteArray[ofs] | mask);
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xerces/internal/impl/dtd/models/CMStateSet.class
