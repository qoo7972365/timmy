...
/* 286 */     Type texp = this._exp.typeCheck(stable);
/*     */ 
/*     */     
/* 289 */     if (texp instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.util.ReferenceType) {
/* 290 */       this._exp = new CastExpr(this._exp, texp = Type.Real);
/*     */     }
/*     */ 
/*     */ 
/*     */ 
/*     */     
/* 296 */     if (texp instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.util.ResultTreeType) {
/* 297 */       this._exp = new CastExpr(this._exp, Type.Boolean);
/* 298 */       this._exp = new CastExpr(this._exp, Type.Real);
/* 299 */       texp = this._exp.typeCheck(stable);
/*     */     } 
/*     */ 
/*     */     
/* 303 */     if (texp instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.util.NumberType) {
/*     */       
/* 305 */       if (!(texp instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.util.IntType)) {
/* 306 */         this._exp = new CastExpr(this._exp, Type.Int);
/*     */       }
/*     */       
/* 309 */       if (this._canOptimize) {
/*     */         
/* 311 */         this
/* 312 */           ._nthPositionFilter = (!this._exp.hasLastCall() && !this._exp.hasPositionCall());
/*     */ 
/*     */         
/* 315 */         if (this._nthPositionFilter) {
/* 316 */           SyntaxTreeNode parent = getParent();
/* 317 */           this
/* 318 */             ._nthDescendant = (parent instanceof Step && parent.getParent() instanceof AbsoluteLocationPath);
/* 319 */           return this._type = Type.NodeSet;
/*     */         } 
/*     */       } 
/*     */ 
/*     */       
/* 324 */       this._nthPositionFilter = this._nthDescendant = false;
/*     */ 
/*     */ 
/*     */       
/* 328 */       QName position = getParser().getQNameIgnoreDefaultNs("position");
...
/*     */       
/* 336 */       if (this._exp.typeCheck(stable) != Type.Boolean) {
/* 337 */         this._exp = new CastExpr(this._exp, Type.Boolean);
/*     */       }
/* 339 */       return this._type = Type.Boolean;
/*     */     } 
/*     */ 
/*     */     
/* 343 */     if (!(texp instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.util.BooleanType)) {
/* 344 */       this._exp = new CastExpr(this._exp, Type.Boolean);
/*     */     }
/* 346 */     return this._type = Type.Boolean;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 370 */     FilterGenerator filterGen = new FilterGenerator(this._className, "java.lang.Object", toString(), 33, new String[] { "com.sun.org.apache.xalan.internal.xsltc.dom.CurrentNodeListFilter" }, classGen.getStylesheet());
/*     */     
...
/*     */       
/* 379 */       filterGen.addField(new Field(1, cpg
/* 380 */             .addUtf8(var.getEscapedName()), cpg
/* 381 */             .addUtf8(var.getType().toSignature()), null, cpg
/* 382 */             .getConstantPool()));
/*     */     } 
/*     */     
...
/*     */ 
/*     */     
/* 407 */     LocalVariableGen local = testGen.addLocalVariable("document", 
/* 408 */         Util.getJCRefType("Lcom/sun/org/apache/xalan/internal/xsltc/DOM;"), (InstructionHandle)null, (InstructionHandle)null);
/*     */     
...
/*     */       } 
/*     */       
/* 517 */       if (left instanceof VariableRefBase && left
/* 518 */         .getType() == Type.String) {
/*     */         
...
/*     */       } 
/*     */       
/* 530 */       if (right instanceof VariableRefBase && right
/* 531 */         .getType() == Type.String) {
/*     */         
...
/* 564 */       VariableRefBase varRef = this._closureVars.get(i);
...
/* 580 */         il.append(new GETFIELD(cpg
/* 581 */               .addFieldref(variableClosure.getInnerClassName(), var
/* 582 */                 .getEscapedName(), varType.toSignature())));
/*     */       }
/*     */       else {
/*     */         
...
/*     */ 
/*     */       
/* 590 */       il.append(new PUTFIELD(cpg
/* 591 */             .addFieldref(this._className, var.getEscapedName(), varType
/* 592 */               .toSignature())));
/*     */     } 
/*     */   }
/*     */ 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xalan/internal/xsltc/compiler/Predicate.class
