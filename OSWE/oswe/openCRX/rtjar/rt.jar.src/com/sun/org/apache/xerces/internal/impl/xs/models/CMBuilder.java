...
/*     */     }
/* 238 */     else if ((optimize && node.type() == 1) || node
/* 239 */       .type() == 2) {
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */       
/* 261 */       nodeRet = this.fNodeFactory.getCMBinOpNode(102, 
...
/*     */         } else {
/*     */           
/* 277 */           nodeRet = this.fNodeFactory.getCMBinOpNode(102, nodeRet, 
/* 278 */               multiNodes(node, maxOccurs - minOccurs, true));
/*     */         } 
/*     */       } 
/*     */     } 
/*     */     
...
/*     */     }
/* 293 */     int num1 = num / 2;
/* 294 */     return this.fNodeFactory.getCMBinOpNode(102, 
...
/* 306 */       node = this.fNodeFactory.getCMBinOpNode(type, copyNode(bin.getLeft()), 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xerces/internal/impl/xs/models/CMBuilder.class
