...
/*  91 */       result.append(Character.isJavaIdentifierStart(ch) ? ch : 95);
/*     */       
/*  93 */       int n = name.length();
/*  94 */       for (int i = 1; i < n; i++) {
/*  95 */         ch = name.charAt(i);
/*  96 */         result.append(Character.isJavaIdentifierPart(ch) ? ch : 95);
/*     */       } 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xalan/internal/xsltc/compiler/util/Util.class
