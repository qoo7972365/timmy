...
/*      */ 
/*      */     
/*  224 */     if (p_schemeSpecificPart == null || p_schemeSpecificPart
/*  225 */       .trim().length() == 0)
/*      */     {
...
/*  301 */             XMLMessages.createXMLMessage("ER_NO_USERINFO_IF_NO_HOST", null));
/*      */       }
/*      */       
/*  304 */       if (p_port != -1)
/*      */       {
/*  306 */         throw new MalformedURIException(
/*  307 */             XMLMessages.createXMLMessage("ER_NO_PORT_IF_NO_HOST", null));
/*      */       }
/*      */     } 
/*      */     
/*  311 */     if (p_path != null) {
...
/*  316 */             XMLMessages.createXMLMessage("ER_NO_QUERY_STRING_IN_PATH", null));
/*      */       }
/*      */       
/*  319 */       if (p_path.indexOf('#') != -1 && p_fragment != null)
/*      */       {
/*  321 */         throw new MalformedURIException(
/*  322 */             XMLMessages.createXMLMessage("ER_NO_FRAGMENT_STRING_IN_PATH", null));
/*      */       }
/*      */     } 
/*      */     
...
/*  372 */     if (p_base == null && (p_uriSpec == null || p_uriSpec
/*  373 */       .trim().length() == 0))
/*      */     {
/*  375 */       throw new MalformedURIException(
/*  376 */           XMLMessages.createXMLMessage("ER_CANNOT_INIT_URI_EMPTY_PARMS", null));
/*      */     }
/*      */ 
/*      */     
...
/*      */ 
/*      */     
/*  431 */     if (index + 1 < uriSpecLen && uriSpec
/*  432 */       .substring(index).startsWith("//")) {
/*      */       
/*  434 */       index += 2;
/*      */       
...
/*      */ 
/*      */       
/*  439 */       char testChar = Character.MIN_VALUE;
/*      */       
...
/*  610 */     char testChar = Character.MIN_VALUE;
/*      */     
...
/*  652 */     char testChar = Character.MIN_VALUE;
...
/*  761 */     char testChar = Character.MIN_VALUE;
/*      */ 
/*      */     
/*  764 */     while (index < end) {
/*      */       
...
/*  780 */               XMLMessages.createXMLMessage("ER_PATH_CONTAINS_INVALID_ESCAPE_SEQUENCE", null));
/*      */         }
/*      */       }
...
/* 1084 */       char testChar = Character.MIN_VALUE;
/*      */       
...
/* 1158 */             XMLMessages.createXMLMessage("ER_PORT_WHEN_HOST_NULL", null));
/*      */       }
/*      */     }
...
/* 1320 */             XMLMessages.createXMLMessage("ER_FRAG_FOR_GENERIC_URI", null));
/*      */       }
/* 1322 */       if (getPath() == null)
/*      */       {
/* 1324 */         throw new MalformedURIException(
/* 1325 */             XMLMessages.createXMLMessage("ER_FRAG_WHEN_PATH_NULL", null));
/*      */       }
...
/*      */       
/* 1353 */       if (((this.m_scheme == null && testURI.m_scheme == null) || (this.m_scheme != null && testURI.m_scheme != null && this.m_scheme.equals(testURI.m_scheme))) && ((this.m_userinfo == null && testURI.m_userinfo == null) || (this.m_userinfo != null && testURI.m_userinfo != null && this.m_userinfo
/* 1354 */         .equals(testURI.m_userinfo))) && ((this.m_host == null && testURI.m_host == null) || (this.m_host != null && testURI.m_host != null && this.m_host
/* 1355 */         .equals(testURI.m_host))) && this.m_port == testURI.m_port && ((this.m_path == null && testURI.m_path == null) || (this.m_path != null && testURI.m_path != null && this.m_path
/* 1356 */         .equals(testURI.m_path))) && ((this.m_queryString == null && testURI.m_queryString == null) || (this.m_queryString != null && testURI.m_queryString != null && this.m_queryString
/* 1357 */         .equals(testURI.m_queryString))) && ((this.m_fragment == null && testURI.m_fragment == null) || (this.m_fragment != null && testURI.m_fragment != null && this.m_fragment
/* 1358 */         .equals(testURI.m_fragment))))
/*      */       {
/*      */         
/* 1361 */         return true;
/*      */       }
...
/* 1511 */         if (testChar == '.') {
/*      */           
/* 1513 */           if (!isDigit(address.charAt(i - 1)) || (i + 1 < addrLength && 
/* 1514 */             !isDigit(address.charAt(i + 1))))
/*      */           {
/* 1516 */             return false;
/*      */           }
/*      */           
...
/* 1659 */     char testChar = Character.MIN_VALUE;
/*      */     
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xml/internal/utils/URI.class
