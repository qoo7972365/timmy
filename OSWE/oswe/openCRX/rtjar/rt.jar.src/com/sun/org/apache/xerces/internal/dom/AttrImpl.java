...
/*      */         
/*  181 */         TextImpl text = (TextImpl)ownerDocument().createTextNode((String)this.value);
/*  182 */         this.value = text;
...
/*  202 */       ChildNode child = (ChildNode)this.value;
...
/*  368 */             this
/*  369 */               .textNode = (TextImpl)ownerDocument.createTextNode((String)this.value);
/*      */           } else {
/*      */             
...
/*      */       
/*  419 */       internalInsertBefore(ownerDocument.createTextNode(newvalue), (Node)null, true);
/*      */       
...
/*  522 */     return isOwned() ? (Element)this.ownerNode : null;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  534 */     return isOwned() ? (Element)this.ownerNode : null;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  547 */       Node next = kid.getNextSibling();
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  739 */         Node kid = newChild.getFirstChild();
/*  740 */         for (; kid != null; kid = kid.getNextSibling()) {
/*      */           
...
/*      */       }
/*      */       
/* 1123 */       ChildNode mykid = (ChildNode)this.value;
/* 1124 */       for (; mykid != null; 
...
/*      */ 
/*      */       
/* 1168 */       if ((prev != null && prev.getNodeType() == 3) || (next != null && next
/* 1169 */         .getNodeType() == 3)) {
...
/* 1198 */     if (previousSibling != null && previousSibling
/* 1199 */       .getNodeType() == 3) {
/*      */       
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xerces/internal/dom/AttrImpl.class
