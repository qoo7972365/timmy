...
/*     */       
/*  90 */       boolean isIncomplete = (this._dom.getNodeType() != 9);
/*     */       
/*  92 */       if (isIncomplete) {
...
/*     */       
/*     */       case 1:
/* 152 */         qname = node.getNodeName();
/* 153 */         this._handler.startElement((String)null, (String)null, qname);
/*     */ 
/*     */ 
/*     */         
/* 157 */         map = node.getAttributes();
/* 158 */         length = map.getLength();
/*     */ 
/*     */         
...
/*     */ 
/*     */         
/* 176 */         nm = new NamespaceMappings();
/* 177 */         for (j = 0; j < length; j++) {
/* 178 */           Node attr = map.item(j);
...
/* 198 */               this._handler.addAttribute(prefix + ":" + qnameAttr, attr
/* 199 */                   .getNodeValue());
/*     */             } else {
...
/*     */ 
/*     */         
/* 207 */         uri = node.getNamespaceURI();
/* 208 */         localName = node.getLocalName();
/*     */ 
/*     */         
/* 211 */         if (uri != null) {
...
/*     */       
/*     */       case 7:
/* 239 */         this._handler.processingInstruction(node.getNodeName(), node
/* 240 */             .getNodeValue());
/*     */         break;
/*     */       
/*     */       case 3:
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xalan/internal/xsltc/trax/DOM2TO.class
