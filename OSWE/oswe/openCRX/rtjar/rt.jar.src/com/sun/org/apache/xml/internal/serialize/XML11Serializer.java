...
/*     */       
/* 300 */       if (ch == ']' && index + 2 < length && text
/*     */         
/* 302 */         .charAt(index + 1) == ']' && text
/* 303 */         .charAt(index + 2) == '>') {
...
/*     */ 
/*     */             
/* 311 */             String msg = DOMMessageFormatter.formatMessage("http://apache.org/xml/serializer", "EndingCDATA", null);
/*     */ 
/*     */ 
/*     */             
...
/*     */ 
/*     */             
/* 320 */             boolean continueProcess = this.fDOMErrorHandler.handleError(this.fDOMError);
...
/*     */           else {
/*     */             
/* 327 */             String msg = DOMMessageFormatter.formatMessage("http://apache.org/xml/serializer", "SplittingCDATA", null);
/*     */ 
/*     */ 
/*     */             
...
/*     */       
/*     */       }
/* 356 */       else if (this._encodingInfo.isPrintable(ch) && 
...
/*     */           
/* 492 */           if (length-- > 0) {
/* 493 */             surrogates(ch, chars[start++]); continue;
/*     */           } 
...
/* 500 */           this._printer.printText(ch); continue;
/*     */         } 
/* 502 */         printXMLChar(ch);
/*     */       
/*     */       }
...
/*     */           
/* 514 */           if (length-- > 0) {
/* 515 */             surrogates(ch, chars[start++]); continue;
/*     */           } 
...
/* 523 */           this._printer.printText(ch); continue;
/*     */         } 
/* 525 */         printXMLChar(ch);
/*     */       } 
/*     */     } 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xml/internal/serialize/XML11Serializer.class
