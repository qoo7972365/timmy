...
/*     */ 
/*     */         
/* 134 */         Iterator<Map.Entry<String, String>> propIter = httpInputSource.getHTTPRequestProperties();
/* 135 */         while (propIter.hasNext()) {
/* 136 */           Map.Entry entry = propIter.next();
...
/*     */           
/* 169 */           if ((charset.charAt(0) == '"' && charset
/* 170 */             .charAt(charset.length() - 1) == '"') || (charset
/* 171 */             .charAt(0) == '\'' && charset
/* 172 */             .charAt(charset.length() - 1) == '\''))
/*     */           {
/*     */             
/* 175 */             charset = charset.substring(1, charset.length() - 1);
/*     */           }
/*     */         } else {
/*     */           
/* 179 */           charset = null;
...
/* 232 */       return new UTF8Reader(stream, this.fTempString.ch.length, this.fErrorReporter
/*     */           
/* 234 */           .getMessageFormatter("http://www.w3.org/TR/1998/REC-xml-19980210"), this.fErrorReporter
/* 235 */           .getLocale());
/*     */     }
/*     */ 
/*     */     
...
/*     */       
/* 246 */       MessageFormatter aFormatter = this.fErrorReporter.getMessageFormatter("http://www.w3.org/TR/1998/REC-xml-19980210");
...
/* 253 */       return new ASCIIReader(stream, this.fTempString.ch.length, this.fErrorReporter
/*     */           
/* 255 */           .getMessageFormatter("http://www.w3.org/TR/1998/REC-xml-19980210"), this.fErrorReporter
/* 256 */           .getLocale());
/*     */     }
/*     */     
...
/* 438 */               if (!isValid(sup)) {
/* 439 */                 this.fErrorReporter.reportError("http://www.w3.org/TR/1998/REC-xml-19980210", "InvalidCharInContent", new Object[] {
/*     */                       
/* 441 */                       Integer.toString(sup, 16) }(short)2);
/*     */               }
/*     */             }
/*     */             else
/*     */             {
/* 446 */               this.fErrorReporter.reportError("http://www.w3.org/TR/1998/REC-xml-19980210", "InvalidCharInContent", new Object[] {
/*     */                     
/* 448 */                     Integer.toString(ch2, 16) }(short)2);
/*     */             }
/*     */           
/*     */           } else {
/*     */             
/* 453 */             this.fErrorReporter.reportError("http://www.w3.org/TR/1998/REC-xml-19980210", "InvalidCharInContent", new Object[] {
/*     */                   
/* 455 */                   Integer.toString(ch, 16) }(short)2);
/*     */           } 
/*     */         }
/*     */       } 
/*     */       
...
/* 463 */         this.fHandler.characters(this.fTempString, this.fHandler
/*     */             
/* 465 */             .modifyAugmentations(null, true));
/*     */       } 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xerces/internal/xinclude/XIncludeTextReader.class
