...
/*     */     
/*  83 */     Enumeration<String> elements = this.namespaceStack.elements();
/*  84 */     while (!inExtension && elements.hasMoreElements()) {
/*  85 */       String ns = elements.nextElement();
/*  86 */       if (ns == null) {
/*  87 */         inExtension = true;
/*     */         continue;
/*     */       } 
/*  90 */       inExtension = (!ns.equals("urn:oasis:names:tc:entity:xmlns:tr9401:catalog") && !ns.equals("urn:oasis:names:tc:entity:xmlns:xml:catalog"));
/*     */     } 
/*     */ 
/*     */     
...
/* 137 */     int entryType = -1;
/* 138 */     Vector<String> entryArgs = new Vector();
/*     */     
...
/*     */       } 
/*     */       
/* 174 */       if ((localName.equals("catalog") || localName.equals("group")) && atts
/* 175 */         .getValue("prefer") != null) {
...
/*     */           
/* 219 */           this.debug.message(4, "delegatePublic", 
/* 220 */               PublicId.normalize(atts.getValue("publicIdStartString")), atts
/* 221 */               .getValue("catalog"));
/*     */         } 
...
/*     */           
/* 229 */           this.debug.message(4, "delegateSystem", atts
/* 230 */               .getValue("systemIdStartString"), atts
/* 231 */               .getValue("catalog"));
/*     */         } 
...
/*     */           
/* 239 */           this.debug.message(4, "delegateURI", atts
/* 240 */               .getValue("uriStartString"), atts
/* 241 */               .getValue("catalog"));
/*     */         } 
...
/*     */           
/* 249 */           this.debug.message(4, "rewriteSystem", atts
/* 250 */               .getValue("systemIdStartString"), atts
/* 251 */               .getValue("rewritePrefix"));
/*     */         } 
...
/*     */           
/* 259 */           this.debug.message(4, "systemSuffix", atts
/* 260 */               .getValue("systemIdSuffix"), atts
/* 261 */               .getValue("uri"));
/*     */         } 
...
/*     */           
/* 269 */           this.debug.message(4, "rewriteURI", atts
/* 270 */               .getValue("uriStartString"), atts
/* 271 */               .getValue("rewritePrefix"));
/*     */         } 
...
/*     */           
/* 279 */           this.debug.message(4, "uriSuffix", atts
/* 280 */               .getValue("uriSuffix"), atts
/* 281 */               .getValue("uri"));
/*     */         } 
...
/*     */           
/* 296 */           this.debug.message(4, "public", 
/* 297 */               PublicId.normalize(atts.getValue("publicId")), atts
/* 298 */               .getValue("uri"));
/*     */         } 
...
/*     */           
/* 306 */           this.debug.message(4, "system", atts
/* 307 */               .getValue("systemId"), atts
/* 308 */               .getValue("uri"));
/*     */         } 
...
/*     */           
/* 316 */           this.debug.message(4, "uri", atts
/* 317 */               .getValue("name"), atts
/* 318 */               .getValue("uri"));
/*     */         } 
...
/* 441 */     int entryType = -1;
/* 442 */     Vector<String> entryArgs = new Vector();
/*     */     
/* 444 */     boolean inExtension = inExtensionNamespace();
/*     */     
/* 446 */     if (namespaceURI != null && !inExtension && ("urn:oasis:names:tc:entity:xmlns:xml:catalog"
/*     */       
/* 448 */       .equals(namespaceURI) || "urn:oasis:names:tc:entity:xmlns:tr9401:catalog"
/* 449 */       .equals(namespaceURI))) {
/*     */       
/* 451 */       String popURI = this.baseURIStack.pop();
/* 452 */       String baseURI = this.baseURIStack.peek();
/*     */       
...
/* 476 */         String popOverride = this.overrideStack.pop();
/* 477 */         String override = this.overrideStack.peek();
/*     */         
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xml/internal/resolver/readers/OASISXMLCatalogReader.class
