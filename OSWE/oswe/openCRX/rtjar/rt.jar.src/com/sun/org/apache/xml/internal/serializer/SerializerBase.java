...
/*  471 */         uri = "";
/*      */       }
/*  473 */       addAttributeAlways(uri, atts
/*      */           
/*  475 */           .getLocalName(i), atts
/*  476 */           .getQName(i), atts
/*  477 */           .getType(i), atts
/*  478 */           .getValue(i), false);
/*      */     } 
/*      */   }
/*      */ 
/*      */ 
...
/*  808 */         this.m_elemContext
/*  809 */           .m_elementLocalName = getLocalName(this.m_elemContext.m_elementName); 
/*  810 */       if (this.m_elemContext.m_elementURI == null) {
/*      */         
/*  812 */         String prefix = getPrefixPart(this.m_elemContext.m_elementName);
/*  813 */         if (prefix != null) {
/*  814 */           this.m_elemContext
/*  815 */             .m_elementURI = this.m_prefixMap.lookupNamespace(prefix);
/*      */         }
/*      */       } 
/*      */       
/*  819 */       if (null != this.m_elemContext.m_elementURI && this.m_elemContext.m_elementURI
/*  820 */         .length() == 0) {
...
/*      */         
/*  828 */         String uri = this.m_cdataSectionElements.elementAt(i);
/*  829 */         String loc = this.m_cdataSectionElements.elementAt(i + 1);
/*  830 */         if (loc.equals(this.m_elemContext.m_elementLocalName) && 
/*  831 */           subPartMatch(this.m_elemContext.m_elementURI, uri)) {
/*      */           
/*  833 */           b = true;
/*      */           
/*      */           break;
...
/*      */         {
/*  914 */           throw new RuntimeException(Utils.messages
/*  915 */               .createMessage("ER_NAMESPACE_PREFIX", new Object[] {
/*      */                   
/*  917 */                   qname.substring(0, col)
/*      */                 })); } 
/*      */       } 
/*      */     }
/*  921 */     return uri;
...
/*      */ 
/*      */     
/*  970 */     if (this.m_transformer instanceof SerializerTrace && ((SerializerTrace)this.m_transformer)
/*  971 */       .hasTraceListeners()) {
/*  972 */       this.m_tracer = (SerializerTrace)this.m_transformer;
/*      */     } else {
/*  974 */       this.m_tracer = null;
/*      */     } 
/*      */   }
/*      */ 
/*      */ 
...
/*      */     
/*      */     }
/* 1276 */     catch (ClassCastException classCastException) {}
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xml/internal/serializer/SerializerBase.class
