...
/* 175 */       return false;
/*     */     }
/* 177 */     if (systemId.length() > 2 && systemId
/* 178 */       .charAt(1) == ':' && 
/* 179 */       Character.isLetter(systemId.charAt(0)) && (systemId
/* 180 */       .charAt(2) == '\\' || systemId.charAt(2) == '/')) {
/* 181 */       return true;
/*     */     }
/* 183 */     return false;
/*     */   }
...
/*     */                 {
/* 250 */                   absoluteURI = systemId.substring(0, secondColonIndex - 1) + getAbsolutePathFromRelativePath(localPath);
/*     */                 }
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xml/internal/serializer/utils/SystemIDResolver.class
