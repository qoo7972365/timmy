...
/*     */     
/* 155 */     if (this.fType == 3) {
/* 156 */       if (superWildcard.fType == 3 && 
/* 157 */         subset2sets(this.fNamespaceList, superWildcard.fNamespaceList)) {
/* 158 */         return true;
/*     */       }
/*     */       
/* 161 */       if (superWildcard.fType == 2 && 
/* 162 */         !elementInSet(superWildcard.fNamespaceList[0], this.fNamespaceList) && 
/* 163 */         !elementInSet(ABSENT, this.fNamespaceList)) {
/* 164 */         return true;
/*     */       }
/*     */     } 
/*     */ 
...
/* 482 */       int i; StringBuffer buffer = new StringBuffer();
...
/* 501 */           buffer.append("\"");
/* 502 */           for (i = 1; i < this.fNamespaceList.length; i++) {
/* 503 */             buffer.append(",\"");
...
/* 571 */         return "skip";
/* 572 */       case 3: return "lax";
/* 573 */       case 1: return "strict"; }
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xerces/internal/impl/xs/XSWildcardDecl.class
