...
/*     */       
/* 441 */       byte[] arrayOfByte = this.m_map[bindex];
/* 442 */       if (arrayOfByte != null)
/* 443 */         for (int i = boffset; i < this.m_blocksize; i++) {
/* 444 */           if (arrayOfByte[i] == elem)
/* 445 */             return i + bindex * this.m_blocksize; 
/* 446 */         }   boffset = 0;
/*     */     } 
/*     */     
...
/* 486 */     int index = this.m_firstFree / this.m_blocksize;
/* 487 */     for (; index >= 0; 
/* 488 */       index--) {
/*     */       
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xml/internal/utils/SuballocatedByteVector.class
