...
/*     */ {
/*  77 */   private static final int[] kidOK = new int[13]; static {
/*  78 */     kidOK[9] = 1410;
/*     */ 
/*     */     
/*  81 */     kidOK[1] = 442; kidOK[5] = 442; kidOK[6] = 442; kidOK[11] = 442;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 133 */       this.fStorePSVI = this.fDocument instanceof com.sun.org.apache.xerces.internal.dom.PSVIDocumentImpl;
/*     */       return;
/*     */     } 
...
/* 155 */       int length = oldMap.getLength(); int i;
...
/* 228 */       elem = this.fDocument.createElementNS(element.uri, element.rawname);
...
/* 339 */         this.fTarget.appendChild(this.fTargetChildren.get(i));
/*     */       }
/*     */     } else {
/*     */       
/* 343 */       for (int i = 0; i < length; i++) {
/* 344 */         this.fTarget.insertBefore(this.fTargetChildren.get(i), this.fNextSibling);
/*     */       }
/*     */     } 
/*     */   }
/*     */   
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xerces/internal/jaxp/validation/DOMResultBuilder.class
