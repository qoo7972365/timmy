...
/* 236 */       ArrayList<InstructionHandle[]> matches = new ArrayList();
/*     */       
...
/* 360 */     map.put("lconst", new String(new char[] { '(', makeChar((short)9), '|', 
/* 361 */             makeChar((short)10), ')' }));
/* 362 */     map.put("dconst", new String(new char[] { '(', makeChar((short)14), '|', 
/* 363 */             makeChar((short)15), ')' }));
/* 364 */     map.put("fconst", new String(new char[] { '(', makeChar((short)11), '|', 
/* 365 */             makeChar((short)12), ')' }));
/*     */     
...
/*     */ 
/*     */     
/* 379 */     for (Iterator<String> i = map.keySet().iterator(); i.hasNext(); ) {
/* 380 */       String key = i.next();
...
/*     */     
/* 393 */     for (short s = 0; s < 256; s = (short)(s + 1)) {
/* 394 */       if (Constants.NO_OF_OPERANDS[s] != -1) {
/* 395 */         buf.append(makeChar(s));
/*     */         
/* 397 */         if (s < 255)
/* 398 */           buf.append('|'); 
/*     */       } 
...
/*     */     short i;
/* 409 */     for (i = from; i <= to; i = (short)(i + 1)) {
...
/* 432 */       if (ch >= '翿')
/* 433 */       { if (make_string) {
/* 434 */           buf.append(Constants.OPCODE_NAMES[ch - 32767]);
/*     */         } else {
/* 436 */           buf.append(ch - 32767);
/*     */         }  }
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/bcel/internal/util/InstructionFinder.class
