...
/* 125 */     return "Statistic " + getClass().getName() + NEWLINE + "Name: " + 
/* 126 */       getName() + NEWLINE + "Description: " + 
/* 127 */       getDescription() + NEWLINE + "Unit: " + 
/* 128 */       getUnit() + NEWLINE + "LastSampleTime: " + 
/* 129 */       getLastSampleTime() + NEWLINE + "StartTime: " + 
/* 130 */       getStartTime();
/*     */   }
/*     */   
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/glassfish/external/statistics/impl/StatisticImpl.class
