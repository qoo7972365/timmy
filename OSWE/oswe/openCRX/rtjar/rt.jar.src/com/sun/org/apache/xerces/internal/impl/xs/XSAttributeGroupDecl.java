...
/*     */     int i;
/* 180 */     for (i = 0; i < this.fAttrUseNum; i++) {
/*     */       
...
/*     */ 
/*     */           
/* 209 */           if (!XSConstraints.checkSimpleDerivationOk(attrDecl.fType, baseAttrDecl.fType, baseAttrDecl.fType
/*     */               
/* 211 */               .getFinal())) {
/*     */             
/* 213 */             errorArgs = new Object[] { typeName, attrDecl.fName, attrDecl.fType.getName(), baseAttrDecl.fType.getName(), "derivation-ok-restriction.2.1.2" };
...
/*     */ 
/*     */           
/* 222 */           int baseConsType = (baseAttrUse.fConstraintType != 0) ? baseAttrUse.fConstraintType : baseAttrDecl.getConstraintType();
/*     */           
/* 224 */           int thisConstType = (attrUse.fConstraintType != 0) ? attrUse.fConstraintType : attrDecl.getConstraintType();
/*     */           
...
/*     */             {
/* 240 */               errorArgs = new Object[] { typeName, attrDecl.fName, thisFixedValue.stringValue(), baseFixedValue.stringValue(), "derivation-ok-restriction.2.1.3.b" };
...
/*     */ 
/*     */     
/* 272 */     for (i = 0; i < baseGroup.fAttrUseNum; i++) {
/*     */       
...
/*     */ 
/*     */         
/* 305 */         errorArgs = new Object[] { typeName, this.fAttributeWC.getProcessContentsAsString(), baseGroup.fAttributeWC.getProcessContentsAsString(), "derivation-ok-restriction.4.3" };
/*     */         
...
/* 365 */       this.fAttrUses = new XSObjectListImpl((XSObject[])this.fAttributeUses, this.fAttrUseNum);
/*     */     }
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xerces/internal/impl/xs/XSAttributeGroupDecl.class
