...
/*  73 */     super((DTMAxisTraverser)null);
/*     */     
/*  75 */     this.m_axis = axis;
/*  76 */     int whatToShow = -1;
...
/* 142 */     this
/*     */       
/* 144 */       .m_lastFetched = (-1 == this.m_lastFetched) ? this.m_traverser.first(this.m_context) : this.m_traverser.next(this.m_context, this.m_lastFetched);
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xpath/internal/axes/OneStepIteratorForward.class
