...
/*  92 */     this.fAnnotationDepth = -1;
/*     */ 
/*     */     
/*  95 */     this.fInnerAnnotationDepth = -1;
/*     */     
/*  97 */     this.fDepth = -1;
/*     */ 
/*     */ 
/*     */ 
/*     */     
/* 102 */     this.fGenerateSyntheticAnnotation = false;
/* 103 */     this.fHasNonSchemaAttributes = new BooleanStack();
/* 104 */     this.fSawAnnotation = new BooleanStack();
/* 105 */     this.fEmptyAttr = new XMLAttributesImpl();
/*     */     this.config = config;
...
/* 249 */         this.fCurrentAnnotationElement = this.schemaDOM.startElement(element, attributes, this.fLocator
/* 250 */             .getLineNumber(), this.fLocator
/* 251 */             .getColumnNumber(), this.fLocator
/* 252 */             .getCharacterOffset());
/*     */         return;
/*     */       } 
...
/*     */       return;
/*     */     } 
/* 269 */     this.schemaDOM.startElement(element, attributes, this.fLocator
/* 270 */         .getLineNumber(), this.fLocator
/* 271 */         .getColumnNumber(), this.fLocator
/* 272 */         .getCharacterOffset());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 290 */     if (this.fGenerateSyntheticAnnotation && this.fAnnotationDepth == -1 && element.uri == SchemaSymbols.URI_SCHEMAFORSCHEMA && element.localpart != SchemaSymbols.ELT_ANNOTATION && 
/* 291 */       hasNonSchemaAttributes(element, attributes)) {
/*     */       
/* 293 */       this.schemaDOM.startElement(element, attributes, this.fLocator
/* 294 */           .getLineNumber(), this.fLocator
/* 295 */           .getColumnNumber(), this.fLocator
/* 296 */           .getCharacterOffset());
/*     */       
...
/* 300 */       String annRawName = (schemaPrefix.length() == 0) ? SchemaSymbols.ELT_ANNOTATION : (schemaPrefix + ':' + SchemaSymbols.ELT_ANNOTATION);
/* 301 */       this.schemaDOM.startAnnotation(annRawName, attributes, this.fNamespaceContext);
/* 302 */       String elemRawName = (schemaPrefix.length() == 0) ? SchemaSymbols.ELT_DOCUMENTATION : (schemaPrefix + ':' + SchemaSymbols.ELT_DOCUMENTATION);
...
/*     */     } 
/*     */     
/* 334 */     ElementImpl newElem = this.schemaDOM.emptyElement(element, attributes, this.fLocator
/* 335 */         .getLineNumber(), this.fLocator
/* 336 */         .getColumnNumber(), this.fLocator
/* 337 */         .getCharacterOffset());
/*     */     
...
/* 383 */           String annRawName = (schemaPrefix.length() == 0) ? SchemaSymbols.ELT_ANNOTATION : (schemaPrefix + ':' + SchemaSymbols.ELT_ANNOTATION);
/* 384 */           this.schemaDOM.startAnnotation(annRawName, this.fEmptyAttr, this.fNamespaceContext);
/* 385 */           String elemRawName = (schemaPrefix.length() == 0) ? SchemaSymbols.ELT_DOCUMENTATION : (schemaPrefix + ':' + SchemaSymbols.ELT_DOCUMENTATION);
...
/* 406 */       if (uri != null && uri != SchemaSymbols.URI_SCHEMAFORSCHEMA && uri != NamespaceContext.XMLNS_URI && (uri != NamespaceContext.XML_URI || attributes
/*     */ 
/*     */         
/* 409 */         .getQName(i) != SchemaSymbols.ATT_XML_LANG || element.localpart != SchemaSymbols.ELT_SCHEMA)) {
/* 410 */         return true;
/*     */       }
/*     */     } 
/* 413 */     return false;
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xerces/internal/impl/xs/opti/SchemaDOMParser.class
