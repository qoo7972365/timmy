...
/* 133 */     if (this.fDetach) {
/* 134 */       throw new DOMException((short)11, 
/*     */           
/* 136 */           DOMMessageFormatter.formatMessage("http://www.w3.org/dom/DOMTR", "INVALID_STATE_ERR", null));
/*     */     }
/*     */ 
/*     */     
...
/*     */       
/*     */       }
/* 154 */       else if (!this.fEntityReferenceExpansion && nextNode != null && nextNode
/*     */         
/* 156 */         .getNodeType() == 5) {
/* 157 */         nextNode = nextNode(nextNode, false);
/*     */       } else {
/* 159 */         nextNode = nextNode(nextNode, true);
/*     */       } 
/*     */ 
/*     */       
...
/* 189 */     if (this.fDetach) {
/* 190 */       throw new DOMException((short)11, 
/*     */           
/* 192 */           DOMMessageFormatter.formatMessage("http://www.w3.org/dom/DOMTR", "INVALID_STATE_ERR", null));
/*     */     }
/*     */ 
/*     */     
...
/*     */     }
/* 238 */     return ((this.fWhatToShow & 1 << node.getNodeType() - 1) != 0 && this.fNodeFilter
/* 239 */       .acceptNode(node) == 1);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 272 */         Node node1 = node.getFirstChild();
/* 273 */         return node1;
/*     */       } 
/*     */     }
/*     */     
...
/*     */ 
/*     */     
/* 321 */     if (result.hasChildNodes() && (this.fEntityReferenceExpansion || result == null || result
/*     */ 
/*     */       
/* 324 */       .getNodeType() != 5))
/*     */     {
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xerces/internal/dom/NodeIteratorImpl.class
