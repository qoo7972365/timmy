...
/* 192 */         this.m_last = ((DTMIterator)nodeVector).getLength();
/*     */       } 
/*     */     } 
/*     */   }
/*     */ 
...
/* 301 */     return hasCache() ? -17 : this.m_iter
/* 302 */       .getWhatToShow();
/*     */   }
/*     */ 
/*     */ 
...
/*     */ 
/*     */         
/* 330 */         int i = vec.elementAt(this.m_next);
/* 331 */         this.m_next++;
/* 332 */         return i;
/*     */       } 
...
/*     */       }
/* 514 */       else if (null == getVector() && index < this.m_next) {
/*     */         int n;
/* 516 */         while (this.m_next >= index && -1 != (n = previousNode()));
/*     */       } else {
/*     */         int n;
/*     */         
...
/*     */ 
/*     */       
/* 613 */       if (this.m_iter instanceof com.sun.org.apache.xpath.internal.NodeSetDTM)
/*     */       {
...
/* 664 */     if (null != this.m_iter) clone.m_iter = (DTMIterator)this.m_iter.clone(); 
...
/*     */   {
/* 889 */     private NodeVector m_vec2 = null;
/*     */     private boolean m_isComplete2 = false;
/* 891 */     private int m_useCount2 = 1;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/xpath/internal/axes/NodeSequence.class
