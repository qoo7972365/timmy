...
/* 118 */         Class2HTML.referenceType(type) + "</TD><TD><A NAME=\"field" + name + "\">" + name + "</A></TD>");
/*     */ 
/*     */     
/* 121 */     Attribute[] attributes = field.getAttributes();
/*     */     
/*     */     int i;
/* 124 */     for (i = 0; i < attributes.length; i++) {
...
/*     */ 
/*     */     
/* 177 */     for (i = 0; i < attributes.length; i++) {
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/bcel/internal/util/MethodHTML.class
