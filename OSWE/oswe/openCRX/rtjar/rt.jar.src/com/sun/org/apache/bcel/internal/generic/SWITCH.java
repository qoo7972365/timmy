...
/*     */     
/*     */     do {
/* 154 */       for (; this.match[i] < m; i++);
/* 155 */       for (; m < this.match[j]; j--);
/*     */       
/* 157 */       if (i > j)
/* 158 */         continue;  int h = this.match[i]; this.match[i] = this.match[j]; this.match[j] = h;
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/org/apache/bcel/internal/generic/SWITCH.class
