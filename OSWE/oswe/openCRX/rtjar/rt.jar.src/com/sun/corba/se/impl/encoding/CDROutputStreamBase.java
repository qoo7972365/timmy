...
/*     */   } protected abstract void init(ORB paramORB, boolean paramBoolean1, BufferManagerWrite paramBufferManagerWrite, byte paramByte, boolean paramBoolean2); public abstract void write_boolean(boolean paramBoolean); public abstract void write_char(char paramChar); public abstract void write_wchar(char paramChar); public abstract void write_octet(byte paramByte); public abstract void write_short(short paramShort); public abstract void write_ushort(short paramShort); public abstract void write_long(int paramInt); public abstract void write_ulong(int paramInt); public abstract void write_longlong(long paramLong); public abstract void write_ulonglong(long paramLong); public abstract void write_float(float paramFloat); public abstract void write_double(double paramDouble);
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/corba/se/impl/encoding/CDROutputStreamBase.class
