...
/*  74 */       doLog(Level.WARNING, "INTERCEPTORS.typeOutOfRange", arrayOfObject, InterceptorsSystemException.class, (Throwable)bAD_PARAM);
/*     */     } 
/*     */ 
/*     */     
/*  78 */     return bAD_PARAM;
...
/* 102 */       doLog(Level.WARNING, "INTERCEPTORS.nameNull", arrayOfObject, InterceptorsSystemException.class, (Throwable)bAD_PARAM);
/*     */     } 
/*     */ 
/*     */     
...
/* 134 */       doLog(Level.WARNING, "INTERCEPTORS.rirInvalidPreInit", arrayOfObject, InterceptorsSystemException.class, (Throwable)bAD_INV_ORDER);
/*     */     } 
/*     */ 
/*     */     
...
/* 164 */       doLog(Level.WARNING, "INTERCEPTORS.badState1", arrayOfObject, InterceptorsSystemException.class, (Throwable)bAD_INV_ORDER);
/*     */     } 
/*     */ 
/*     */     
...
/* 195 */       doLog(Level.WARNING, "INTERCEPTORS.badState2", arrayOfObject, InterceptorsSystemException.class, (Throwable)bAD_INV_ORDER);
/*     */     } 
/*     */ 
/*     */     
...
/* 227 */       doLog(Level.WARNING, "INTERCEPTORS.ioexceptionDuringCancelRequest", arrayOfObject, InterceptorsSystemException.class, (Throwable)cOMM_FAILURE);
/*     */     } 
/*     */ 
/*     */     
...
/* 259 */       doLog(Level.WARNING, "INTERCEPTORS.exceptionWasNull", arrayOfObject, InterceptorsSystemException.class, (Throwable)iNTERNAL);
/*     */     } 
/*     */ 
/*     */     
/* 263 */     return iNTERNAL;
...
/* 287 */       doLog(Level.WARNING, "INTERCEPTORS.objectHasNoDelegate", arrayOfObject, InterceptorsSystemException.class, (Throwable)iNTERNAL);
/*     */     } 
/*     */ 
/*     */     
/* 291 */     return iNTERNAL;
...
/* 315 */       doLog(Level.WARNING, "INTERCEPTORS.delegateNotClientsub", arrayOfObject, InterceptorsSystemException.class, (Throwable)iNTERNAL);
/*     */     } 
/*     */ 
/*     */     
/* 319 */     return iNTERNAL;
...
/* 343 */       doLog(Level.WARNING, "INTERCEPTORS.objectNotObjectimpl", arrayOfObject, InterceptorsSystemException.class, (Throwable)iNTERNAL);
/*     */     } 
/*     */ 
/*     */     
/* 347 */     return iNTERNAL;
...
/* 371 */       doLog(Level.WARNING, "INTERCEPTORS.exceptionInvalid", arrayOfObject, InterceptorsSystemException.class, (Throwable)iNTERNAL);
/*     */     } 
/*     */ 
/*     */     
/* 375 */     return iNTERNAL;
...
/* 399 */       doLog(Level.WARNING, "INTERCEPTORS.replyStatusNotInit", arrayOfObject, InterceptorsSystemException.class, (Throwable)iNTERNAL);
/*     */     } 
/*     */ 
/*     */     
/* 403 */     return iNTERNAL;
...
/* 427 */       doLog(Level.WARNING, "INTERCEPTORS.exceptionInArguments", arrayOfObject, InterceptorsSystemException.class, (Throwable)iNTERNAL);
/*     */     } 
/*     */ 
/*     */     
/* 431 */     return iNTERNAL;
...
/* 455 */       doLog(Level.WARNING, "INTERCEPTORS.exceptionInExceptions", arrayOfObject, InterceptorsSystemException.class, (Throwable)iNTERNAL);
/*     */     } 
/*     */ 
/*     */     
/* 459 */     return iNTERNAL;
...
/* 483 */       doLog(Level.WARNING, "INTERCEPTORS.exceptionInContexts", arrayOfObject, InterceptorsSystemException.class, (Throwable)iNTERNAL);
/*     */     } 
/*     */ 
/*     */     
/* 487 */     return iNTERNAL;
...
/* 511 */       doLog(Level.WARNING, "INTERCEPTORS.exceptionWasNull2", arrayOfObject, InterceptorsSystemException.class, (Throwable)iNTERNAL);
/*     */     } 
/*     */ 
/*     */     
/* 515 */     return iNTERNAL;
...
/* 539 */       doLog(Level.WARNING, "INTERCEPTORS.servantInvalid", arrayOfObject, InterceptorsSystemException.class, (Throwable)iNTERNAL);
/*     */     } 
/*     */ 
/*     */     
/* 543 */     return iNTERNAL;
...
/* 567 */       doLog(Level.WARNING, "INTERCEPTORS.cantPopOnlyPicurrent", arrayOfObject, InterceptorsSystemException.class, (Throwable)iNTERNAL);
/*     */     } 
/*     */ 
/*     */     
/* 571 */     return iNTERNAL;
...
/* 595 */       doLog(Level.WARNING, "INTERCEPTORS.cantPopOnlyCurrent2", arrayOfObject, InterceptorsSystemException.class, (Throwable)iNTERNAL);
/*     */     } 
/*     */ 
/*     */     
/* 599 */     return iNTERNAL;
...
/* 623 */       doLog(Level.WARNING, "INTERCEPTORS.piDsiResultIsNull", arrayOfObject, InterceptorsSystemException.class, (Throwable)iNTERNAL);
/*     */     } 
/*     */ 
/*     */     
/* 627 */     return iNTERNAL;
...
/* 651 */       doLog(Level.WARNING, "INTERCEPTORS.piDiiResultIsNull", arrayOfObject, InterceptorsSystemException.class, (Throwable)iNTERNAL);
/*     */     } 
/*     */ 
/*     */     
/* 655 */     return iNTERNAL;
...
/* 679 */       doLog(Level.WARNING, "INTERCEPTORS.exceptionUnavailable", arrayOfObject, InterceptorsSystemException.class, (Throwable)iNTERNAL);
/*     */     } 
/*     */ 
/*     */     
/* 683 */     return iNTERNAL;
...
/* 707 */       doLog(Level.WARNING, "INTERCEPTORS.clientInfoStackNull", arrayOfObject, InterceptorsSystemException.class, (Throwable)iNTERNAL);
/*     */     } 
/*     */ 
/*     */     
/* 711 */     return iNTERNAL;
...
/* 735 */       doLog(Level.WARNING, "INTERCEPTORS.serverInfoStackNull", arrayOfObject, InterceptorsSystemException.class, (Throwable)iNTERNAL);
/*     */     } 
/*     */ 
/*     */     
/* 739 */     return iNTERNAL;
...
/* 763 */       doLog(Level.WARNING, "INTERCEPTORS.markAndResetFailed", arrayOfObject, InterceptorsSystemException.class, (Throwable)iNTERNAL);
/*     */     } 
/*     */ 
/*     */     
/* 767 */     return iNTERNAL;
...
/* 793 */       doLog(Level.WARNING, "INTERCEPTORS.slotTableInvariant", arrayOfObject, InterceptorsSystemException.class, (Throwable)iNTERNAL);
/*     */     } 
/*     */ 
/*     */     
/* 797 */     return iNTERNAL;
...
/* 821 */       doLog(Level.WARNING, "INTERCEPTORS.interceptorListLocked", arrayOfObject, InterceptorsSystemException.class, (Throwable)iNTERNAL);
/*     */     } 
/*     */ 
/*     */     
/* 825 */     return iNTERNAL;
...
/* 849 */       doLog(Level.WARNING, "INTERCEPTORS.sortSizeMismatch", arrayOfObject, InterceptorsSystemException.class, (Throwable)iNTERNAL);
/*     */     } 
/*     */ 
/*     */     
/* 853 */     return iNTERNAL;
...
/* 881 */       doLog(Level.WARNING, "INTERCEPTORS.piOrbNotPolicyBased", arrayOfObject, InterceptorsSystemException.class, (Throwable)nO_IMPLEMENT);
/*     */     } 
/*     */ 
/*     */     
...
/* 913 */       doLog(Level.FINE, "INTERCEPTORS.orbinitinfoInvalid", arrayOfObject, InterceptorsSystemException.class, (Throwable)oBJECT_NOT_EXIST);
/*     */     } 
/*     */ 
/*     */     
...
/* 945 */       doLog(Level.FINE, "INTERCEPTORS.unknownRequestInvoke", arrayOfObject, InterceptorsSystemException.class, (Throwable)uNKNOWN);
/*     */     } 
/*     */ 
/*     */     
/* 949 */     return uNKNOWN;
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/corba/se/impl/logging/InterceptorsSystemException.class
