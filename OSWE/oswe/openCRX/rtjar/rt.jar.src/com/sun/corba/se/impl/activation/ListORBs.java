...
/* 953 */         return true;
/*     */       }
/* 955 */       Activator activator = ActivatorHelper.narrow(paramORB
/* 956 */           .resolve_initial_references("ServerActivator"));
/*     */       
/* 958 */       String[] arrayOfString = activator.getORBNames(i);
/*     */       
/* 960 */       paramPrintStream.println(CorbaResourceUtil.getText("servertool.orbidmap2"));
/*     */       
/* 962 */       for (byte b = 0; b < arrayOfString.length; b++) {
/* 963 */         paramPrintStream.println("\t " + arrayOfString[b]);
/*     */       }
/* 965 */     } catch (ServerNotRegistered serverNotRegistered) {
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/corba/se/impl/activation/ListORBs.class
