...
/* 124 */     this.service_contexts = new ServiceContexts((InputStream)paramInputStream);
/*     */     
/* 126 */     this.request_id = paramInputStream.read_ulong();
/* 127 */     this.response_expected = paramInputStream.read_boolean();
/* 128 */     this.reserved = new byte[3]; int i;
/* 129 */     for (i = 0; i < 3; i++) {
...
/* 142 */       this.service_contexts.write((OutputStream)paramOutputStream, GIOPVersion.V1_1);
/*     */     }
/*     */     else {
/*     */       
/* 146 */       ServiceContexts.writeNullServiceContext((OutputStream)paramOutputStream);
/*     */     } 
/*     */     
...
/*     */     }
/*     */     
/* 156 */     for (byte b = 0; b < 3; b++) {
/* 157 */       paramOutputStream.write_octet(this.reserved[b]);
/*     */     }
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/corba/se/impl/protocol/giopmsgheaders/RequestMessage_1_1.class
