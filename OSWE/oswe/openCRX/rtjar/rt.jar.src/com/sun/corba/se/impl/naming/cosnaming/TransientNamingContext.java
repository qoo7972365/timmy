...
/*     */ 
/*     */     
/* 351 */     this.theHashtable = new Hashtable<>();
...
/*     */     InternalBindingValue internalBindingValue2 = this.theHashtable.put(internalBindingKey, internalBindingValue1);
...
/*     */     try {
/*     */       TransientBindingIterator transientBindingIterator = new TransientBindingIterator((ORB)this.orb, (Hashtable)this.theHashtable.clone(), this.nsPOA);
/*     */       transientBindingIterator.list(paramInt, paramBindingListHolder);
/*     */       byte[] arrayOfByte = this.nsPOA.activate_object((Servant)transientBindingIterator);
...
/*     */       byte[] arrayOfByte = this.nsPOA.activate_object((Servant)transientNamingContext);
/*     */       Object object = this.nsPOA.id_to_reference(arrayOfByte);
/*     */       this.lifecycleLogger.fine("TransientNamingContext LIFECYCLE.CREATE SUCCESSFUL");
/*     */       return NamingContextHelper.narrow(object);
/*     */     } catch (SystemException systemException) {
/*     */       this.lifecycleLogger.log(Level.WARNING, "<<LIFECYCLE CREATE>><<FAILURE>>", (Throwable)systemException);
/*     */       throw systemException;
/*     */     } catch (Exception exception) {
...
/*     */     try {
/*     */       byte[] arrayOfByte = this.nsPOA.servant_to_id((Servant)this);
/*     */       if (arrayOfByte != null)
...
/*     */     } catch (SystemException systemException) {
/*     */       this.lifecycleLogger.log(Level.WARNING, "<<LIFECYCLE DESTROY>><<FAILURE>>", (Throwable)systemException);
/*     */       throw systemException;
/*     */     } catch (Exception exception) {
...
/*     */     return paramNameComponent.id + "." + paramNameComponent.kind;
/*     */   }
/*     */   
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/corba/se/impl/naming/cosnaming/TransientNamingContext.class
