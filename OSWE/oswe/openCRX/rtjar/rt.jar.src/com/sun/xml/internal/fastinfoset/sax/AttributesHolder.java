...
/*  58 */   private QualifiedName[] _names = new QualifiedName[8];
/*  59 */   private String[] _values = new String[8];
/*     */   
/*  61 */   private String[] _algorithmURIs = new String[8];
/*  62 */   private int[] _algorithmIds = new int[8];
/*  63 */   private Object[] _algorithmData = new Object[8];
/*     */ 
/*     */   
...
/*     */     
/*     */     try {
/* 106 */       this._values[index] = convertEncodingAlgorithmDataToString(this._algorithmIds[index], this._algorithmURIs[index], this._algorithmData[index])
/*     */ 
/*     */         
/* 109 */         .toString(); return convertEncodingAlgorithmDataToString(this._algorithmIds[index], this._algorithmURIs[index], this._algorithmData[index]).toString();
...
/* 128 */       if (localName.equals(name.localName) && prefix
/* 129 */         .equals(name.prefix)) {
/* 130 */         return i;
/*     */       }
/*     */     } 
/* 133 */     return -1;
...
/* 157 */       if (localName.equals(name.localName) && uri
/* 158 */         .equals(name.namespaceName)) {
/* 159 */         return i;
/*     */       }
/*     */     } 
/* 162 */     return -1;
...
/* 270 */     if (identifier < 9)
/* 271 */     { BuiltInEncodingAlgorithm builtInEncodingAlgorithm = BuiltInEncodingAlgorithmFactory.getAlgorithm(identifier); }
/* 272 */     else { if (identifier == 9)
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/fastinfoset/sax/AttributesHolder.class
