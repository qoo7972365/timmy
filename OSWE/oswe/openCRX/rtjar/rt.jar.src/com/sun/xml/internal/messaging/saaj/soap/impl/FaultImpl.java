...
/* 135 */     setFaultCode(faultCodeQName
/* 136 */         .getLocalName(), faultCodeQName
/* 137 */         .getPrefix(), faultCodeQName
/* 138 */         .getURI());
/*     */   }
/*     */   
/*     */   public void setFaultCode(QName faultCodeQName) throws SOAPException {
/* 142 */     setFaultCode(faultCodeQName
/* 143 */         .getLocalPart(), faultCodeQName
/* 144 */         .getPrefix(), faultCodeQName
/* 145 */         .getNamespaceURI());
/*     */   }
/*     */ 
/*     */ 
...
/* 208 */     log.log(Level.SEVERE, "SAAJ0146.impl.invalid.name.change.requested", new Object[] { this.elementQName
/*     */ 
/*     */           
/* 211 */           .getLocalPart(), newName.getLocalPart() });
/* 212 */     throw new SOAPException("Cannot change name for " + this.elementQName
/* 213 */         .getLocalPart() + " to " + newName.getLocalPart());
/*     */   }
...
/*     */       }
/*     */       
/* 225 */       String localName = soapElement.getElementName().getLocalName();
/* 226 */       if (isStandardFaultElement(localName))
/* 227 */         return replaceElementWithSOAPElement(element, 
/*     */             
...
/*     */         
/* 241 */         newElement = createSOAPFaultElement(elementName);
/*     */       } else {
...
/* 253 */       this
/* 254 */         .faultCodeElement = addSOAPFaultElement(getFaultCodeName().getLocalName());
...
/* 265 */       this
/* 266 */         .faultStringElement = addSOAPFaultElement(getFaultStringName().getLocalName());
...
/* 278 */       this
/* 279 */         .faultActorElement = addSOAPFaultElement(getFaultActorName().getLocalName());
...
/* 289 */       return (SOAPElement)addDetail(); 
/* 290 */     if (getFaultCodeName().equals(name))
/* 291 */       return (SOAPElement)addFaultCodeElement(); 
/* 292 */     if (getFaultStringName().equals(name))
/* 293 */       return (SOAPElement)addFaultStringElement(); 
/* 294 */     if (getFaultActorName().equals(name)) {
/* 295 */       return (SOAPElement)addFaultActorElement();
/*     */     }
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/messaging/saaj/soap/impl/FaultImpl.class
