...
/*  53 */   private String[] _strings = new String[64];
/*     */ 
/*     */   
...
/* 111 */       if (localName.equals(this._strings[(i << 3) + 2]) && uri
/* 112 */         .equals(this._strings[(i << 3) + 1])) {
/* 113 */         return i;
/*     */       }
/*     */     } 
/* 116 */     return -1;
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/stream/buffer/AttributesHolder.class
