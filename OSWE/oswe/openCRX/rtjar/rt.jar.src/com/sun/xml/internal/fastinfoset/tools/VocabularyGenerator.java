...
/* 249 */         throw new SAXException(CommonResourceBundle.getInstance()
/* 250 */             .getString("message.namespaceURINotIndexed", new Object[] { Integer.valueOf(namespaceURIIndex) }));
/*     */       }
/*     */       
/* 253 */       if (prefix.length() > 0) {
/* 254 */         prefixIndex = this._serializerVocabulary.prefix.get(prefix);
/* 255 */         if (prefixIndex == -1) {
/* 256 */           throw new SAXException(CommonResourceBundle.getInstance()
/* 257 */               .getString("message.prefixNotIndexed", new Object[] { Integer.valueOf(prefixIndex) }));
/*     */         }
/*     */       } 
/*     */     } 
/*     */     
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/fastinfoset/tools/VocabularyGenerator.class
