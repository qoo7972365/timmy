...
/*  59 */       return (TypeT)this.parent.nav().getReturnType(this.getter);
/*     */     }
/*  61 */     return (TypeT)this.parent.nav().getMethodParameters(this.setter)[0];
/*     */   }
/*     */   
/*     */   public <A extends Annotation> A readAnnotation(Class<A> annotation) {
/*  65 */     return (A)this.parent.reader().getMethodAnnotation(annotation, this.getter, this.setter, this);
/*     */   }
/*     */   
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/bind/v2/model/impl/GetterSetterPropertySeed.class
