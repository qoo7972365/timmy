...
/*  107 */     } catch (SecurityException securityException) {}
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  234 */     List<? extends Header> hdrs = this.mimePart.getAllHeaders();
...
/*      */ 
/*      */     
/*  434 */     if (s.equalsIgnoreCase("7bit") || s.equalsIgnoreCase("8bit") || s
/*  435 */       .equalsIgnoreCase("quoted-printable") || s
/*  436 */       .equalsIgnoreCase("base64")) {
/*  437 */       return s;
/*      */     }
/*      */     
...
/*      */     
/*      */     while (true) {
/*  446 */       HeaderTokenizer.Token tk = h.next();
/*  447 */       int tkType = tk.getType();
/*  448 */       if (tkType == -4)
/*      */         break; 
/*  450 */       if (tkType == -1) {
...
/*  541 */       return null;
/*      */     }
/*  543 */     return (String[])v.toArray((Object[])new String[v.size()]);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  715 */       } catch (ParseException parseException) {}
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*  942 */     List<String> hdrLines = this.headers.getAllHeaderLines();
/*  943 */     int sz = hdrLines.size();
/*  944 */     for (int i = 0; i < sz; i++) {
/*  945 */       OutputUtil.writeln(hdrLines.get(i), os);
/*      */     }
/*      */     
...
/*      */         }
/* 1102 */         if (needCTHeader && setDefaultTextCharset && cType
/* 1103 */           .match("text/*") && cType
/* 1104 */           .getParameter("charset") == null) {
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */           
/* 1116 */           String charset, enc = getEncoding();
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/messaging/saaj/packaging/mime/internet/MimeBodyPart.class
