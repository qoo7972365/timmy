...
/* 158 */       PolicyScope scope = this.internalMap.get(createLocalCopy(key));
...
/* 164 */       PolicyScope scope = this.internalMap.get(localKey);
/* 165 */       if (scope == null) {
/* 166 */         List<PolicySubject> list = new LinkedList<>();
...
/* 180 */       PolicyScope scope = this.internalMap.get(localKey);
/* 181 */       if (scope == null) {
/* 182 */         List<PolicySubject> list = new LinkedList<>();
...
/*     */           
/*     */           public Policy next() {
/* 219 */             PolicyMapKey key = this.keysIterator.next();
/*     */             try {
...
/* 436 */     List<PolicySubject> subjects = new LinkedList<>();
...
/*     */   
/*     */   public boolean isEmpty() {
/* 492 */     return (this.serviceMap.isEmpty() && this.endpointMap.isEmpty() && this.operationMap
/* 493 */       .isEmpty() && this.inputMessageMap.isEmpty() && this.outputMessageMap
/* 494 */       .isEmpty() && this.faultMessageMap.isEmpty());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 506 */       Collection<PolicySubject> scopedSubjects = scope.getPolicySubjects();
...
/* 649 */               this.currentScopeIterator = this.mainIterator.next(); continue;
/*     */             } 
/* 651 */             return false;
/*     */           } 
/*     */ 
...
/*     */         public Policy next() {
/* 659 */           if (hasNext()) {
/* 660 */             return this.currentScopeIterator.next();
/*     */           }
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/ws/policy/PolicyMap.class
