...
/*  61 */     super(owner, (RuntimeTypeInfo)rai, rai.getType(), rai.getTypeName(), false, true, false);
/*  62 */     this.itemType = this.jaxbType.getComponentType();
/*  63 */     this.itemBeanInfo = owner.getOrCreate((RuntimeTypeInfo)rai.getItemType());
/*     */   }
/*     */ 
/*     */   
...
/* 106 */       ((List<Object>)state.getTarget()).add(o);
/*     */     }
/*     */   }
/*     */   
...
/* 159 */     target.reportError((ValidationEvent)new ValidationEventImpl(1, Messages.UNABLE_TO_MARSHAL_NON_ELEMENT
/*     */ 
/*     */           
/* 162 */           .format(new Object[] { array.getClass().getName() }, ), null, null));
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/bind/v2/runtime/ArrayBeanInfoImpl.class
