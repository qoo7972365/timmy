...
/* 159 */     if (!this.m_hasHeader)
/* 160 */       return;  wr.write(this.xmlDecl.toString());
/*     */   }
/*     */ 
/*     */   
/*     */   private String parseEncoding(String xmlDeclFinal, int eqIndex) throws IOException {
/* 165 */     StringTokenizer strTok = new StringTokenizer(xmlDeclFinal.substring(eqIndex + 1));
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/messaging/saaj/util/XMLDeclarationParser.class
