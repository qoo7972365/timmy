...
/*     */ 
/*     */     
/*  82 */     List<Tree> normalizedChildren = new ArrayList<>(children.size());
...
/*     */     } 
/*     */     
/*  94 */     return new Group(kind, normalizedChildren.<Tree>toArray(new Tree[normalizedChildren.size()]));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     } else {
/*     */       
/* 126 */       (new Group(GroupKind.SEQUENCE, new Tree[] { this })).write(ct);
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/* 237 */       writeOccurs((Occurs)c, isOptional, repeated);
/*     */       
/* 239 */       for (Tree child : this.children)
/* 240 */         child.write((ContentModelContainer)c, false, false); 
/*     */     }
/*     */   }
/*     */ }


/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/bind/v2/schemagen/Tree.class
