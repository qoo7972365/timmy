...
/* 210 */     Map<String, String> nsToPrefixMap = new HashMap<>();
/*     */     
/* 212 */     Collection<String> namespaces = getUsedNamespaces();
...
/* 342 */         PolicySourceModel referencedModel; PolicyReferenceData refData = reference.getPolicyReferenceData();
...
/*     */     }
/*     */     
/* 388 */     Queue<ModelNode> nodesToBeProcessed = new LinkedList<>();
...
/*     */           }
/*     */           
/* 407 */           for (Map.Entry<QName, String> attribute : nodeData.getAttributesSet()) {
...
/* 426 */     return this.namespaceToPrefix.get(namespace);
/*     */   }
/*     */ }


/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/ws/policy/sourcemodel/PolicySourceModel.class
