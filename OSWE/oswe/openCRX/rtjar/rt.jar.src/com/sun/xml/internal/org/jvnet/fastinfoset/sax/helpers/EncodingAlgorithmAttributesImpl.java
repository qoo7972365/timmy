...
/* 309 */     if (index < 0 || index >= this._length)
/*     */       return; 
/* 311 */     int i = index * 6;
...
/*     */     
/*     */     try {
/* 427 */       this._data[index * 6 + 4] = convertEncodingAlgorithmDataToString(this._algorithmIds[index], this._data[index * 6 + 5], this._algorithmData[index])
/*     */ 
/*     */         
/* 430 */         .toString(); return convertEncodingAlgorithmDataToString(this._algorithmIds[index], this._data[index * 6 + 5], this._algorithmData[index]).toString();
/* 431 */     } catch (IOException e) {
/* 432 */       return null;
/* 433 */     } catch (FastInfosetException e) {
/* 434 */       return null;
/*     */     } 
/*     */   }
/*     */   
...
/* 467 */       if (localName.equals(this._data[index * 6 + 1]) && uri
/* 468 */         .equals(this._data[index * 6 + 0])) {
/* 469 */         return index;
/*     */       }
/*     */     } 
/* 472 */     return -1;
...
/* 576 */     if (identifier < 9)
/* 577 */     { BuiltInEncodingAlgorithm builtInEncodingAlgorithm = BuiltInEncodingAlgorithmFactory.getAlgorithm(identifier); }
/* 578 */     else { if (identifier == 9)
/* 579 */         throw new EncodingAlgorithmException(
/* 580 */             CommonResourceBundle.getInstance().getString("message.CDATAAlgorithmNotSupported")); 
/* 581 */       if (identifier >= 32) {
/* 582 */         if (URI == null) {
/* 583 */           throw new EncodingAlgorithmException(
/* 584 */               CommonResourceBundle.getInstance().getString("message.URINotPresent") + identifier);
/*     */         }
/*     */         
/* 587 */         ea = (EncodingAlgorithm)this._registeredEncodingAlgorithms.get(URI);
/* 588 */         if (ea == null) {
/* 589 */           throw new EncodingAlgorithmException(
/* 590 */               CommonResourceBundle.getInstance().getString("message.algorithmNotRegistered") + URI);
/*     */         
/*     */         }
/*     */       }
/*     */       else {
...
/* 597 */             CommonResourceBundle.getInstance().getString("message.identifiers10to31Reserved"));
/*     */       }  }
/*     */     
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/org/jvnet/fastinfoset/sax/helpers/EncodingAlgorithmAttributesImpl.class
