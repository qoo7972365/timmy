...
/*     */ {
/*  59 */   protected static final Logger log = Logger.getLogger("com.sun.xml.internal.messaging.saaj.soap", "com.sun.xml.internal.messaging.saaj.soap.LocalStrings");
/*     */ 
/*     */   
...
/* 124 */         this.document.removeChild((Node)this.envelope);
...
/* 131 */       this.document.insertBefore((Node)this.envelope, (Node)null);
/*     */     } 
...
/* 139 */     { this.envelope = (Envelope)envelopeChildElement; }
...
/*     */         
/* 229 */         if (is != null) {
/* 230 */           this.source = (Source)new JAXMStreamSource(is);
/* 231 */         } else if (rdr != null) {
/* 232 */           this.source = (Source)new JAXMStreamSource(rdr);
/*     */         } else {
...
/*     */ 
/*     */         
/* 247 */         if (!(is instanceof com.sun.xml.internal.messaging.saaj.util.ByteInputStream)) {
/* 248 */           ByteOutputStream bout = new ByteOutputStream();
/* 249 */           bout.write(is);
/*     */ 
/*     */           
/* 252 */           FastInfosetReflection.FastInfosetSource_setInputStream(source, (InputStream)bout
/* 253 */               .newInputStream());
/*     */         } 
...
/* 266 */       throw new SOAPExceptionImpl("Error setting the source for SOAPPart: " + ex
/* 267 */           .getMessage());
/*     */     } 
/*     */   }
/*     */   
...
/* 293 */           return is;
/*     */         }
/* 295 */         if (!(is instanceof com.sun.xml.internal.messaging.saaj.util.ByteInputStream)) {
...
/* 311 */       env.output((OutputStream)b, isFastInfoset());
/*     */     }
/* 313 */     catch (SOAPException soapException) {
...
/*     */ 
/*     */     
/* 320 */     return (InputStream)b.newInputStream();
/*     */   }
/*     */   
...
/*     */     try {
/* 390 */       getEnvelope();
/* 391 */     } catch (SOAPException sOAPException) {}
/*     */     
...
/*     */     try {
/* 399 */       lookForEnvelope();
/* 400 */     } catch (SOAPException sOAPException) {}
/*     */   }
/*     */ 
/*     */   
...
/*     */       try {
/* 606 */         getEnvelope();
/* 607 */       } catch (SOAPException sOAPException) {}
/*     */     }
/*     */   }
/*     */ 
/*     */   
...
/*     */           
/*     */           try {
/* 625 */             reader = new InputStreamReader(inputStream, getSourceCharsetEncoding());
/* 626 */           } catch (UnsupportedEncodingException uee) {
/* 627 */             log.log(Level.SEVERE, "SAAJ0551.soap.unsupported.encoding", new Object[] {
/*     */ 
/*     */                   
/* 630 */                   getSourceCharsetEncoding() });
/* 631 */             throw new SOAPExceptionImpl("Unsupported encoding " + 
/* 632 */                 getSourceCharsetEncoding(), uee);
/*     */           } 
/*     */         } 
/*     */       } else {
/*     */         
...
/* 660 */         return ev;
/*     */       } 
/* 662 */     } else if (this.source == null || this.source instanceof javax.xml.transform.dom.DOMSource) {
/*     */     
/*     */     } 
/* 665 */     return null;
/*     */   }
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/messaging/saaj/soap/SOAPPartImpl.class
