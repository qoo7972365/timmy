...
/* 176 */         this.bv.put12(90, (this.cw.newInteger(v[i] ? 1 : 0)).index);
/*     */       }
...
/* 322 */     int size = 1 + 2 * (panns.length - off); int i;
/* 323 */     for (i = off; i < panns.length; i++) {
/* 324 */       size += (panns[i] == null) ? 0 : panns[i].getSize();
/*     */     }
/* 326 */     out.putInt(size).putByte(panns.length - off);
/* 327 */     for (i = off; i < panns.length; i++) {
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/ws/org/objectweb/asm/AnnotationWriter.class
