...
/*     */ 
/*     */           
/* 257 */           if (!((NamespaceSupport)this.fNamespaceContext).containsPrefixInCurrentContext(prefix)) {
/* 258 */             this.fNamespaceContext.declarePrefix(prefix, attValue);
/*     */           }
/* 260 */           specified = true;
/*     */         } else {
/*     */           
/* 263 */           int j = attributes.getLength();
/* 264 */           for (int k = 0; k < j; k++) {
/* 265 */             if (attributes.getQName(k) == attRawName) {
/* 266 */               specified = true;
/*     */ 
/*     */               
/*     */               break;
...
/*     */         
/* 288 */         int j = attributes.addAttribute(this.fTempQName, attType, attValue);
/*     */       } 
/*     */ 
/*     */       
...
/*     */       
/* 304 */       int position = this.fDTDGrammar.getFirstAttributeDeclIndex(elementIndex);
...
/*     */       
/*     */       case 2:
/* 399 */         buffer = new StringBuffer();
/* 400 */         buffer.append('(');
/* 401 */         for (i = 0; i < attrDecl.simpleType.enumeration.length; i++) {
/* 402 */           if (i > 0) {
/* 403 */             buffer.append("|");
/*     */           }
...
/* 469 */     if (this.fDTDGrammar == null)
/* 470 */       return;  this.fElementDepth--;
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/stream/dtd/DTDGrammarUtil.class
