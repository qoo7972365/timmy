...
/*  74 */     super(context, (RuntimePropertyInfo)prop);
/*  75 */     this.attName = context.nameBuilder.createAttributeName(prop.getXmlName());
/*  76 */     this.xacc = TransducedAccessor.get(context, (RuntimeNonElementRef)prop);
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/bind/v2/runtime/property/AttributeProperty.class
