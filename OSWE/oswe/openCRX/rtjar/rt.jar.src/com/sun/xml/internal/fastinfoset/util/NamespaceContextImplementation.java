...
/* 110 */       if (declaredNamespaceURI.equals(namespaceURI) && this.prefixes[i]
/* 111 */         .length() > 0) {
/* 112 */         String declaredPrefix = this.prefixes[i];
/*     */ 
/*     */         
/* 115 */         for (; ++i < this.namespacePosition; i++) {
...
/*     */     
/* 133 */     for (int i = this.namespacePosition - 1; i >= 0; i--) {
...
/*     */ 
/*     */         
/* 139 */         int j = i + 1; while (true) { if (j < this.namespacePosition) {
/* 140 */             if (declaredPrefix.equals(this.prefixes[j]))
/*     */               break;  j++; continue;
/*     */           } 
/* 143 */           l.add(declaredPrefix); break; }
/*     */       
/*     */       } 
/*     */     } 
...
/* 211 */       resizeContexts();
/*     */     }
/* 213 */     this.contexts[this.contextPosition++] = this.currentContext = this.namespacePosition;
/*     */   }
/*     */   
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/fastinfoset/util/NamespaceContextImplementation.class
