...
/*     */ 
/*     */   
/* 113 */   protected static final boolean ignoreMissingEndBoundary = SAAJUtil.getSystemBoolean("saaj.mime.multipart.ignoremissingendboundary");
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 302 */     long start = 0L, end = 0L;
/* 303 */     boolean foundClosingBoundary = false;
/*     */     
/*     */     try {
/* 306 */       in = this.ds.getInputStream();
/* 307 */       if (!(in instanceof java.io.ByteArrayInputStream) && !(in instanceof BufferedInputStream) && !(in instanceof SharedInputStream))
/*     */       {
/*     */         
...
/*     */       
/* 351 */       while (!done) {
/* 352 */         MimeBodyPart part; InternetHeaders headers = null;
/* 353 */         if (sin != null) {
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/messaging/saaj/packaging/mime/internet/MimeMultipart.class
