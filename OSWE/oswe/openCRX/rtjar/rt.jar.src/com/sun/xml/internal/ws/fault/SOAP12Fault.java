...
/* 145 */       Iterator<Element> iter = fault.getDetail().getDetailEntries();
/* 146 */       while (iter.hasNext()) {
/* 147 */         Element fd = iter.next();
...
/* 154 */     this(new CodeType(code), new ReasonType(reason), (String)null, (String)null, detailObject);
/*     */   }
/*     */   
/*     */   CodeType getCode() {
...
/* 203 */         Detail detail = fault.addDetail();
...
/*     */       }
/*     */       
/* 214 */       return (Throwable)new ServerSOAPFaultException(fault);
...
/* 234 */     Iterator<QName> subcodes = fault.getFaultSubcodes();
/* 235 */     SubcodeType firstSct = null;
/* 236 */     while (subcodes.hasNext()) {
/* 237 */       QName subcode = subcodes.next();
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/ws/fault/SOAP12Fault.class
