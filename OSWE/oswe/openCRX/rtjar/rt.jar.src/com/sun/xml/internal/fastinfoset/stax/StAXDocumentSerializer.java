...
/*     */     
/* 135 */     this._inStartElement = this._isEmptyElement = false;
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*     */     try {
/* 166 */       for (; this._stackCount >= 0; this._stackCount--) {
/* 167 */         writeEndElement();
/*     */       }
/*     */       
...
/*     */ 
/*     */         
/* 297 */         if (namespaceURI == "http://www.w3.org/2000/xmlns/" || namespaceURI
/* 298 */           .equals("http://www.w3.org/2000/xmlns/")) {
/*     */           return;
/*     */         }
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 324 */     if (namespaceURI == "http://www.w3.org/2000/xmlns/" || namespaceURI
/* 325 */       .equals("http://www.w3.org/2000/xmlns/")) {
/*     */       return;
/*     */     }
/*     */     
...
/*     */     try {
/* 406 */       if (getIgnoreProcesingInstructions())
/*     */         return; 
...
/* 497 */         isWhiteSpace(text, start, len))
/*     */         return; 
...
/* 515 */     if (this._stackCount > -1 && !this._nsSupportContextStack[this._stackCount]) {
...
/* 548 */     return (NamespaceContext)this._nsContext;
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 600 */           for (int j = 0; j < this._namespacesArrayIndex;) {
/* 601 */             encodeNamespaceAttribute(this._namespacesArray[j++], this._namespacesArray[j++]);
/*     */           }
...
/* 641 */           if (this._nsSupportContextStack[this._stackCount--] == true) {
...
/* 715 */     if (hasMark()) {
/* 716 */       this._octetBuffer[this._markIndex] = (byte)(this._octetBuffer[this._markIndex] | 0x40);
/* 717 */       resetMark();
/*     */     } 
/*     */   }
/*     */   
...
/* 806 */       if ((prefix == name.prefix || prefix.equals(name.prefix)) && (namespaceURI == name.namespaceName || namespaceURI
/* 807 */         .equals(name.namespaceName))) {
/* 808 */         this._b = type;
...
/* 822 */       if ((prefix == name.prefix || prefix.equals(name.prefix)) && (namespaceURI == name.namespaceName || namespaceURI
/* 823 */         .equals(name.namespaceName))) {
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/fastinfoset/stax/StAXDocumentSerializer.class
