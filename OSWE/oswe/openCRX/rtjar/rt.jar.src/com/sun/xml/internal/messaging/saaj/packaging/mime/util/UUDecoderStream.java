...
/*     */     
/*     */     while (true) {
/* 173 */       String line = this.lin.readLine();
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */           
/* 222 */           byte a = (byte)(line.charAt(i++) - 32 & 0x3F);
/* 223 */           byte b = (byte)(line.charAt(i++) - 32 & 0x3F);
/* 224 */           this.buffer[this.bufsize++] = (byte)(a << 2 & 0xFC | b >>> 4 & 0x3);
/*     */           
/* 226 */           if (this.bufsize < count) {
/* 227 */             a = b;
/* 228 */             b = (byte)(line.charAt(i++) - 32 & 0x3F);
...
/* 234 */             a = b;
/* 235 */             b = (byte)(line.charAt(i++) - 32 & 0x3F);
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/messaging/saaj/packaging/mime/util/UUDecoderStream.class
