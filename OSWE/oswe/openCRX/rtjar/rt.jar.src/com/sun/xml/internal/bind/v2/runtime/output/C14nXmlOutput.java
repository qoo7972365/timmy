...
/* 174 */       this.len = 0;
/* 175 */       Collections.sort((List<DynamicAttribute>)this.otherAttributes);
/*     */ 
/*     */       
/* 178 */       int size = this.otherAttributes.size();
/* 179 */       for (int j = 0; j < size; j++) {
/* 180 */         DynamicAttribute a = (DynamicAttribute)this.otherAttributes.get(j);
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/bind/v2/runtime/output/C14nXmlOutput.class
