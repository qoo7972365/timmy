...
/* 138 */       Iterator<Attribute> it = getAttributes();
...
/* 149 */       Iterator<Namespace> it = this.fNamespaces.iterator();
...
/*     */   }
/*     */   
/*     */   void addAttributes(Iterator<Attribute> attrs) {
/* 208 */     if (attrs == null)
/*     */       return; 
/* 210 */     while (attrs.hasNext()) {
/* 211 */       Attribute attr = attrs.next();
...
/*     */   }
/*     */   
/*     */   void addNamespaceAttributes(Iterator<Namespace> attrs) {
/* 223 */     if (attrs == null)
/*     */       return; 
/* 225 */     while (attrs.hasNext()) {
/* 226 */       Namespace attr = attrs.next();
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/stream/events/StartElementEvent.class
