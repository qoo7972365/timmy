...
/*     */   extends BodyImpl
/*     */ {
/*  49 */   protected static final Logger log = Logger.getLogger(Body1_2Impl.class.getName(), "com.sun.xml.internal.messaging.saaj.soap.ver1_2.LocalStrings");
/*     */ 
/*     */   
...
/*  61 */     return (SOAPBodyElement)new BodyElement1_2Impl(((SOAPDocument)
/*  62 */         getOwnerDocument()).getDocument(), name);
/*     */   }
/*     */   
/*     */   protected SOAPBodyElement createBodyElement(QName name) {
/*  66 */     return (SOAPBodyElement)new BodyElement1_2Impl(((SOAPDocument)
/*  67 */         getOwnerDocument()).getDocument(), name);
/*     */   }
/*     */ 
/*     */   
...
/*  99 */     if (name.getLocalName().equals("encodingStyle") && name
/* 100 */       .getURI().equals("http://www.w3.org/2003/05/soap-envelope"))
/*     */     {
...
/* 109 */     if (name.getLocalPart().equals("encodingStyle") && name
/* 110 */       .getNamespaceURI().equals("http://www.w3.org/2003/05/soap-envelope"))
/*     */     {
...
/* 118 */     return (child.getElementName().getURI().equals("http://www.w3.org/2003/05/soap-envelope") && child
/*     */       
/* 120 */       .getElementName().getLocalName().equals("Fault"));
/*     */   }
/*     */ 
/*     */   
/*     */   protected SOAPFault createFaultElement() {
/* 125 */     return (SOAPFault)new Fault1_2Impl(((SOAPDocument)
/* 126 */         getOwnerDocument()).getDocument(), getPrefix());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/messaging/saaj/soap/ver1_2/Body1_2Impl.class
