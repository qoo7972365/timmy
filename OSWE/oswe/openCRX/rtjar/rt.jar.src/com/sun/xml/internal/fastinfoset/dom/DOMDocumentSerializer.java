...
/* 133 */         String str = a.getNamespaceURI();
/* 134 */         if (str != null && str.equals("http://www.w3.org/2000/xmlns/")) {
...
/* 162 */       !this._namespaceScopeContext.getNamespaceURI(elementPrefix).equals(elementNamespaceURI)) {
...
/*     */       } 
/*     */       
/* 174 */       int i = this._namespaceScopeContext.getCurrentContextStartIndex();
/* 175 */       for (; i < this._namespaceScopeContext.getCurrentContextEndIndex(); i++) {
/*     */         
...
/* 249 */         isWhiteSpace(this._charBuffer, 0, length))
/*     */         return; 
...
/* 303 */     if (getIgnoreProcesingInstructions())
/*     */       return; 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/fastinfoset/dom/DOMDocumentSerializer.class
