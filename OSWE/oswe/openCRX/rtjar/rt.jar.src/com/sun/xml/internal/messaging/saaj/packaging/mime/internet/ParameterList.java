...
/*     */         }
/* 108 */         this.list.put(name, tk.getValue()); continue;
/*     */       }  break;
...
/* 194 */     Iterator<Map.Entry> itr = this.list.entrySet().iterator();
/*     */     
...
/* 214 */         if (lastlf >= 0) {
/* 215 */           used += s.length() - lastlf - 1; continue;
/*     */         } 
/* 217 */         used += s.length(); continue;
/*     */       } 
/* 219 */       sb.append(value);
...
/* 229 */     if ("".equals(value))
/* 230 */       return "\"\""; 
/* 231 */     return MimeUtility.quote(value, "()<>@,;:\\\"\t []/?=");
/*     */   }
/*     */   
/*     */   public ParameterList copy() {
/* 235 */     return new ParameterList((HashMap)this.list.clone());
/*     */   }
/*     */ }


/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/messaging/saaj/packaging/mime/internet/ParameterList.class
