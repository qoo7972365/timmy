...
/*  93 */       this._currentStructureFragment = (FragmentedArray)this._currentStructureFragment.getNext();
/*  94 */       this._structure = this._currentStructureFragment.getArray();
/*     */     } else {
/*  96 */       this._structure = new byte[this._structure.length];
/*  97 */       this._currentStructureFragment = (FragmentedArray)new FragmentedArray<>(this._structure, (FragmentedArray)this._currentStructureFragment);
/*     */     } 
/*     */   }
/*     */   
...
/* 111 */       this._currentStructureStringFragment = (FragmentedArray)this._currentStructureStringFragment.getNext();
/* 112 */       this._structureStrings = this._currentStructureStringFragment.getArray();
/*     */     } else {
/* 114 */       this._structureStrings = new String[this._structureStrings.length];
/* 115 */       this._currentStructureStringFragment = (FragmentedArray)new FragmentedArray<>(this._structureStrings, (FragmentedArray)this._currentStructureStringFragment);
/*     */     } 
/*     */   }
/*     */   
...
/* 153 */       this._currentContentCharactersBufferFragment = (FragmentedArray)this._currentContentCharactersBufferFragment.getNext();
/* 154 */       this._contentCharactersBuffer = this._currentContentCharactersBufferFragment.getArray();
/*     */     } else {
/* 156 */       this._contentCharactersBuffer = new char[this._contentCharactersBuffer.length];
/* 157 */       this._currentContentCharactersBufferFragment = (FragmentedArray)new FragmentedArray<>(this._contentCharactersBuffer, (FragmentedArray)this._currentContentCharactersBufferFragment);
/*     */     } 
/*     */   }
/*     */ 
/*     */   
...
/* 183 */       this._contentObjects = this._currentContentObjectFragment.getArray();
/*     */     } else {
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/stream/buffer/AbstractCreator.class
