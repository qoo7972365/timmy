...
/* 107 */       String cid; Base64Data b64d = (Base64Data)value;
/*     */       
/* 109 */       if (b64d.hasData()) {
/* 110 */         cid = this.serializer.attachmentMarshaller.addMtomAttachment(b64d
/* 111 */             .get(), 0, b64d.getDataLen(), b64d.getMimeType(), this.nsUri, this.localName);
/*     */       } else {
/* 113 */         cid = this.serializer.attachmentMarshaller.addMtomAttachment(b64d
/* 114 */             .getDataHandler(), this.nsUri, this.localName);
/*     */       } 
/* 116 */       if (cid != null) {
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/bind/v2/runtime/output/MTOMXmlOutput.class
