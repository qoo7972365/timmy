...
/*  70 */     return (XMLStreamReader)new StAXDocumentParser(s, this._manager);
/*     */   }
/*     */   
...
/* 132 */     return (XMLEventReader)new StAXEventReader(createXMLStreamReader(inputstream));
/*     */   }
/*     */   
/*     */   public XMLEventReader createXMLEventReader(Reader reader) throws XMLStreamException {
/* 136 */     return (XMLEventReader)new StAXEventReader(createXMLStreamReader(reader));
/*     */   }
/*     */   
/*     */   public XMLEventReader createXMLEventReader(Source source) throws XMLStreamException {
/* 140 */     return (XMLEventReader)new StAXEventReader(createXMLStreamReader(source));
/*     */   }
/*     */   
/*     */   public XMLEventReader createXMLEventReader(String systemId, InputStream inputstream) throws XMLStreamException {
/* 144 */     return (XMLEventReader)new StAXEventReader(createXMLStreamReader(systemId, inputstream));
/*     */   }
/*     */   
/*     */   public XMLEventReader createXMLEventReader(InputStream stream, String encoding) throws XMLStreamException {
/* 148 */     return (XMLEventReader)new StAXEventReader(createXMLStreamReader(stream, encoding));
/*     */   }
/*     */   
/*     */   public XMLEventReader createXMLEventReader(String systemId, Reader reader) throws XMLStreamException {
/* 152 */     return (XMLEventReader)new StAXEventReader(createXMLStreamReader(systemId, reader));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 163 */     return (XMLEventReader)new StAXEventReader(streamReader);
/*     */   }
/*     */   
...
/* 194 */     return (XMLEventReader)new StAXFilteredEvent(reader, filter);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 205 */       return (XMLStreamReader)new StAXFilteredParser(reader, filter);
/*     */     }
/* 207 */     return null;
/*     */   }
/*     */ 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/fastinfoset/stax/factory/StAXInputFactory.class
