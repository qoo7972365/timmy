...
/*     */     }
/*     */     
/*  80 */     Collection<Policy> result = new ArrayList<>(this.policyURIs.size());
/*     */     
/*  82 */     for (String policyURI : this.policyURIs) {
/*  83 */       PolicySourceModel sourceModel = this.policyStore.get(policyURI);
...
/*  95 */     Collection<Policy> policies = getPolicies();
/*  96 */     Collection<PolicySubject> result = new ArrayList<>(policies.size());
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/ws/policy/jaxws/BuilderHandler.class
