...
/*  62 */     METHOD_FILE_TO_PATH = safeGetMethod(File.class, "toPath", new Class[0]);
/*  63 */     METHOD_FILES_CREATE_TEMP_FILE = safeGetMethod(CLASS_FILES, "createTempFile", new Class[] { String.class, String.class, CLASS_FILE_ATTRIBUTES });
/*  64 */     METHOD_FILES_CREATE_TEMP_FILE_WITHPATH = safeGetMethod(CLASS_FILES, "createTempFile", new Class[] { CLASS_PATH, String.class, String.class, CLASS_FILE_ATTRIBUTES });
/*  65 */     METHOD_PATH_TO_FILE = safeGetMethod(CLASS_PATH, "toFile", new Class[0]);
/*     */   }
/*     */   
...
/* 129 */       LOGGER.log(Level.WARNING, "Error invoking java.nio API, temp file (path: {0}, prefix:{1}, suffix:{2}) being created using old java.io API.", new Object[] { (dir != null) ? dir
/* 130 */             .getAbsolutePath() : null, prefix, suffix });
...
/* 135 */       LOGGER.log(Level.WARNING, "Error invoking java.nio API, temp file (path: {0}, prefix:{1}, suffix:{2}) being created using old java.io API.", new Object[] { (dir != null) ? dir
/* 136 */             .getAbsolutePath() : null, prefix, suffix });
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/org/jvnet/mimepull/TempFiles.class
