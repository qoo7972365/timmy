...
/*  79 */     m.write(this.tagName, this.bi, t, XMLStreamWriterOutput.create(output, this.context, m.getEscapeHandler()), new StAXPostInitAction(output, m.serializer));
/*     */   }
/*     */   
...
/*  94 */     m.write(this.tagName, this.bi, t, (XmlOutput)new SAXOutput((ContentHandler)new SAX2DOMEx(output)), new DomPostInitAction(output, m.serializer));
/*     */   }
/*     */   
...
/*  99 */     m.write(this.tagName, this.bi, t, (XmlOutput)new SAXOutput(contentHandler), null);
/*     */   }
/*     */   
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/bind/v2/runtime/BridgeImpl.class
