...
/* 113 */       } else if (latestVersion.compareTo((Enum)tested.getNamespaceVersion()) < 0) {
...
/*     */ 
/*     */     
/* 127 */     List<AssertionSet> finalAlternatives = new LinkedList<>(policies[0].getContent());
/* 128 */     Queue<AssertionSet> testedAlternatives = new LinkedList<>();
/* 129 */     List<AssertionSet> alternativesToMerge = new ArrayList<>(2);
/* 130 */     for (int i = 1; i < policies.length; i++) {
/* 131 */       Collection<AssertionSet> currentAlternatives = policies[i].getContent();
/*     */       
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/ws/policy/PolicyIntersector.class
