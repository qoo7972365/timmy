...
/* 189 */         int i; for (i = sp.currentNamespaces.size() - 1; i >= 0; i--) {
/* 190 */           String result = DOMStreamReader.getPrefixForAttr((Attr)sp.currentNamespaces.get(i), nsUri);
/* 191 */           if (result != null)
/* 192 */             return result; 
/*     */         } 
/* 194 */         for (i = sp.additionalNamespaces.size() - 2; i >= 0; i -= 2) {
...
/* 260 */         Attr attr = (Attr)this._namedNodeMap.item(j);
...
/* 346 */         QName.valueOf(((Attr)this._currentAttributes.get(index)).getNodeName()).getLocalPart();
/*     */     } 
...
/* 434 */         QName.valueOf(this._current.getNodeName()).getLocalPart();
/*     */     } 
...
/* 573 */     Node node = this._start; int type;
/* 574 */     while ((type = node.getNodeType()) != 9 && type != 1)
/*     */     {
...
/* 606 */     return Collections.<String>singletonList(prefix).iterator();
/*     */   }
/*     */   
...
/* 742 */           if (prev != null && prev.getNodeType() == 3) {
/*     */             continue;
/*     */           }
/* 745 */           t = (Text)this._current;
/* 746 */           this.wholeText = t.getWholeText();
/* 747 */           if (this.wholeText.length() == 0)
/*     */             continue; 
/* 749 */           return 4;
/*     */         case 1:
/* 751 */           splitAttributes();
...
/*     */         }
/*     */         
/* 801 */         sibling = this._current.getNextSibling();
/* 802 */         if (sibling == null) {
...
/* 823 */     while ((eventType == 4 && isWhiteSpace()) || (eventType == 12 && 
/* 824 */       isWhiteSpace()) || eventType == 6 || eventType == 3 || eventType == 5)
/*     */     {
/*     */ 
/*     */ 
/*     */       
...
/*     */         } 
/*     */         
/* 885 */         if (node.getNodeType() == 2)
/*     */           return; 
/* 887 */         attrs = node.getAttributes();
/* 888 */         for (i = 0; i < attrs.getLength(); i++) {
/* 889 */           verifyDOMIntegrity(attrs.item(i));
/*     */         }
/*     */       case 9:
/* 892 */         children = node.getChildNodes();
/* 893 */         for (j = 0; j < children.getLength(); j++) {
/* 894 */           verifyDOMIntegrity(children.item(j));
/*     */         }
/*     */         break;
/*     */     }  }
/*     */ 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/ws/streaming/DOMStreamReader.class
