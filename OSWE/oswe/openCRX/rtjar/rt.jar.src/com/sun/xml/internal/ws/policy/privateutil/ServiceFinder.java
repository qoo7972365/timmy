...
/* 203 */     return new LazyIterator<>(this.serviceClass, this.classLoader);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   
/*     */   public T[] toArray() {
/* 216 */     List<T> result = new ArrayList<>();
/* 217 */     for (T t : this) {
/* 218 */       result.add(t);
/*     */     }
/* 220 */     return result.toArray((T[])Array.newInstance(this.serviceClass, result.size()));
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   private static void fail(Class service, String msg, Throwable cause) throws ServiceConfigurationError {
/* 226 */     ServiceConfigurationError sce = new ServiceConfigurationError(LocalizationMessages.WSP_0025_SPI_FAIL_SERVICE_MSG(service.getName(), msg));
/* 227 */     if (null != cause) {
...
/* 265 */         fail(service, u, lc, LocalizationMessages.WSP_0066_ILLEGAL_PROVIDER_CLASSNAME(ln), null);  int i;
/* 266 */       for (i = Character.charCount(cp); i < n; i += Character.charCount(cp)) {
...
/* 299 */     ArrayList<String> names = new ArrayList<>();
/*     */     try {
/* 301 */       in = u.openStream();
...
/* 352 */           return false;
/*     */         }
/* 354 */         this.pending = ServiceFinder.parse(this.service, this.configs.nextElement(), this.returned);
/*     */       } 
/* 356 */       this.nextName = this.pending.next();
/* 357 */       return true;
/*     */     }
/*     */     
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/ws/policy/privateutil/ServiceFinder.class
