...
/*  86 */     ManagedServiceAssertion assertion = ManagementAssertion.<ManagedServiceAssertion>getAssertion(MANAGED_SERVICE_QNAME, policyMap, endpoint
/*  87 */         .getServiceName(), endpoint.getPortName(), ManagedServiceAssertion.class);
...
/* 133 */         throw (WebServiceException)LOGGER.logSevereException(new WebServiceException(
...
/* 148 */     Collection<ImplementationRecord> result = new LinkedList<>();
/* 149 */     Iterator<PolicyAssertion> parameters = getParametersIterator();
/* 150 */     while (parameters.hasNext()) {
/* 151 */       PolicyAssertion parameter = parameters.next();
/* 152 */       if (COMMUNICATION_SERVER_IMPLEMENTATIONS_PARAMETER_QNAME.equals(parameter.getName())) {
/* 153 */         Iterator<PolicyAssertion> implementations = parameter.getParametersIterator();
/* 154 */         if (!implementations.hasNext()) {
/* 155 */           throw (WebServiceException)LOGGER.logSevereException(new WebServiceException(
/* 156 */                 ManagementMessages.WSM_1005_EXPECTED_COMMUNICATION_CHILD()));
/*     */         }
/* 158 */         while (implementations.hasNext()) {
/* 159 */           PolicyAssertion implementation = implementations.next();
...
/*     */             continue;
/*     */           } 
/* 164 */           throw (WebServiceException)LOGGER.logSevereException(new WebServiceException(
/* 165 */                 ManagementMessages.WSM_1004_EXPECTED_XML_TAG(COMMUNICATION_SERVER_IMPLEMENTATION_PARAMETER_QNAME, implementation
/* 166 */                   .getName())));
/*     */         } 
/*     */       } 
/*     */     } 
...
/* 205 */     Iterator<PolicyAssertion> parameters = getParametersIterator();
/* 206 */     while (parameters.hasNext()) {
/* 207 */       PolicyAssertion parameter = parameters.next();
...
/* 217 */     HashMap<QName, String> parameterMap = new HashMap<>();
/* 218 */     Iterator<PolicyAssertion> implementationParameters = rootParameter.getParametersIterator();
/* 219 */     Collection<NestedParameters> nestedParameters = new LinkedList<>();
/* 220 */     while (implementationParameters.hasNext()) {
/* 221 */       PolicyAssertion parameterAssertion = implementationParameters.next();
/* 222 */       QName parameterName = parameterAssertion.getName();
/* 223 */       if (parameterAssertion.hasParameters()) {
/* 224 */         Map<QName, String> nestedParameterMap = new HashMap<>();
/* 225 */         Iterator<PolicyAssertion> parameters = parameterAssertion.getParametersIterator();
/* 226 */         while (parameters.hasNext()) {
/* 227 */           PolicyAssertion parameter = parameters.next();
/* 228 */           String str = parameter.getValue();
/* 229 */           if (str != null) {
/* 230 */             str = str.trim();
/*     */           }
/* 232 */           nestedParameterMap.put(parameter.getName(), str);
/*     */         } 
...
/* 299 */       if ((this.implementation == null) ? (other.implementation != null) : 
/* 300 */         !this.implementation.equals(other.implementation)) {
/* 301 */         return false;
/*     */       }
/* 303 */       if (this.parameters != other.parameters && (this.parameters == null || !this.parameters.equals(other.parameters))) {
/* 304 */         return false;
/*     */       }
/* 306 */       if (this.nestedParameters != other.nestedParameters && (this.nestedParameters == null || 
/* 307 */         !this.nestedParameters.equals(other.nestedParameters))) {
/* 308 */         return false;
/*     */       }
/* 310 */       return true;
/*     */     }
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/ws/api/config/management/policy/ManagedServiceAssertion.class
