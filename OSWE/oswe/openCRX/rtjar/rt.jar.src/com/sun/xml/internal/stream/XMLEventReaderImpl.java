...
/* 112 */       throw new XMLStreamException("parser must be on START_ELEMENT to read next text", this.fLastEvent
/* 113 */           .getLocation());
/*     */     }
/*     */ 
/*     */ 
...
/*     */         
/* 138 */         if (type == 1)
/* 139 */           throw new XMLStreamException("elementGetText() function expects text only elment but START_ELEMENT was encountered.", event
/* 140 */               .getLocation()); 
/* 141 */         if (type == 2) {
/* 142 */           return "";
/*     */         }
...
/* 168 */           if (type == 1) {
/* 169 */             throw new XMLStreamException("elementGetText() function expects text only elment but START_ELEMENT was encountered.", event
/* 170 */                 .getLocation());
/*     */           }
/* 172 */           throw new XMLStreamException("Unexpected event type " + type, event
/* 173 */               .getLocation());
/*     */         } 
/*     */         
...
/*     */ 
/*     */       
/* 226 */       while ((event.isCharacters() && event.asCharacters().isWhiteSpace()) || eventType == 3 || eventType == 5) {
/*     */ 
/*     */ 
/*     */         
/* 230 */         event = nextEvent();
...
/* 263 */     if (this.fPeekedEvent != null) return this.fPeekedEvent;
/*     */     
/* 265 */     if (hasNext()) {
/*     */ 
/*     */ 
...
/*     */ 
/*     */       
/* 276 */       this.fXMLReader.next();
/* 277 */       this.fPeekedEvent = this.fXMLEventAllocator.allocate(this.fXMLReader);
/* 278 */       return this.fPeekedEvent;
/*     */     } 
/* 280 */     return null;
/*     */   }
/*     */ }
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/stream/XMLEventReaderImpl.class
