...
/* 132 */     XmlAdapter<OnWire, InMemory> a = u.coordinator.getAdapter(this.adapter);
/* 133 */     u.coordinator.pushCoordinator();
/*     */     try {
/* 135 */       return (InMemory)a.unmarshal(v);
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/bind/v2/runtime/BridgeAdapter.class
