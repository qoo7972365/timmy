...
/*     */ 
/*     */       
/* 250 */       int i = ++this.currentPos, nesting = 1;
/* 251 */       for (; nesting > 0 && this.currentPos < this.maxPos; 
/* 252 */         this.currentPos++) {
...
/*     */         
/* 271 */         if (filter) {
/* 272 */           s = filterToken(this.string, i, this.currentPos - 1);
/*     */         } else {
/* 274 */           s = this.string.substring(i, this.currentPos - 1);
/*     */         } 
...
/*     */     
/* 287 */     if (c == '"') {
/* 288 */       for (int i = ++this.currentPos; this.currentPos < this.maxPos; this.currentPos++) {
...
/* 294 */           filter = true;
/* 295 */         } else if (c == '"') {
/* 296 */           String s; this.currentPos++;
/*     */ 
/*     */           
/* 299 */           if (filter) {
/* 300 */             s = filterToken(this.string, i, this.currentPos - 1);
/*     */           } else {
/* 302 */             s = this.string.substring(i, this.currentPos - 1);
/*     */           } 
...
/*     */     
/*     */     int start;
/* 319 */     for (start = this.currentPos; this.currentPos < this.maxPos; this.currentPos++) {
/* 320 */       c = this.string.charAt(this.currentPos);
/*     */ 
/*     */       
/* 323 */       if (c < ' ' || c >= '' || c == '(' || c == ' ' || c == '"' || this.delimiters
/* 324 */         .indexOf(c) >= 0)
/*     */         break; 
/*     */     } 
...
/* 333 */     for (; this.currentPos < this.maxPos; this.currentPos++) {
/* 334 */       char c; if ((c = this.string.charAt(this.currentPos)) != ' ' && c != '\t' && c != '\r' && c != '\n')
/*     */       {
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/ws/encoding/HeaderTokenizer.class
