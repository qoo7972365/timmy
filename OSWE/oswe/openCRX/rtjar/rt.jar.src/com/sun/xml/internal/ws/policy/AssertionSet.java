...
/* 170 */     label17: for (PolicyAssertion thisAssertion : this.assertions) {
...
/* 244 */     List<PolicyAssertion> matched = new LinkedList<>();
/*     */     
...
/*     */ 
/*     */     
/* 287 */     Iterator<QName> vIterator1 = getVocabulary().iterator();
/* 288 */     Iterator<QName> vIterator2 = that.getVocabulary().iterator();
/* 289 */     while (vIterator1.hasNext()) {
/* 290 */       QName entry1 = vIterator1.next();
/* 291 */       if (vIterator2.hasNext()) {
/* 292 */         QName entry2 = vIterator2.next();
...
/*     */ 
/*     */     
/* 307 */     Iterator<PolicyAssertion> pIterator1 = getAssertions().iterator();
/* 308 */     Iterator<PolicyAssertion> pIterator2 = that.getAssertions().iterator();
/* 309 */     while (pIterator1.hasNext()) {
/* 310 */       PolicyAssertion pa1 = pIterator1.next();
/* 311 */       if (pIterator2.hasNext()) {
/* 312 */         PolicyAssertion pa2 = pIterator2.next();
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/ws/policy/AssertionSet.class
