...
/*     */   extends FaultImpl
/*     */ {
/*  56 */   protected static final Logger log = Logger.getLogger("com.sun.xml.internal.messaging.saaj.soap.ver1_1", "com.sun.xml.internal.messaging.saaj.soap.ver1_1.LocalStrings");
/*     */ 
/*     */ 
/*     */   
...
/*  81 */     return new Detail1_1Impl(((SOAPDocument)
/*  82 */         getOwnerDocument()).getDocument());
/*     */   }
/*     */   
/*     */   protected FaultElementImpl createSOAPFaultElement(String localName) {
/*  86 */     return new FaultElement1_1Impl(((SOAPDocument)
/*  87 */         getOwnerDocument()).getDocument(), localName);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */       
/* 121 */       return (Name)NameImpl.createFromUnqualifiedName(faultcodeString);
/*     */     }
/*     */ 
/*     */     
...
/* 139 */     return convertCodeToQName(faultcodeString, (SOAPElement)this.faultCodeElement);
/*     */   }
/*     */ 
/*     */   
...
/* 148 */       this.faultStringElement = (SOAPFaultElement)addSOAPFaultElement("faultstring");
/*     */     } else {
...
/*     */       
/* 170 */       String xmlLangAttr = this.faultStringElement.getAttributeValue(
/* 171 */           (Name)NameImpl.createFromUnqualifiedName("xml:lang"));
...
/* 181 */     this.faultStringElement.addAttribute(
/* 182 */         NameImpl.createFromTagName("xml:lang"), 
/* 183 */         localeToXmlLang(locale));
/*     */   }
/*     */   
/*     */   protected boolean isStandardFaultElement(String localName) {
/* 187 */     if (localName.equalsIgnoreCase("detail") || localName
/* 188 */       .equalsIgnoreCase("faultcode") || localName
/* 189 */       .equalsIgnoreCase("faultstring") || localName
/* 190 */       .equalsIgnoreCase("faultactor")) {
/* 191 */       return true;
/*     */     }
/* 193 */     return false;
/*     */   }
...
/* 302 */     return new FaultElement1_1Impl(((SOAPDocument)
/* 303 */         getOwnerDocument()).getDocument(), qname);
/*     */   }
/*     */ 
/*     */   
/*     */   protected FaultElementImpl createSOAPFaultElement(Name qname) {
/* 308 */     return new FaultElement1_1Impl(((SOAPDocument)
/* 309 */         getOwnerDocument()).getDocument(), (NameImpl)qname);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 359 */     if (faultCode.equals("VersionMismatch") || faultCode.equals("MustUnderstand") || faultCode
/* 360 */       .equals("Client") || faultCode.equals("Server")) {
/* 361 */       return true;
/*     */     }
/* 363 */     if (faultCode.startsWith("VersionMismatch.") || faultCode.startsWith("MustUnderstand.") || faultCode
/* 364 */       .startsWith("Client.") || faultCode.startsWith("Server.")) {
/* 365 */       return true;
/*     */     }
/* 367 */     return false;
/*     */   }
...
/*     */       return; 
/* 377 */     this
/* 378 */       .faultActorElement = (SOAPFaultElement)createSOAPFaultElement((Name)getFaultActorName());
/* 379 */     this.faultActorElement.addTextNode(faultActor);
/* 380 */     if (hasDetail()) {
/* 381 */       insertBefore((Node)this.faultActorElement, (Node)this.detail);
/*     */       return;
/*     */     } 
/* 384 */     addNode((Node)this.faultActorElement);
/*     */   }
/*     */ }


/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/messaging/saaj/soap/ver1_1/Fault1_1Impl.class
