...
/*  78 */     super(grammar, (RuntimeTypeInfo)rei, rei.getType(), true, false, true);
/*     */     
/*  80 */     this.property = PropertyFactory.create(grammar, (RuntimePropertyInfo)rei.getProperty());
/*     */     
...
/*     */     
/*  86 */     Class<JAXBElement> type = (Class)Utils.REFLECTION_NAVIGATOR.erasure(rei.getType());
...
/*     */     
/* 115 */     this.property = new Property<JAXBElement>() {
...
/* 130 */             } catch (JAXBException x) {
/*     */               
/* 132 */               target.reportError(null, (Throwable)x);
/*     */               return;
/*     */             } 
...
/* 146 */             } catch (AccessorException x) {
/* 147 */               JaxBeanInfo tbi; target.reportError(null, (Throwable)tbi);
/*     */             } 
/*     */           } 
/*     */         }
/*     */ 
...
/* 274 */       QNameMap<ChildLoader> result = new QNameMap();
...
/*     */     }
/* 294 */     return this.constructor.newInstance(new Object[] { o });
/*     */   }
/*     */   
...
/* 318 */     } catch (AccessorException x) {
/* 319 */       target.reportError(null, (Throwable)x);
/*     */     } 
/*     */   }
/*     */   
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/bind/v2/runtime/ElementBeanInfoImpl.class
