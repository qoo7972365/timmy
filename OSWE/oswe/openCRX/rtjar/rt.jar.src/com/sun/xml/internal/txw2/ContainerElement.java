...
/*     */     }
/*     */     
/* 125 */     XmlAttribute xa = method.<XmlAttribute>getAnnotation(XmlAttribute.class);
/* 126 */     XmlValue xv = method.<XmlValue>getAnnotation(XmlValue.class);
/* 127 */     XmlElement xe = method.<XmlElement>getAnnotation(XmlElement.class);
/*     */ 
/*     */     
/* 130 */     if (xa != null) {
...
/* 188 */       XmlElement ce = c.<XmlElement>getAnnotation(XmlElement.class);
/* 189 */       if (ce != null) {
/* 190 */         nsUri = ce.ns();
/*     */       }
/*     */       
...
/*     */         Text text;
/* 209 */         if (isCDATA) { text = new Cdata(this.document, st, arg); }
/* 210 */         else { text = new Pcdata(this.document, st, arg); }
/* 211 */          addChild(text);
/*     */       } 
...
/*     */ 
/*     */     
/* 231 */     XmlNamespace ns = pkg.<XmlNamespace>getAnnotation(XmlNamespace.class);
/* 232 */     if (ns != null) {
/* 233 */       nsUri = ns.value();
/*     */     } else {
/* 235 */       nsUri = "";
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/txw2/ContainerElement.class
