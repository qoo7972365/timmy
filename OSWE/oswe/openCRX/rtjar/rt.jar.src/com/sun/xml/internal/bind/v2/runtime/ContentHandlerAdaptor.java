...
/*     */ 
/*     */         
/*  99 */         this.serializer.getNamespaceContext().force((String)this.prefixMap
/* 100 */             .get(i + 1), (String)this.prefixMap.get(i));
/*     */       }
/*     */       
/* 103 */       for (i = 0; i < len; i++) {
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/bind/v2/runtime/ContentHandlerAdaptor.class
