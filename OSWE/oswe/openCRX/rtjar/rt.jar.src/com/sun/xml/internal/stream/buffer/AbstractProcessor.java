...
/* 137 */     this._structure = this._currentStructureFragment.getArray();
...
/* 141 */     this._structureStrings = this._currentStructureStringFragment.getArray();
...
/* 145 */     this._contentCharactersBuffer = this._currentContentCharactersBufferFragment.getArray();
...
/* 149 */     this._contentObjects = this._currentContentObjectFragment.getArray();
...
/* 194 */     this._currentStructureFragment = (FragmentedArray)this._currentStructureFragment.getNext();
/* 195 */     this._structure = this._currentStructureFragment.getArray();
...
/* 205 */     this._currentStructureStringFragment = (FragmentedArray)this._currentStructureStringFragment.getNext();
/* 206 */     this._structureStrings = this._currentStructureStringFragment.getArray();
...
/* 226 */     this._currentContentCharactersBufferFragment = (FragmentedArray)this._currentContentCharactersBufferFragment.getNext();
/* 227 */     this._contentCharactersBuffer = this._currentContentCharactersBufferFragment.getArray();
/* 228 */     return 0;
/*     */   }
/*     */   
...
/* 238 */     this._contentObjects = this._currentContentObjectFragment.getArray();
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/stream/buffer/AbstractProcessor.class
