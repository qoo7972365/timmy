...
/*  54 */       urlString = absolutePath.startsWith(File.separator) ? ("file://" + absolutePath) : ("file:///" + absolutePath);
/*     */     
/*     */     }
/*     */     else {
/*     */       
...
/* 106 */       return false; 
/* 107 */     if (systemId.length() > 2 && systemId
/* 108 */       .charAt(1) == ':' && 
/* 109 */       Character.isLetter(systemId.charAt(0)) && (systemId
/* 110 */       .charAt(2) == '\\' || systemId.charAt(2) == '/')) {
/* 111 */       return true;
/*     */     }
/* 113 */     return false;
/*     */   }
...
/*     */                 {
/* 151 */                   absoluteURI = systemId.substring(0, secondColonIndex - 1) + getAbsolutePathFromRelativePath(localPath);
/*     */                 }
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/fastinfoset/sax/SystemIdResolver.class
