...
/*  70 */       RejectDoctypeSaxFilter rejectDoctypeSaxFilter; if (src instanceof JAXMStreamSource) {
/*     */         try {
...
/*     */       
/*     */       try {
/*  94 */         rejectDoctypeSaxFilter = new RejectDoctypeSaxFilter(saxParser);
...
/*     */ 
/*     */       
/* 101 */       src = new SAXSource((XMLReader)rejectDoctypeSaxFilter, is);
/*     */     } 
/*     */ 
/*     */     
/*     */     try {
/* 106 */       Transformer transformer = EfficientStreamingTransformer.newTransformer();
/* 107 */       DOMResult result = new DOMResult((Node)soapPart);
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/messaging/saaj/soap/EnvelopeFactory.class
