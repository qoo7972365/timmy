...
/*  41 */           .getString("message.lengthNotMultipleOfUUID", new Object[] { Integer.valueOf(16) }));
/*     */     }
/*     */     
...
/* 106 */     return digits(msb >> 32L, 8) + "-" + 
/* 107 */       digits(msb >> 16L, 4) + "-" + 
/* 108 */       digits(msb, 4) + "-" + 
/* 109 */       digits(lsb >> 48L, 4) + "-" + 
/* 110 */       digits(lsb, 12);
/*     */   }
/*     */   
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/fastinfoset/algorithm/UUIDEncodingAlgorithm.class
