...
/*  98 */         String str = getPrefix(uri);
/*  99 */         if (str != null) {
/* 100 */           this._prefixToPrefixMapping.put(prefix, str);
/*     */         }
/*     */         
/*     */         return;
/*     */       } 
...
/* 123 */       if (encodeElementMapEntry(entry, namespaceURI))
/*     */         return; 
...
/* 128 */           encodeElementMapEntry(entry, namespaceURI)) {
/*     */           return;
/*     */         }
/*     */       } 
/*     */     } 
...
/* 168 */               if (uri == "http://www.w3.org/2001/XMLSchema-instance" || uri
/* 169 */                 .equals("http://www.w3.org/2001/XMLSchema-instance")) {
...
/*     */             } 
/*     */           } else {
/* 183 */             encodeNonIdentifyingStringOnFirstBit(eAtts.getAlgorithmURI(i), eAtts
/* 184 */                 .getAlgorithmIndex(i), data);
/*     */           } 
/*     */         } 
/*     */       } 
/*     */     } else {
...
/*     */           
/* 195 */           if (uri == "http://www.w3.org/2001/XMLSchema-instance" || uri
/* 196 */             .equals("http://www.w3.org/2001/XMLSchema-instance")) {
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/fastinfoset/sax/SAXDocumentSerializerWithPrefixMapping.class
