...
/*     */     
/* 114 */     this.current = this.top = new Element(this, null);
/*     */     
...
/*     */     
/* 142 */     if (uri.length() == 0) {
/* 143 */       for (int j = this.size - 1; j >= 0; j--) {
/* 144 */         if (this.nsUris[j].length() == 0)
/* 145 */           return j; 
/* 146 */         if (this.prefixes[j].length() == 0) {
/*     */ 
/*     */           
/* 149 */           assert this.current.defaultPrefixIndex == -1 && this.current.oldDefaultNamespaceUriIndex == -1;
/*     */           
/* 151 */           String oldUri = this.nsUris[j];
/* 152 */           String[] knownURIs = this.owner.nameList.namespaceURIs;
/*     */           
/* 154 */           if (this.current.baseIndex <= j) {
/*     */ 
/*     */             
/* 157 */             this.nsUris[j] = "";
/*     */             
...
/*     */ 
/*     */             
/* 162 */             for (int m = knownURIs.length - 1; m >= 0; m--) {
/* 163 */               if (knownURIs[m].equals(oldUri)) {
/* 164 */                 this.owner.knownUri2prefixIndexMap[m] = subst;
/*     */                 break;
/*     */               } 
/*     */             } 
...
/*     */ 
/*     */           
/* 176 */           for (int k = knownURIs.length - 1; k >= 0; k--) {
/* 177 */             if (knownURIs[k].equals(oldUri)) {
/* 178 */               this.current.defaultPrefixIndex = j;
/* 179 */               this.current.oldDefaultNamespaceUriIndex = k;
/*     */ 
/*     */ 
/*     */               
/* 183 */               this.owner.knownUri2prefixIndexMap[k] = this.size;
/*     */               break;
/*     */             } 
/*     */           } 
...
/* 230 */         if (this.nsUris[i].equals(uri)) {
/* 231 */           return i;
/*     */         }
/*     */         
/*     */         break;
...
/* 279 */     String prefix = (new StringBuilder(5)).append("ns").append(this.size).toString();
...
/*     */     }
/* 349 */     return Collections.<String>singleton(uri).iterator();
/*     */   }
/*     */   
...
/* 441 */         this.next = new Element(this.context, this); 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/bind/v2/runtime/output/NamespaceContextImpl.class
