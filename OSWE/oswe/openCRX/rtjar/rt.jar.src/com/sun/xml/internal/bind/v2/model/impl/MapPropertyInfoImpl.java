...
/*     */     
/*  62 */     T raw = getRawType();
/*  63 */     T bt = (T)nav().getBaseClass(raw, nav().asDecl(Map.class));
/*  64 */     assert bt != null;
/*     */     
/*  66 */     if (nav().isParameterizedType(bt)) {
/*  67 */       this.keyType = (T)nav().getTypeArgument(bt, 0);
/*  68 */       this.valueType = (T)nav().getTypeArgument(bt, 1);
/*     */     } else {
/*  70 */       this.keyType = this.valueType = (T)nav().ref(Object.class);
/*     */     } 
/*     */   }
/*     */   
/*     */   public Collection<? extends TypeInfo<T, C>> ref() {
/*  75 */     return (Collection)Arrays.asList((Object[])new NonElement[] { getKeyType(), getValueType() });
/*     */   }
/*     */   
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/bind/v2/model/impl/MapPropertyInfoImpl.class
