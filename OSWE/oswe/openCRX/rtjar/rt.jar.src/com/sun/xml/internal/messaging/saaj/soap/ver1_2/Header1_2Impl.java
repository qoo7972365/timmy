...
/*     */   extends HeaderImpl
/*     */ {
/*  52 */   protected static final Logger log = Logger.getLogger("com.sun.xml.internal.messaging.saaj.soap.ver1_2", "com.sun.xml.internal.messaging.saaj.soap.ver1_2.LocalStrings");
/*     */ 
/*     */ 
/*     */   
...
/*  85 */       prefix = "ns1";
/*     */     }
/*  87 */     NameImpl nameImpl = getNotUnderstoodName();
/*     */     
/*  89 */     SOAPHeaderElement notunderstoodHeaderElement = (SOAPHeaderElement)addChildElement((Name)nameImpl);
/*  90 */     notunderstoodHeaderElement.addAttribute(
/*  91 */         (Name)NameImpl.createFromUnqualifiedName("qname"), 
/*  92 */         getQualifiedName(new QName(sourceName
/*     */             
/*  94 */             .getNamespaceURI(), sourceName
/*  95 */             .getLocalPart(), prefix)));
/*     */     
/*  97 */     notunderstoodHeaderElement.addNamespaceDeclaration(prefix, sourceName
/*     */         
/*  99 */         .getNamespaceURI());
...
/* 104 */     log.log(Level.SEVERE, "SAAJ0416.ver1_2.adding.text.not.legal", 
/*     */ 
/*     */         
/* 107 */         getElementQName());
...
/*     */     } 
/* 118 */     return (SOAPHeaderElement)new HeaderElement1_2Impl(((SOAPDocument)
/* 119 */         getOwnerDocument()).getDocument(), name);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*     */     } 
/* 130 */     return (SOAPHeaderElement)new HeaderElement1_2Impl(((SOAPDocument)
/* 131 */         getOwnerDocument()).getDocument(), name);
/*     */   }
/*     */ 
/*     */   
...
/* 142 */     if (name.getLocalName().equals("encodingStyle") && name
/* 143 */       .getURI().equals("http://www.w3.org/2003/05/soap-envelope"))
/*     */     {
...
/* 152 */     if (name.getLocalPart().equals("encodingStyle") && name
/* 153 */       .getNamespaceURI().equals("http://www.w3.org/2003/05/soap-envelope"))
/*     */     {
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/messaging/saaj/soap/ver1_2/Header1_2Impl.class
