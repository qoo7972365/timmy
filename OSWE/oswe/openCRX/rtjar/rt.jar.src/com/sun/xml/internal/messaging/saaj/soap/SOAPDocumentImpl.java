...
/*     */   
/*  45 */   protected static final Logger log = Logger.getLogger("com.sun.xml.internal.messaging.saaj.soap", "com.sun.xml.internal.messaging.saaj.soap.LocalStrings");
/*     */   
...
/*  98 */     return (Element)ElementFactory.createElement(this, 
/*     */         
/* 100 */         NameImpl.getLocalNameFromTagName(tagName), 
/* 101 */         NameImpl.getPrefixFromTagName(tagName), null);
/*     */   }
/*     */ 
/*     */   
...
/* 110 */     return (Text)new TextImpl(this, data);
/*     */   }
/*     */   
/*     */   public Comment createComment(String data) {
/* 114 */     return (Comment)new CommentImpl(this, data);
/*     */   }
/*     */   
/*     */   public CDATASection createCDATASection(String data) throws DOMException {
/* 118 */     return (CDATASection)new CDATAImpl(this, data);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 162 */     return (Element)ElementFactory.createElement(this, 
/*     */         
/* 164 */         NameImpl.getLocalNameFromTagName(qualifiedName), 
/* 165 */         NameImpl.getPrefixFromTagName(qualifiedName), namespaceURI);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 186 */     cloneNode(newSoapPart.getDocument(), deep);
/* 187 */     return (Node)newSoapPart;
/*     */   }
/*     */   
/*     */   public void cloneNode(SOAPDocumentImpl newdoc, boolean deep) {
/* 191 */     cloneNode(newdoc, deep);
/*     */   }
/*     */ }


/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/messaging/saaj/soap/SOAPDocumentImpl.class
