...
/* 248 */         data[len++] = (byte)c;
/*     */       } else {
/* 250 */         int byteLength = i; int j;
/* 251 */         for (j = i; j < charLength; j++) {
/* 252 */           c = s.charAt(j);
/* 253 */           if (c >= '\001' && c <= '') {
/* 254 */             byteLength++;
/* 255 */           } else if (c > '߿') {
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/ws/org/objectweb/asm/ByteVector.class
