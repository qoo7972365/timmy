...
/*  75 */     this.out.add(this.ef
/*  76 */         .createStartElement(this.nsContext
/*  77 */           .getPrefix(prefix), this.nsContext
/*  78 */           .getNamespaceURI(prefix), localName));
/*     */ 
/*     */     
...
/*     */     } else {
/*  97 */       att = this.ef.createAttribute(this.nsContext
/*  98 */           .getPrefix(prefix), this.nsContext
/*  99 */           .getNamespaceURI(prefix), localName, value);
/*     */     } 
/*     */     
...
/* 110 */     this.out.add(this.ef
/* 111 */         .createEndElement(this.nsContext
/* 112 */           .getPrefix(prefix), this.nsContext
/* 113 */           .getNamespaceURI(prefix), localName));
/*     */   }
/*     */ 
/*     */   
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/bind/v2/runtime/output/XMLEventWriterOutput.class
