...
/*     */ {
/*  53 */   protected static final Logger log = Logger.getLogger("com.sun.xml.internal.messaging.saaj.util", "com.sun.xml.internal.messaging.saaj.util.LocalStrings");
/*     */ 
/*     */ 
/*     */   
...
/* 167 */             attrImpl.addAttribute(atts.getURI(i), atts.getLocalName(i), atts
/* 168 */                 .getQName(i), ID_NAME, atts.getValue(i));
/*     */           } else {
/* 170 */             attrImpl.addAttribute(atts.getURI(i), atts.getLocalName(i), atts.getQName(i), atts.getType(i), atts.getValue(i));
/*     */           } 
/*     */         } else {
/* 173 */           attrImpl.addAttribute(atts.getURI(i), atts.getLocalName(i), atts
/* 174 */               .getQName(i), atts.getType(i), atts.getValue(i));
/*     */         } 
/*     */       } 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/messaging/saaj/util/RejectDoctypeSaxFilter.class
