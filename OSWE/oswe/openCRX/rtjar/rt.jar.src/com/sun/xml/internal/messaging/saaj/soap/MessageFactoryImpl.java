...
/*     */ {
/*  52 */   protected static final Logger log = Logger.getLogger("com.sun.xml.internal.messaging.saaj.soap", "com.sun.xml.internal.messaging.saaj.soap.LocalStrings");
/*     */   
...
/*  80 */       teeInputStream = new TeeInputStream(in, this.listener);
/*     */     }
/*     */     
/*     */     try {
...
/*  88 */         return (SOAPMessage)new Message1_1Impl(headers, contentType, stat, (InputStream)teeInputStream); 
/*  89 */       if (MessageImpl.isSoap1_2Content(stat)) {
/*  90 */         return (SOAPMessage)new Message1_2Impl(headers, contentType, stat, (InputStream)teeInputStream);
/*     */       }
...
/*  97 */       throw new SOAPExceptionImpl("Unable to parse content type: " + e
/*  98 */           .getMessage());
/*     */     } 
/*     */   }
/*     */   
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/messaging/saaj/soap/MessageFactoryImpl.class
