...
/*  95 */     } catch (NoSuchMethodException mex) {
/*     */       
...
/* 160 */     if (!this.needContextPop[this.depth]) {
...
/* 185 */     if (!this.needContextPop[this.depth]) {
...
/* 462 */       if (this.needContextPop[this.depth]) {
...
/*     */     } 
/* 482 */     if (this.needContextPop[this.depth]) {
...
/* 566 */     } catch (InvocationTargetException ite) {
...
/*     */     } 
/* 624 */     if (this.needContextPop[this.depth]) {
...
/*     */     } 
/* 670 */     if (this.needContextPop[this.depth]) {
...
/* 711 */       if (this.needContextPop[this.depth]) {
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/stream/writers/XMLDOMWriterImpl.class
