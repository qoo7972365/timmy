...
/*  55 */   protected static final int IDENTIFYING_STRING_TABLE_MAXIMUM_ITEMS = getIntegerValueFromProperty("com.sun.xml.internal.fastinfoset.vocab.ParserVocabulary.IdentifyingStringTable.maximumItems");
/*     */   
/*  57 */   protected static final int NON_IDENTIFYING_STRING_TABLE_MAXIMUM_ITEMS = getIntegerValueFromProperty("com.sun.xml.internal.fastinfoset.vocab.ParserVocabulary.NonIdentifyingStringTable.maximumItems");
/*     */   
/*  59 */   protected static final int NON_IDENTIFYING_STRING_TABLE_MAXIMUM_CHARACTERS = getIntegerValueFromProperty("com.sun.xml.internal.fastinfoset.vocab.ParserVocabulary.NonIdentifyingStringTable.maximumCharacters");
/*     */   
...
/*     */     
/*     */     try {
/*  68 */       return Math.max(Integer.parseInt(value), 10);
...
/*     */     
/* 112 */     this.tables[0] = (ValueArray)this.restrictedAlphabet;
/* 113 */     this.tables[1] = (ValueArray)this.encodingAlgorithm;
/* 114 */     this.tables[2] = (ValueArray)this.prefix;
/* 115 */     this.tables[3] = (ValueArray)this.namespaceName;
/* 116 */     this.tables[4] = (ValueArray)this.localName;
/* 117 */     this.tables[5] = (ValueArray)this.otherNCName;
/* 118 */     this.tables[6] = (ValueArray)this.otherURI;
/* 119 */     this.tables[7] = (ValueArray)this.attributeValue;
/* 120 */     this.tables[8] = (ValueArray)this.otherString;
/* 121 */     this.tables[9] = (ValueArray)this.characterContentChunk;
/* 122 */     this.tables[10] = (ValueArray)this.elementName;
/* 123 */     this.tables[11] = (ValueArray)this.attributeName;
/*     */   }
/*     */ 
/*     */   
...
/* 160 */     FixedEntryStringIntMap fixedEntryStringIntMap1 = new FixedEntryStringIntMap("xml", 8);
/*     */     
/* 162 */     FixedEntryStringIntMap fixedEntryStringIntMap2 = new FixedEntryStringIntMap("http://www.w3.org/XML/1998/namespace", 8);
/*     */     
...
/* 168 */     addToTable(v.prefixes.iterator(), this.prefix, (StringIntMap)fixedEntryStringIntMap1);
/* 169 */     addToTable(v.namespaceNames.iterator(), this.namespaceName, (StringIntMap)fixedEntryStringIntMap2);
...
/* 176 */     addToTable(v.elements.iterator(), this.elementName, false, (StringIntMap)fixedEntryStringIntMap1, (StringIntMap)fixedEntryStringIntMap2, localNameMap);
/*     */     
/* 178 */     addToTable(v.attributes.iterator(), this.attributeName, true, (StringIntMap)fixedEntryStringIntMap1, (StringIntMap)fixedEntryStringIntMap2, localNameMap);
/*     */   }
/*     */ 
/*     */   
/*     */   private void addToTable(Iterator<String> i, StringArray a) {
/* 183 */     while (i.hasNext()) {
/* 184 */       addToTable(i.next(), a, (StringIntMap)null);
/*     */     }
/*     */   }
/*     */   
/*     */   private void addToTable(Iterator<String> i, StringArray a, StringIntMap m) {
/* 189 */     while (i.hasNext()) {
/* 190 */       addToTable(i.next(), a, m);
/*     */     }
/*     */   }
/*     */   
...
/* 252 */     while (i.hasNext()) {
/* 253 */       addToNameTable(i.next(), a, isAttribute, prefixMap, namespaceNameMap, localNameMap);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 287 */     QualifiedName name = new QualifiedName(n.getPrefix(), n.getNamespaceURI(), n.getLocalPart(), a.getSize(), prefixIndex, namespaceURIIndex, localNameIndex);
/*     */     
/* 289 */     if (isAttribute) {
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/com/sun/xml/internal/fastinfoset/vocab/ParserVocabulary.class
