...
/*      */     this(paramBeanContextServices, (Locale)null, false, true);
/*      */   }
/*      */   
...
/*      */       }
/*      */       
/*      */       void removeRequestor(Object param2Object) {
/*      */         this.requestors.remove(param2Object);
/*      */       }
/*      */       
...
/*      */     }
/*      */     
/*      */     BCSSChild(Object param1Object1, Object param1Object2) {
/*      */       super(param1Object1, param1Object2);
/*      */     }
/*      */     
/*      */     synchronized void usingService(Object param1Object1, Object param1Object2, Class<?> param1Class, BeanContextServiceProvider param1BeanContextServiceProvider, boolean param1Boolean, BeanContextServiceRevokedListener param1BeanContextServiceRevokedListener) throws TooManyListenersException, UnsupportedOperationException {
...
/*      */     }
/*      */     
/*      */     synchronized void releaseService(Object param1Object1, Object param1Object2) {
/*      */       if (this.serviceRequestors == null)
/*      */         return; 
...
/*      */     }
/*      */     
/*      */     synchronized void revokeService(Class param1Class, boolean param1Boolean1, boolean param1Boolean2) {
/*      */       if (this.serviceClasses == null)
/*      */         return; 
/*      */       BCSSCServiceClassRef bCSSCServiceClassRef = (BCSSCServiceClassRef)this.serviceClasses.get(param1Class);
/*      */       if (bCSSCServiceClassRef == null)
/*      */         return; 
/*      */       Iterator<Map.Entry> iterator = bCSSCServiceClassRef.cloneOfEntries();
...
/*      */       if (this.serviceRequestors == null)
/*      */         return; 
/*      */       Iterator<Map.Entry> iterator = this.serviceRequestors.entrySet().iterator();
/*      */       while (iterator.hasNext()) {
/*      */         Map.Entry entry = iterator.next();
/*      */         Object object = entry.getKey();
/*      */         Iterator<Map.Entry> iterator1 = ((Map)entry.getValue()).entrySet().iterator();
/*      */         iterator.remove();
/*      */         while (iterator1.hasNext()) {
/*      */           Map.Entry entry1 = iterator1.next();
...
/*      */       if (this.serviceClasses == null)
/*      */         return; 
/*      */       Iterator<?> iterator = (new HashSet(this.serviceClasses.values())).iterator();
/*      */       while (iterator.hasNext()) {
/*      */         BCSSCServiceClassRef bCSSCServiceClassRef = (BCSSCServiceClassRef)iterator.next();
/*      */         if (!bCSSCServiceClassRef.isDelegated())
/*      */           continue; 
/*      */         Iterator<Map.Entry> iterator1 = bCSSCServiceClassRef.cloneOfEntries();
...
/*      */     
/*      */     BCSSServiceProvider(Class param1Class, BeanContextServiceProvider param1BeanContextServiceProvider) {
/*      */       this.serviceProvider = param1BeanContextServiceProvider;
/*      */     }
/*      */     
...
/*      */         Iterator<Object> iterator = this.children.keySet().iterator();
/*      */         while (iterator.hasNext()) {
/*      */           BeanContextServicesListener beanContextServicesListener = (BeanContextServicesListener)iterator.next();
/*      */           if (beanContextServicesListener instanceof BeanContextServices)
/*      */             ((BeanContextServicesListener)beanContextServicesListener).serviceAvailable(beanContextServiceAvailableEvent); 
/*      */         } 
/*      */       } 
/*      */       return true;
/*      */     } 
...
/*      */       if (paramBeanContextServiceProvider instanceof Serializable)
/*      */         this.serializable--; 
/*      */       Iterator<BCSSChild> iterator = bcsChildren();
/*      */       while (iterator.hasNext())
...
/*      */     
/*      */     BCSSProxyServiceProvider(BeanContextServices param1BeanContextServices) {
/*      */       this.nestingCtxt = param1BeanContextServices;
/*      */     }
/*      */     
...
/*      */     }
/*      */     
/*      */     public void releaseService(BeanContextServices param1BeanContextServices, Object param1Object1, Object param1Object2) {
/*      */       this.nestingCtxt.releaseService(param1BeanContextServices, param1Object1, param1Object2);
/*      */     }
/*      */     
/*      */     public Iterator getCurrentServiceSelectors(BeanContextServices param1BeanContextServices, Class param1Class) {
/*      */       return this.nestingCtxt.getCurrentServiceSelectors(param1Class);
/*      */     }
/*      */     
/*      */     public void serviceRevoked(BeanContextServiceRevokedEvent param1BeanContextServiceRevokedEvent) {
/*      */       Iterator<BeanContextServicesSupport.BCSSChild> iterator = BeanContextServicesSupport.this.bcsChildren();
/*      */       while (iterator.hasNext())
...
/*      */         BeanContextServicesListener beanContextServicesListener = (BeanContextServicesListener)iterator.next();
/*      */         if (beanContextServicesListener instanceof BeanContextServices)
/*      */           ((BeanContextServicesListener)beanContextServicesListener).serviceAvailable(paramBeanContextServiceAvailableEvent); 
/*      */       } 
/*      */     } 
/*      */   }
/*      */   
...
/*      */         BeanContextServicesListener beanContextServicesListener = (BeanContextServicesListener)iterator.next();
/*      */         if (beanContextServicesListener instanceof BeanContextServices)
/*      */           ((BeanContextServicesListener)beanContextServicesListener).serviceRevoked(paramBeanContextServiceRevokedEvent); 
/*      */       } 
/*      */     } 
/*      */   }
/*      */   
...
/*      */   }
/*      */   
/*      */   protected synchronized void bcsPreSerializationHook(ObjectOutputStream paramObjectOutputStream) throws IOException {
/*      */     paramObjectOutputStream.writeInt(this.serializable);
/*      */     if (this.serializable <= 0)
/*      */       return; 
/*      */     byte b = 0;
/*      */     Iterator<Map.Entry> iterator = this.services.entrySet().iterator();
...
/*      */   }
/*      */   
/*      */   protected synchronized void bcsPreDeserializationHook(ObjectInputStream paramObjectInputStream) throws IOException, ClassNotFoundException {
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/java/beans/beancontext/BeanContextServicesSupport.class
