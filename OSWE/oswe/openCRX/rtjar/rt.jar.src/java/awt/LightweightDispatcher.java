...
/*      */   
/*      */   static {
/* 4418 */     int[] arrayOfInt = AWTAccessor.getInputEventAccessor().getButtonDownMasks();
/* 4419 */     int i = 0;
/* 4420 */     for (int j : arrayOfInt) {
/* 4421 */       i |= j;
/*      */     }
/* 4423 */     BUTTONS_DOWN_MASK = i;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 4950 */     this.isMouseInNativeContainer = false;
/*      */ 
/*      */ 
/*      */ 
/*      */     
/* 4955 */     this.isMouseDTInNativeContainer = false;
...
/*      */     Component component2 = this.mouseEventTarget.get();
...
/*      */     } 
/*      */     Component component = retargetMouseEnterExit(paramComponent, paramMouseEvent, this.targetLastEnteredDT.get(), this.isMouseDTInNativeContainer);
...
/*      */       stopListeningForOtherDrags();
/*      */     } 
/*      */     Component component = retargetMouseEnterExit(paramComponent, paramMouseEvent, this.targetLastEntered.get(), this.isMouseInNativeContainer);
...
/*      */     boolean bool = (paramAWTEvent instanceof MouseEvent && !(paramAWTEvent instanceof SunDropTargetEvent) && paramAWTEvent.id == 506 && paramAWTEvent.getSource() != this.nativeContainer) ? true : false;
/*      */     if (!bool)
/*      */       return; 
...
/*      */               mouseEvent.translatePoint(ptSrcOrigin.x - point.x, ptSrcOrigin.y - point.y);
...
/*      */       return; 
/*      */     int i = paramMouseEvent.getX(), j = paramMouseEvent.getY();
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/java/awt/LightweightDispatcher.class
