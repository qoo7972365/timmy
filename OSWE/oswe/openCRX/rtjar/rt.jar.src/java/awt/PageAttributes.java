...
/*   70 */     private static final String[] NAMES = new String[] { "color", "monochrome" };
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/*      */     private ColorType(int param1Int) {
/*   84 */       super(param1Int, NAMES);
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/*      */     
/*      */     private MediaType(int param1Int) {
/*  802 */       super(param1Int, NAMES);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */     
/*  815 */     private static final String[] NAMES = new String[] { "portrait", "landscape" };
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/*      */     private OrientationRequestedType(int param1Int) {
/*  833 */       super(param1Int, NAMES);
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/*      */     
/*  845 */     private static final String[] NAMES = new String[] { "physical", "printable" };
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/*      */     private OriginType(int param1Int) {
/*  859 */       super(param1Int, NAMES);
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/*      */     
/*  873 */     private static final String[] NAMES = new String[] { "high", "normal", "draft" };
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/*      */     private PrintQualityType(int param1Int) {
/*  897 */       super(param1Int, NAMES);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*  970 */     } catch (CloneNotSupportedException cloneNotSupportedException) {
/*      */       
/*  972 */       throw new InternalError(cloneNotSupportedException);
/*      */     } 
/*      */   }
/*      */ 
/*      */ 
...
/* 1058 */     if (str != null && (str
/* 1059 */       .equals(Locale.US.getCountry()) || str
/* 1060 */       .equals(Locale.CANADA.getCountry()))) {
/* 1061 */       setMedia(MediaType.NA_LETTER);
/*      */     } else {
/* 1063 */       setMedia(MediaType.ISO_A4);
/*      */     } 
/*      */   }
/*      */ 
/*      */ 
...
/*      */     } 
/*      */     
/* 1117 */     setOrientationRequested((OrientationRequestedType)null);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     } 
/*      */     
/* 1215 */     setPrintQuality((PrintQualityType)null);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */   
/*      */   public int hashCode() {
/* 1355 */     return this.color.hashCode() << 31 ^ this.media
/* 1356 */       .hashCode() << 24 ^ this.orientationRequested
/* 1357 */       .hashCode() << 23 ^ this.origin
/* 1358 */       .hashCode() << 22 ^ this.printQuality
/* 1359 */       .hashCode() << 20 ^ this.printerResolution[2] >> 2 << 19 ^ this.printerResolution[1] << 10 ^ this.printerResolution[0];
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1372 */     return "color=" + getColor() + ",media=" + getMedia() + ",orientation-requested=" + 
/* 1373 */       getOrientationRequested() + ",origin=" + 
/* 1374 */       getOrigin() + ",print-quality=" + getPrintQuality() + ",printer-resolution=[" + this.printerResolution[0] + "," + this.printerResolution[1] + "," + this.printerResolution[2] + "]";
/*      */   }
/*      */ }


/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/java/awt/PageAttributes.class
