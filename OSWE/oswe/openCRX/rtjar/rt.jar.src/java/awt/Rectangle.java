...
/*      */     int i, j, k, m;
/*  380 */     if (paramDouble1 > 4.294967294E9D) {
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */     } 
/*      */     
/*  396 */     if (paramDouble2 > 4.294967294E9D) {
/*      */       
/*  398 */       j = Integer.MAX_VALUE;
/*  399 */       m = -1;
/*      */     } else {
...
/*  411 */     if (paramDouble <= -2.147483648E9D) {
/*  412 */       return Integer.MIN_VALUE;
/*      */     }
/*  414 */     if (paramDouble >= 2.147483647E9D) {
...
/*      */ 
/*      */           
/*  530 */           this.width += j - Integer.MIN_VALUE;
/*      */         }
/*      */ 
/*      */ 
/*      */ 
/*      */         
/*  536 */         j = Integer.MIN_VALUE;
/*      */       }
/*      */     
/*      */     }
/*  540 */     else if (j < i) {
...
/*      */ 
/*      */         
/*  545 */         this.width += j - Integer.MAX_VALUE;
/*      */ 
/*      */         
/*  548 */         if (this.width < 0) this.width = Integer.MAX_VALUE; 
/*      */       } 
/*  550 */       j = Integer.MAX_VALUE;
/*      */     } 
/*      */     
/*  553 */     this.x = j;
/*      */     
...
/*  562 */           this.height += j - Integer.MIN_VALUE;
/*      */         }
/*      */         
/*  565 */         j = Integer.MIN_VALUE;
/*      */       }
/*      */     
/*      */     }
/*  569 */     else if (j < i) {
...
/*  572 */         this.height += j - Integer.MAX_VALUE;
/*  573 */         if (this.height < 0) this.height = Integer.MAX_VALUE; 
/*      */       } 
/*  575 */       j = Integer.MAX_VALUE;
/*      */     } 
/*      */     
/*  578 */     this.y = j;
/*      */   }
...
/*      */     }
/* 1166 */     Rectangle2D.Double double_ = new Rectangle2D.Double();
/* 1167 */     Rectangle2D.intersect(this, paramRectangle2D, double_);
/* 1168 */     return double_;
/*      */   }
/*      */ 
/*      */ 
...
/*      */     }
/* 1179 */     Rectangle2D.Double double_ = new Rectangle2D.Double();
/* 1180 */     Rectangle2D.union(this, paramRectangle2D, double_);
/* 1181 */     return double_;
/*      */   }
/*      */ 
/*      */ 
...
/* 1198 */       Rectangle rectangle = (Rectangle)paramObject;
/* 1199 */       return (this.x == rectangle.x && this.y == rectangle.y && this.width == rectangle.width && this.height == rectangle.height);
/*      */     } 
/*      */ 
/*      */ 
/*      */     
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/java/awt/Rectangle.class
