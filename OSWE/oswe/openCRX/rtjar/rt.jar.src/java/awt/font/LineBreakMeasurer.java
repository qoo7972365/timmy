...
/*     */ 
/*     */       
/* 359 */       int j = this.measurer.getLineBreakIndex(this.pos, paramFloat);
/*     */       
/* 361 */       if (j == this.limit) {
/* 362 */         i = this.limit;
/*     */       }
...
/*     */       }
/*     */       
/* 445 */       TextLayout textLayout = this.measurer.getLayout(this.pos, i);
/* 446 */       this.pos = i;
/*     */       
/* 448 */       return textLayout;
/*     */     } 
/* 450 */     return null;
/*     */   }
/*     */ 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/java/awt/font/LineBreakMeasurer.class
