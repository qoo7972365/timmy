...
/*  145 */     EventListener eventListener1 = removeInternal(this.a, paramEventListener);
/*  146 */     EventListener eventListener2 = removeInternal(this.b, paramEventListener);
/*  147 */     if (eventListener1 == this.a && eventListener2 == this.b) {
/*  148 */       return this;
/*      */     }
/*  150 */     return addInternal(eventListener1, eventListener2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  159 */     ((ComponentListener)this.a).componentResized(paramComponentEvent);
/*  160 */     ((ComponentListener)this.b).componentResized(paramComponentEvent);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  169 */     ((ComponentListener)this.a).componentMoved(paramComponentEvent);
/*  170 */     ((ComponentListener)this.b).componentMoved(paramComponentEvent);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  179 */     ((ComponentListener)this.a).componentShown(paramComponentEvent);
/*  180 */     ((ComponentListener)this.b).componentShown(paramComponentEvent);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  189 */     ((ComponentListener)this.a).componentHidden(paramComponentEvent);
/*  190 */     ((ComponentListener)this.b).componentHidden(paramComponentEvent);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  542 */     return (ComponentListener)addInternal(paramComponentListener1, paramComponentListener2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  713 */     return (ComponentListener)removeInternal(paramComponentListener1, paramComponentListener2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     }
/*  923 */     else if (this.a instanceof java.io.Serializable) {
...
/*      */     }
/*  931 */     else if (this.b instanceof java.io.Serializable) {
...
/*      */     }
/*  944 */     else if (paramEventListener instanceof java.io.Serializable) {
...
/*  958 */       AWTEventMulticaster aWTEventMulticaster = (AWTEventMulticaster)paramEventListener;
/*  959 */       return getListenerCount(aWTEventMulticaster.a, paramClass) + 
/*  960 */         getListenerCount(aWTEventMulticaster.b, paramClass);
/*      */     } 
/*      */ 
/*      */     
...
/*  977 */       AWTEventMulticaster aWTEventMulticaster = (AWTEventMulticaster)paramEventListener;
/*  978 */       int i = populateListenerArray(paramArrayOfEventListener, aWTEventMulticaster.a, paramInt);
/*  979 */       return populateListenerArray(paramArrayOfEventListener, aWTEventMulticaster.b, i);
/*      */     } 
...
/* 1025 */       throw new NullPointerException("Listener type should not be null");
/*      */     }
/*      */     
/* 1028 */     int i = getListenerCount(paramEventListener, paramClass);
/* 1029 */     EventListener[] arrayOfEventListener = (EventListener[])Array.newInstance(paramClass, i);
/* 1030 */     populateListenerArray(arrayOfEventListener, paramEventListener, 0);
/* 1031 */     return (T[])arrayOfEventListener;
/*      */   }
/*      */ }


/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/java/awt/AWTEventMulticaster.class
