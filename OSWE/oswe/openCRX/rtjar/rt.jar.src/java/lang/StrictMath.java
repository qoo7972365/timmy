...
/*  182 */     return paramDouble / 180.0D * Math.PI;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  199 */     return paramDouble * 180.0D / Math.PI;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  340 */     return floorOrCeil(paramDouble, -0.0D, 1.0D, 1.0D);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  359 */     return floorOrCeil(paramDouble, -1.0D, 0.0D, -1.0D);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  374 */     int i = Math.getExponent(paramDouble1);
/*      */     
/*  376 */     if (i < 0)
/*      */     {
/*      */ 
...
/*      */ 
/*      */       
/*  382 */       return (paramDouble1 == 0.0D) ? paramDouble1 : ((paramDouble1 < 0.0D) ? paramDouble2 : paramDouble3);
/*      */     }
/*  384 */     if (i >= 52)
/*      */     {
/*      */ 
/*      */       
/*  388 */       return paramDouble1;
/*      */     }
/*      */ 
/*      */     
/*  392 */     assert i >= 0 && i <= 51;
/*      */     
/*  394 */     long l1 = Double.doubleToRawLongBits(paramDouble1);
/*  395 */     long l2 = 4503599627370495L >> i;
/*      */     
/*  397 */     if ((l2 & l1) == 0L) {
/*  398 */       return paramDouble1;
/*      */     }
/*  400 */     double d = Double.longBitsToDouble(l1 & (l2 ^ 0xFFFFFFFFFFFFFFFFL));
/*  401 */     if (paramDouble4 * paramDouble1 > 0.0D)
/*  402 */       d += paramDouble4; 
/*  403 */     return d;
/*      */   }
/*      */ 
...
/*  449 */     double d1 = 4.503599627370496E15D;
/*  450 */     double d2 = Math.copySign(1.0D, paramDouble);
/*  451 */     paramDouble = Math.abs(paramDouble);
/*      */     
/*  453 */     if (paramDouble < d1) {
/*  454 */       paramDouble = d1 + paramDouble - d1;
/*      */     }
/*      */     
/*  457 */     return d2 * paramDouble;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  654 */     return Math.round(paramFloat);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  678 */     return Math.round(paramDouble);
/*      */   }
/*      */   
...
/*  724 */     return Math.addExact(paramInt1, paramInt2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  739 */     return Math.addExact(paramLong1, paramLong2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  754 */     return Math.subtractExact(paramInt1, paramInt2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  769 */     return Math.subtractExact(paramLong1, paramLong2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  784 */     return Math.multiplyExact(paramInt1, paramInt2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  799 */     return Math.multiplyExact(paramLong1, paramLong2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  813 */     return Math.toIntExact(paramLong);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  837 */     return Math.floorDiv(paramInt1, paramInt2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  861 */     return Math.floorDiv(paramLong1, paramLong2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  888 */     return Math.floorMod(paramInt1, paramInt2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  914 */     return Math.floorMod(paramLong1, paramLong2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  967 */     return Math.abs(paramFloat);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  986 */     return Math.abs(paramDouble);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1000 */     return Math.max(paramInt1, paramInt2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1014 */     return Math.max(paramLong1, paramLong2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1032 */     return Math.max(paramFloat1, paramFloat2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1050 */     return Math.max(paramDouble1, paramDouble2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1064 */     return Math.min(paramInt1, paramInt2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1078 */     return Math.min(paramLong1, paramLong2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1096 */     return Math.min(paramFloat1, paramFloat2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1114 */     return Math.min(paramDouble1, paramDouble2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1141 */     return Math.ulp(paramDouble);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1168 */     return Math.ulp(paramFloat);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1189 */     return Math.signum(paramDouble);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1210 */     return Math.signum(paramFloat);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1388 */     return Math.copySign(paramDouble1, Double.isNaN(paramDouble2) ? 1.0D : paramDouble2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1404 */     return Math.copySign(paramFloat1, Float.isNaN(paramFloat2) ? 1.0F : paramFloat2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1421 */     return Math.getExponent(paramFloat);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1439 */     return Math.getExponent(paramDouble);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1482 */     return Math.nextAfter(paramDouble1, paramDouble2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1524 */     return Math.nextAfter(paramFloat, paramDouble);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1553 */     return Math.nextUp(paramDouble);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1582 */     return Math.nextUp(paramFloat);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1611 */     return Math.nextDown(paramDouble);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1640 */     return Math.nextDown(paramFloat);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1674 */     return Math.scalb(paramDouble, paramInt);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1708 */     return Math.scalb(paramFloat, paramInt);
/*      */   }
/*      */ }


/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/java/lang/StrictMath.class
