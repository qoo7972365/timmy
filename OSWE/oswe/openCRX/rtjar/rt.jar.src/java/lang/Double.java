...
/*  139 */   public static final Class<Double> TYPE = (Class)Class.getPrimitiveClass("double");
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */     }
/*      */     
/*  292 */     StringBuilder stringBuilder = new StringBuilder(24);
/*      */     
/*  294 */     if (Math.copySign(1.0D, paramDouble) == -1.0D) {
/*  295 */       stringBuilder.append("-");
/*      */     }
/*  297 */     stringBuilder.append("0x");
/*      */     
/*  299 */     paramDouble = Math.abs(paramDouble);
/*      */     
/*  301 */     if (paramDouble == 0.0D) {
/*  302 */       stringBuilder.append("0.0p0");
/*      */     } else {
/*  304 */       boolean bool = (paramDouble < 2.2250738585072014E-308D) ? true : false;
/*      */ 
/*      */ 
/*      */ 
/*      */       
/*  309 */       long l = doubleToLongBits(paramDouble) & 0xFFFFFFFFFFFFFL | 0x1000000000000000L;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*      */       
/*  315 */       stringBuilder.append(bool ? "0." : "1.");
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  322 */       stringBuilder.append(str.equals("0000000000000") ? "0" : str
/*      */           
/*  324 */           .replaceFirst("0{1,12}$", ""));
/*      */       
/*  326 */       stringBuilder.append('p');
/*      */ 
/*      */ 
/*      */ 
/*      */       
/*  331 */       stringBuilder.append(bool ? -1022 : 
/*      */           
...
/*      */ 
/*      */   
/*      */   public static Double valueOf(String paramString) throws NumberFormatException {
...
/*      */ 
/*      */   
/*      */   public Double(String paramString) throws NumberFormatException {
...
/*  798 */     return (paramObject instanceof Double && 
/*  799 */       doubleToLongBits(((Double)paramObject).value) == 
/*  800 */       doubleToLongBits(this.value));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/*  839 */     if ((l & 0x7FF0000000000000L) == 9218868437227405312L && (l & 0xFFFFFFFFFFFFFL) != 0L)
/*      */     {
/*      */       
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/java/lang/Double.class
