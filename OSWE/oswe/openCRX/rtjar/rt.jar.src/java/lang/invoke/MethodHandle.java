...
/*      */   
/*      */   static {
/*  422 */     MethodHandleImpl.initStatics();
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/*      */     try {
/* 1451 */       FORM_OFFSET = MethodHandleStatics.UNSAFE.objectFieldOffset(MethodHandle.class.getDeclaredField("form"));
/* 1452 */     } catch (ReflectiveOperationException reflectiveOperationException) {
/* 1453 */       throw MethodHandleStatics.newInternalError(reflectiveOperationException);
/*      */     } 
/*      */   }
/*      */   
...
/*      */   }
/*      */   
/*      */   public Object invokeWithArguments(List<?> paramList) throws Throwable {
...
/*      */     if (methodHandle != null && paramMethodType == methodHandle.type)
/*      */       return methodHandle; 
/*      */     return null;
/*      */   }
/*      */   
...
/*      */     if (paramBoolean) {
/*      */       assert type().isViewableAs(paramMethodType, true) : Arrays.asList((T[])new Object[] { this, paramMethodType });
/*      */     } else {
/*      */       assert type().basicType().isViewableAs(paramMethodType.basicType(), true) : Arrays.asList((T[])new Object[] { this, paramMethodType });
/*      */     } 
/*      */     return true;
/*      */   }
/*      */   
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/java/lang/invoke/MethodHandle.class
