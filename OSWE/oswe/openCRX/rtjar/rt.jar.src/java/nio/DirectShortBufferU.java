...
/* 211 */     int k = i << 1;
/* 212 */     assert k >= 0;
/* 213 */     return new DirectShortBufferU(this, -1, 0, bool, bool, k);
/*     */   }
/*     */   
/*     */   public ShortBuffer duplicate() {
/* 217 */     return new DirectShortBufferU(this, 
/* 218 */         markValue(), 
/* 219 */         position(), 
/* 220 */         limit(), 
/* 221 */         capacity(), 0);
...
/* 227 */     return new DirectShortBufferRU(this, 
/* 228 */         markValue(), 
/* 229 */         position(), 
/* 230 */         limit(), 
/* 231 */         capacity(), 0);
...
/* 318 */       DirectShortBufferU directShortBufferU = (DirectShortBufferU)paramShortBuffer;
/*     */       
/* 320 */       int i = directShortBufferU.position();
/* 321 */       int j = directShortBufferU.limit();
/* 322 */       assert i <= j;
...
/* 332 */       unsafe.copyMemory(directShortBufferU.ix(i), ix(k), b1 << 1L);
/* 333 */       directShortBufferU.position(i + b1);
/* 334 */       position(k + b1);
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/java/nio/DirectShortBufferU.class
