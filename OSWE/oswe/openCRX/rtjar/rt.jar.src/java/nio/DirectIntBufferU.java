...
/* 211 */     int k = i << 2;
/* 212 */     assert k >= 0;
/* 213 */     return new DirectIntBufferU(this, -1, 0, bool, bool, k);
/*     */   }
/*     */   
/*     */   public IntBuffer duplicate() {
/* 217 */     return new DirectIntBufferU(this, 
/* 218 */         markValue(), 
/* 219 */         position(), 
/* 220 */         limit(), 
/* 221 */         capacity(), 0);
...
/* 227 */     return new DirectIntBufferRU(this, 
/* 228 */         markValue(), 
/* 229 */         position(), 
/* 230 */         limit(), 
/* 231 */         capacity(), 0);
...
/* 297 */     unsafe.putInt(ix(nextPutIndex()), paramInt);
/* 298 */     return this;
/*     */   }
/*     */ 
/*     */ 
...
/* 306 */     unsafe.putInt(ix(checkIndex(paramInt1)), paramInt2);
/* 307 */     return this;
/*     */   }
/*     */ 
/*     */ 
...
/* 315 */     if (paramIntBuffer instanceof DirectIntBufferU) {
/* 316 */       if (paramIntBuffer == this)
/* 317 */         throw new IllegalArgumentException(); 
/* 318 */       DirectIntBufferU directIntBufferU = (DirectIntBufferU)paramIntBuffer;
/*     */       
/* 320 */       int i = directIntBufferU.position();
/* 321 */       int j = directIntBufferU.limit();
/* 322 */       assert i <= j;
...
/* 332 */       unsafe.copyMemory(directIntBufferU.ix(i), ix(k), b1 << 2L);
/* 333 */       directIntBufferU.position(i + b1);
/* 334 */       position(k + b1);
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/java/nio/DirectIntBufferU.class
