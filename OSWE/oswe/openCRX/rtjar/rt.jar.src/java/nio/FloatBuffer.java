...
/*  289 */     this(paramInt1, paramInt2, paramInt3, paramInt4, (float[])null, 0);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  335 */     return new HeapFloatBuffer(paramInt, paramInt);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/*  373 */       return new HeapFloatBuffer(paramArrayOffloat, paramInt1, paramInt2);
...
/*  396 */     return wrap(paramArrayOffloat, 0, paramArrayOffloat.length);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  686 */     checkBounds(paramInt1, paramInt2, paramArrayOffloat.length);
...
/*  715 */     return get(paramArrayOffloat, 0, paramArrayOffloat.length);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  827 */     checkBounds(paramInt1, paramInt2, paramArrayOffloat.length);
...
/*  859 */     return put(paramArrayOffloat, 0, paramArrayOffloat.length);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1161 */       return true; 
/* 1162 */     if (!(paramObject instanceof FloatBuffer))
/* 1163 */       return false; 
/* 1164 */     FloatBuffer floatBuffer = (FloatBuffer)paramObject;
/* 1165 */     if (remaining() != floatBuffer.remaining())
/* 1166 */       return false; 
/* 1167 */     int i = position();
/* 1168 */     for (int j = limit() - 1, k = floatBuffer.limit() - 1; j >= i; j--, k--) {
/* 1169 */       if (!equals(get(j), floatBuffer.get(k)))
/* 1170 */         return false; 
/* 1171 */     }  return true;
/*      */   }
/*      */ 
...
/* 1176 */     return (paramFloat1 == paramFloat2 || (Float.isNaN(paramFloat1) && Float.isNaN(paramFloat2)));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1206 */     int i = position() + Math.min(remaining(), paramFloatBuffer.remaining());
/* 1207 */     for (int j = position(), k = paramFloatBuffer.position(); j < i; j++, k++) {
/* 1208 */       int m = compare(get(j), paramFloatBuffer.get(k));
/* 1209 */       if (m != 0)
/* 1210 */         return m; 
/*      */     } 
/* 1212 */     return remaining() - paramFloatBuffer.remaining();
/*      */   }
/*      */ 
/*      */   
/*      */   private static int compare(float paramFloat1, float paramFloat2) {
/* 1217 */     return (paramFloat1 < paramFloat2) ? -1 : ((paramFloat1 > paramFloat2) ? 1 : ((paramFloat1 == paramFloat2) ? 0 : (
/*      */ 
/*      */       
/* 1220 */       Float.isNaN(paramFloat1) ? (Float.isNaN(paramFloat2) ? 0 : 1) : -1)));
/*      */   }
/*      */   
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/java/nio/FloatBuffer.class
