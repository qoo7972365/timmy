...
/* 211 */     int k = i << 3;
/* 212 */     assert k >= 0;
/* 213 */     return new DirectLongBufferS(this, -1, 0, bool, bool, k);
/*     */   }
/*     */   
/*     */   public LongBuffer duplicate() {
/* 217 */     return new DirectLongBufferS(this, 
/* 218 */         markValue(), 
/* 219 */         position(), 
/* 220 */         limit(), 
/* 221 */         capacity(), 0);
...
/* 227 */     return new DirectLongBufferRS(this, 
/* 228 */         markValue(), 
/* 229 */         position(), 
/* 230 */         limit(), 
/* 231 */         capacity(), 0);
...
/* 297 */     unsafe.putLong(ix(nextPutIndex()), Bits.swap(paramLong));
/* 298 */     return this;
/*     */   }
/*     */ 
/*     */ 
...
/* 306 */     unsafe.putLong(ix(checkIndex(paramInt)), Bits.swap(paramLong));
/* 307 */     return this;
/*     */   }
/*     */ 
/*     */ 
...
/* 315 */     if (paramLongBuffer instanceof DirectLongBufferS) {
/* 316 */       if (paramLongBuffer == this)
/* 317 */         throw new IllegalArgumentException(); 
/* 318 */       DirectLongBufferS directLongBufferS = (DirectLongBufferS)paramLongBuffer;
/*     */       
/* 320 */       int i = directLongBufferS.position();
/* 321 */       int j = directLongBufferS.limit();
/* 322 */       assert i <= j;
...
/* 332 */       unsafe.copyMemory(directLongBufferS.ix(i), ix(k), b1 << 3L);
/* 333 */       directLongBufferS.position(i + b1);
/* 334 */       position(k + b1);
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/java/nio/DirectLongBufferS.class
