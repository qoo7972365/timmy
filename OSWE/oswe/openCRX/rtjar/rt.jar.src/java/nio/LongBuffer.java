...
/*  289 */     this(paramInt1, paramInt2, paramInt3, paramInt4, (long[])null, 0);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  335 */     return new HeapLongBuffer(paramInt, paramInt);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/*  373 */       return new HeapLongBuffer(paramArrayOflong, paramInt1, paramInt2);
...
/*  396 */     return wrap(paramArrayOflong, 0, paramArrayOflong.length);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  686 */     checkBounds(paramInt1, paramInt2, paramArrayOflong.length);
...
/*  715 */     return get(paramArrayOflong, 0, paramArrayOflong.length);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  827 */     checkBounds(paramInt1, paramInt2, paramArrayOflong.length);
...
/*  859 */     return put(paramArrayOflong, 0, paramArrayOflong.length);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1161 */       return true; 
/* 1162 */     if (!(paramObject instanceof LongBuffer))
/* 1163 */       return false; 
/* 1164 */     LongBuffer longBuffer = (LongBuffer)paramObject;
/* 1165 */     if (remaining() != longBuffer.remaining())
/* 1166 */       return false; 
/* 1167 */     int i = position();
/* 1168 */     for (int j = limit() - 1, k = longBuffer.limit() - 1; j >= i; j--, k--) {
/* 1169 */       if (!equals(get(j), longBuffer.get(k)))
/* 1170 */         return false; 
/* 1171 */     }  return true;
/*      */   }
/*      */ 
...
/* 1178 */     return (paramLong1 == paramLong2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1206 */     int i = position() + Math.min(remaining(), paramLongBuffer.remaining());
/* 1207 */     for (int j = position(), k = paramLongBuffer.position(); j < i; j++, k++) {
/* 1208 */       int m = compare(get(j), paramLongBuffer.get(k));
/* 1209 */       if (m != 0)
/* 1210 */         return m; 
/*      */     } 
/* 1212 */     return remaining() - paramLongBuffer.remaining();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1222 */     return Long.compare(paramLong1, paramLong2);
/*      */   }
/*      */   
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/java/nio/LongBuffer.class
