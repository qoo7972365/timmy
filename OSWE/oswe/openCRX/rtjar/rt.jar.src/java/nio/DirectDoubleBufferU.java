...
/* 211 */     int k = i << 3;
/* 212 */     assert k >= 0;
/* 213 */     return new DirectDoubleBufferU(this, -1, 0, bool, bool, k);
/*     */   }
/*     */   
/*     */   public DoubleBuffer duplicate() {
/* 217 */     return new DirectDoubleBufferU(this, 
/* 218 */         markValue(), 
/* 219 */         position(), 
/* 220 */         limit(), 
/* 221 */         capacity(), 0);
...
/* 227 */     return new DirectDoubleBufferRU(this, 
/* 228 */         markValue(), 
/* 229 */         position(), 
/* 230 */         limit(), 
/* 231 */         capacity(), 0);
...
/* 318 */       DirectDoubleBufferU directDoubleBufferU = (DirectDoubleBufferU)paramDoubleBuffer;
/*     */       
/* 320 */       int i = directDoubleBufferU.position();
/* 321 */       int j = directDoubleBufferU.limit();
/* 322 */       assert i <= j;
...
/* 332 */       unsafe.copyMemory(directDoubleBufferU.ix(i), ix(k), b1 << 3L);
/* 333 */       directDoubleBufferU.position(i + b1);
/* 334 */       position(k + b1);
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/java/nio/DirectDoubleBufferU.class
