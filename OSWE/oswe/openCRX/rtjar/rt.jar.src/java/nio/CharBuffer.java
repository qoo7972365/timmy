...
/*  289 */     this(paramInt1, paramInt2, paramInt3, paramInt4, (char[])null, 0);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  335 */     return new HeapCharBuffer(paramInt, paramInt);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/*  373 */       return new HeapCharBuffer(paramArrayOfchar, paramInt1, paramInt2);
...
/*  396 */     return wrap(paramArrayOfchar, 0, paramArrayOfchar.length);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  417 */     int i = paramCharBuffer.remaining();
/*  418 */     int j = remaining();
/*  419 */     if (j == 0)
/*  420 */       return -1; 
/*  421 */     int k = Math.min(j, i);
/*  422 */     int m = limit();
/*      */     
/*  424 */     if (i < j)
/*  425 */       limit(position() + k); 
/*      */     try {
/*  427 */       if (k > 0)
/*  428 */         paramCharBuffer.put(this); 
/*      */     } finally {
/*  430 */       limit(m);
/*      */     } 
/*  432 */     return k;
...
/*      */     try {
/*  466 */       return new StringCharBuffer(paramCharSequence, paramInt1, paramInt2);
...
/*  487 */     return wrap(paramCharSequence, 0, paramCharSequence.length());
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  686 */     checkBounds(paramInt1, paramInt2, paramArrayOfchar.length);
...
/*  715 */     return get(paramArrayOfchar, 0, paramArrayOfchar.length);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  827 */     checkBounds(paramInt1, paramInt2, paramArrayOfchar.length);
...
/*  859 */     return put(paramArrayOfchar, 0, paramArrayOfchar.length);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  918 */     checkBounds(paramInt1, paramInt2 - paramInt1, paramString.length());
/*  919 */     if (isReadOnly())
/*  920 */       throw new ReadOnlyBufferException(); 
/*  921 */     if (paramInt2 - paramInt1 > remaining())
/*  922 */       throw new BufferOverflowException(); 
/*  923 */     for (int i = paramInt1; i < paramInt2; i++)
/*  924 */       put(paramString.charAt(i)); 
/*  925 */     return this;
/*      */   }
/*      */ 
/*      */ 
...
/*  950 */     return put(paramString, 0, paramString.length());
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1161 */       return true; 
/* 1162 */     if (!(paramObject instanceof CharBuffer))
/* 1163 */       return false; 
/* 1164 */     CharBuffer charBuffer = (CharBuffer)paramObject;
/* 1165 */     if (remaining() != charBuffer.remaining())
/* 1166 */       return false; 
/* 1167 */     int i = position();
/* 1168 */     for (int j = limit() - 1, k = charBuffer.limit() - 1; j >= i; j--, k--) {
/* 1169 */       if (!equals(get(j), charBuffer.get(k)))
/* 1170 */         return false; 
/* 1171 */     }  return true;
/*      */   }
/*      */ 
...
/* 1178 */     return (paramChar1 == paramChar2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1206 */     int i = position() + Math.min(remaining(), paramCharBuffer.remaining());
/* 1207 */     for (int j = position(), k = paramCharBuffer.position(); j < i; j++, k++) {
/* 1208 */       int m = compare(get(j), paramCharBuffer.get(k));
/* 1209 */       if (m != 0)
/* 1210 */         return m; 
/*      */     } 
/* 1212 */     return remaining() - paramCharBuffer.remaining();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1222 */     return Character.compare(paramChar1, paramChar2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1278 */     return get(position() + checkIndex(paramInt, 1));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1348 */     if (paramCharSequence == null) {
/* 1349 */       return put("null");
/*      */     }
/* 1351 */     return put(paramCharSequence.toString());
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1387 */     CharSequence charSequence = (paramCharSequence == null) ? "null" : paramCharSequence;
/* 1388 */     return put(charSequence.subSequence(paramInt1, paramInt2).toString());
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1497 */     return StreamSupport.intStream(() -> new CharBufferSpliterator(this), 16464, false);
/*      */   }
/*      */   
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/java/nio/CharBuffer.class
