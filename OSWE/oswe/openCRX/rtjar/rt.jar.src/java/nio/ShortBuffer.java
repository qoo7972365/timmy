...
/*  289 */     this(paramInt1, paramInt2, paramInt3, paramInt4, (short[])null, 0);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  335 */     return new HeapShortBuffer(paramInt, paramInt);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/*  373 */       return new HeapShortBuffer(paramArrayOfshort, paramInt1, paramInt2);
...
/*  396 */     return wrap(paramArrayOfshort, 0, paramArrayOfshort.length);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  686 */     checkBounds(paramInt1, paramInt2, paramArrayOfshort.length);
...
/*  715 */     return get(paramArrayOfshort, 0, paramArrayOfshort.length);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  763 */     if (paramShortBuffer == this)
/*  764 */       throw new IllegalArgumentException(); 
/*  765 */     if (isReadOnly())
/*  766 */       throw new ReadOnlyBufferException(); 
/*  767 */     int i = paramShortBuffer.remaining();
/*  768 */     if (i > remaining())
/*  769 */       throw new BufferOverflowException(); 
/*  770 */     for (byte b = 0; b < i; b++)
/*  771 */       put(paramShortBuffer.get()); 
/*  772 */     return this;
/*      */   }
/*      */ 
/*      */ 
...
/*  827 */     checkBounds(paramInt1, paramInt2, paramArrayOfshort.length);
...
/*  859 */     return put(paramArrayOfshort, 0, paramArrayOfshort.length);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1085 */     StringBuffer stringBuffer = new StringBuffer();
/* 1086 */     stringBuffer.append(getClass().getName());
/* 1087 */     stringBuffer.append("[pos=");
/* 1088 */     stringBuffer.append(position());
/* 1089 */     stringBuffer.append(" lim=");
/* 1090 */     stringBuffer.append(limit());
/* 1091 */     stringBuffer.append(" cap=");
/* 1092 */     stringBuffer.append(capacity());
...
/* 1161 */       return true; 
/* 1162 */     if (!(paramObject instanceof ShortBuffer))
/* 1163 */       return false; 
/* 1164 */     ShortBuffer shortBuffer = (ShortBuffer)paramObject;
/* 1165 */     if (remaining() != shortBuffer.remaining())
/* 1166 */       return false; 
/* 1167 */     int i = position();
/* 1168 */     for (int j = limit() - 1, k = shortBuffer.limit() - 1; j >= i; j--, k--) {
/* 1169 */       if (!equals(get(j), shortBuffer.get(k)))
/* 1170 */         return false; 
/* 1171 */     }  return true;
/*      */   }
/*      */ 
...
/* 1178 */     return (paramShort1 == paramShort2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1206 */     int i = position() + Math.min(remaining(), paramShortBuffer.remaining());
/* 1207 */     for (int j = position(), k = paramShortBuffer.position(); j < i; j++, k++) {
/* 1208 */       int m = compare(get(j), paramShortBuffer.get(k));
/* 1209 */       if (m != 0)
/* 1210 */         return m; 
/*      */     } 
/* 1212 */     return remaining() - paramShortBuffer.remaining();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1222 */     return Short.compare(paramShort1, paramShort2);
/*      */   }
/*      */   
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/java/nio/ShortBuffer.class
