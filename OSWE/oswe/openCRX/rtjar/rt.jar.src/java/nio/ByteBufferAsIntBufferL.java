...
/*  78 */     assert k >= 0;
/*  79 */     return new ByteBufferAsIntBufferL(this.bb, -1, 0, bool, bool, k);
/*     */   }
/*     */   
/*     */   public IntBuffer duplicate() {
/*  83 */     return new ByteBufferAsIntBufferL(this.bb, 
/*  84 */         markValue(), 
/*  85 */         position(), 
/*  86 */         limit(), 
...
/*  93 */     return new ByteBufferAsIntBufferRL(this.bb, 
/*  94 */         markValue(), 
/*  95 */         position(), 
/*  96 */         limit(), 
...
/* 128 */     Bits.putIntL(this.bb, ix(nextPutIndex()), paramInt);
/* 129 */     return this;
/*     */   }
/*     */ 
/*     */ 
...
/* 137 */     Bits.putIntL(this.bb, ix(checkIndex(paramInt1)), paramInt2);
/* 138 */     return this;
/*     */   }
/*     */ 
/*     */ 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/java/nio/ByteBufferAsIntBufferL.class
