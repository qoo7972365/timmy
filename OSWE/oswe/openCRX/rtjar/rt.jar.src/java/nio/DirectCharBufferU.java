...
/* 211 */     int k = i << 1;
/* 212 */     assert k >= 0;
/* 213 */     return new DirectCharBufferU(this, -1, 0, bool, bool, k);
/*     */   }
/*     */   
/*     */   public CharBuffer duplicate() {
/* 217 */     return new DirectCharBufferU(this, 
/* 218 */         markValue(), 
/* 219 */         position(), 
/* 220 */         limit(), 
/* 221 */         capacity(), 0);
...
/* 227 */     return new DirectCharBufferRU(this, 
/* 228 */         markValue(), 
/* 229 */         position(), 
/* 230 */         limit(), 
/* 231 */         capacity(), 0);
...
/* 258 */     return unsafe.getChar(ix(paramInt));
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 297 */     unsafe.putChar(ix(nextPutIndex()), paramChar);
/* 298 */     return this;
/*     */   }
/*     */ 
/*     */ 
...
/* 306 */     unsafe.putChar(ix(checkIndex(paramInt)), paramChar);
/* 307 */     return this;
/*     */   }
/*     */ 
/*     */ 
...
/* 315 */     if (paramCharBuffer instanceof DirectCharBufferU) {
/* 316 */       if (paramCharBuffer == this)
/* 317 */         throw new IllegalArgumentException(); 
/* 318 */       DirectCharBufferU directCharBufferU = (DirectCharBufferU)paramCharBuffer;
/*     */       
/* 320 */       int i = directCharBufferU.position();
/* 321 */       int j = directCharBufferU.limit();
/* 322 */       assert i <= j;
...
/* 332 */       unsafe.copyMemory(directCharBufferU.ix(i), ix(k), b1 << 1L);
/* 333 */       directCharBufferU.position(i + b1);
/* 334 */       position(k + b1);
...
/* 444 */     return new DirectCharBufferU(this, -1, i + paramInt1, i + paramInt2, 
/*     */ 
/*     */ 
/*     */         
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/java/nio/DirectCharBufferU.class
