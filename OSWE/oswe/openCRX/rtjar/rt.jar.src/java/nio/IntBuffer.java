...
/*  289 */     this(paramInt1, paramInt2, paramInt3, paramInt4, (int[])null, 0);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  335 */     return new HeapIntBuffer(paramInt, paramInt);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try {
/*  373 */       return new HeapIntBuffer(paramArrayOfint, paramInt1, paramInt2);
...
/*  396 */     return wrap(paramArrayOfint, 0, paramArrayOfint.length);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  686 */     checkBounds(paramInt1, paramInt2, paramArrayOfint.length);
...
/*  715 */     return get(paramArrayOfint, 0, paramArrayOfint.length);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  827 */     checkBounds(paramInt1, paramInt2, paramArrayOfint.length);
...
/*  859 */     return put(paramArrayOfint, 0, paramArrayOfint.length);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1161 */       return true; 
/* 1162 */     if (!(paramObject instanceof IntBuffer))
/* 1163 */       return false; 
/* 1164 */     IntBuffer intBuffer = (IntBuffer)paramObject;
/* 1165 */     if (remaining() != intBuffer.remaining())
/* 1166 */       return false; 
/* 1167 */     int i = position();
/* 1168 */     for (int j = limit() - 1, k = intBuffer.limit() - 1; j >= i; j--, k--) {
/* 1169 */       if (!equals(get(j), intBuffer.get(k)))
/* 1170 */         return false; 
/* 1171 */     }  return true;
/*      */   }
/*      */ 
...
/* 1178 */     return (paramInt1 == paramInt2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1206 */     int i = position() + Math.min(remaining(), paramIntBuffer.remaining());
/* 1207 */     for (int j = position(), k = paramIntBuffer.position(); j < i; j++, k++) {
/* 1208 */       int m = compare(get(j), paramIntBuffer.get(k));
/* 1209 */       if (m != 0)
/* 1210 */         return m; 
/*      */     } 
/* 1212 */     return remaining() - paramIntBuffer.remaining();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1222 */     return Integer.compare(paramInt1, paramInt2);
/*      */   }
/*      */   
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/java/nio/IntBuffer.class
