...
/* 211 */     int k = i << 2;
/* 212 */     assert k >= 0;
/* 213 */     return new DirectFloatBufferU(this, -1, 0, bool, bool, k);
/*     */   }
/*     */   
/*     */   public FloatBuffer duplicate() {
/* 217 */     return new DirectFloatBufferU(this, 
/* 218 */         markValue(), 
/* 219 */         position(), 
/* 220 */         limit(), 
/* 221 */         capacity(), 0);
...
/* 227 */     return new DirectFloatBufferRU(this, 
/* 228 */         markValue(), 
/* 229 */         position(), 
/* 230 */         limit(), 
/* 231 */         capacity(), 0);
...
/* 318 */       DirectFloatBufferU directFloatBufferU = (DirectFloatBufferU)paramFloatBuffer;
/*     */       
/* 320 */       int i = directFloatBufferU.position();
/* 321 */       int j = directFloatBufferU.limit();
/* 322 */       assert i <= j;
...
/* 332 */       unsafe.copyMemory(directFloatBufferU.ix(i), ix(k), b1 << 2L);
/* 333 */       directFloatBufferU.position(i + b1);
/* 334 */       position(k + b1);
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/java/nio/DirectFloatBufferU.class
