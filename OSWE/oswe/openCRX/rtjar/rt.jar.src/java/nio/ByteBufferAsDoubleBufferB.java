...
/*  78 */     assert k >= 0;
/*  79 */     return new ByteBufferAsDoubleBufferB(this.bb, -1, 0, bool, bool, k);
/*     */   }
/*     */   
/*     */   public DoubleBuffer duplicate() {
/*  83 */     return new ByteBufferAsDoubleBufferB(this.bb, 
/*  84 */         markValue(), 
/*  85 */         position(), 
/*  86 */         limit(), 
...
/*  93 */     return new ByteBufferAsDoubleBufferRB(this.bb, 
/*  94 */         markValue(), 
/*  95 */         position(), 
/*  96 */         limit(), 
...
/* 128 */     Bits.putDoubleB(this.bb, ix(nextPutIndex()), paramDouble);
/* 129 */     return this;
/*     */   }
/*     */ 
/*     */ 
...
/* 137 */     Bits.putDoubleB(this.bb, ix(checkIndex(paramInt)), paramDouble);
/* 138 */     return this;
/*     */   }
/*     */ 
/*     */ 
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/java/nio/ByteBufferAsDoubleBufferB.class
