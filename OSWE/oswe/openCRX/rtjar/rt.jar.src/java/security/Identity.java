...
/* 265 */     String str1 = paramPublicKey1.getFormat();
/* 266 */     String str2 = paramPublicKey2.getFormat();
/* 267 */     if ((((str1 == null) ? 1 : 0) ^ ((str2 == null) ? 1 : 0)) != 0)
/* 268 */       return false; 
/* 269 */     if (str1 != null && str2 != null && 
/* 270 */       !str1.equalsIgnoreCase(str2))
/* 271 */       return false; 
/* 272 */     return Arrays.equals(paramPublicKey1.getEncoded(), paramPublicKey2
/* 273 */         .getEncoded());
/*     */   }
/*     */ 
/*     */ 
...
/* 314 */     this.certificates.copyInto((Object[])arrayOfCertificate);
...
/* 340 */       Identity identity = (Identity)paramObject;
/* 341 */       if (fullName().equals(identity.fullName())) {
/* 342 */         return true;
/*     */       }
/* 344 */       return identityEquals(identity);
/*     */     } 
/*     */     
/* 347 */     return false;
/*     */   }
...
/*     */     
/* 469 */     byte b = 1;
/* 470 */     for (Certificate certificate : this.certificates) {
/*     */       
/* 472 */       str = str + "\tcertificate " + b++ + "\tfor  : " + certificate.getPrincipal() + "\n";
/*     */       
/* 474 */       str = str + "\t\t\tfrom : " + certificate.getGuarantor() + "\n";
/*     */     } 
/*     */     
/* 477 */     return str;
/*     */   }
...
/* 490 */     SecurityManager securityManager = System.getSecurityManager();
/* 491 */     if (securityManager != null)
/* 492 */       securityManager.checkSecurityAccess(paramString); 
/*     */   }
/*     */ }


/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/java/security/Identity.class
