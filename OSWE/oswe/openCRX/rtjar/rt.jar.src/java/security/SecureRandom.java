...
/*     */   extends Random
/*     */ {
/*  97 */   private static final Debug pdebug = Debug.getInstance("provider", "Provider");
/*  98 */   private static final boolean skipDebug = (
/*  99 */     Debug.isOn("engine=") && !Debug.isOn("securerandom"));
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 670 */     this.digest = null; getDefaultPRNG(false, null); } public SecureRandom(byte[] paramArrayOfbyte) { super(0L); this.digest = null; getDefaultPRNG(true, paramArrayOfbyte); } private SecureRandom(SecureRandomSpi paramSecureRandomSpi, Provider paramProvider, String paramString) { super(0L); this.digest = null;
...
/*     */     while (str2 != null) {
/*     */       Matcher matcher;
/*     */       if ((matcher = StrongPatternHolder.pattern.matcher(str2)).matches()) {
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/java/security/SecureRandom.class
