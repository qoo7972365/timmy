...
/* 775 */     this.text = null;
/* 776 */     this.buffer = null;
/* 777 */     this.expIndex = 0;
/* 778 */     this.key = new StringBuffer(5);
/* 779 */     this.swapOrder = 0; this.owner = paramRuleBasedCollator; this.ordering = paramRuleBasedCollator.getTables(); if (paramString.length() != 0) { NormalizerBase.Mode mode = CollatorUtilities.toNormalizerMode(paramRuleBasedCollator.getDecomposition()); this.text = new NormalizerBase(paramString, mode); }  } CollationElementIterator(CharacterIterator paramCharacterIterator, RuleBasedCollator paramRuleBasedCollator) { this.text = null; this.buffer = null; this.expIndex = 0; this.key = new StringBuffer(5); this.swapOrder = 0;
...
/*     */     return this.ordering.getMaxExpansion(paramInt);
/*     */   }
/*     */   
...
/*     */     int arrayOfInt1[], i = this.ordering.getUnicodeOrder(paramInt1);
/*     */     if (i >= 2130706432)
...
/*     */         j--;
/*     */       } 
/*     */       k = normalizerBase.next();
/*     */     } 
/*     */     String str = this.key.toString();
/*     */     j = 1;
/*     */     for (int m = vector.size() - 1; m > 0; m--) {
/*     */       entryPair = vector.elementAt(m);
/*     */       if (entryPair.fwd)
/*     */         if (str.startsWith(entryPair.entryName) && entryPair.entryName.length() > j) {
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/java/text/CollationElementIterator.class
