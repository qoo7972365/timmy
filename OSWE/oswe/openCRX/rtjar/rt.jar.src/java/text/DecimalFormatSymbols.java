...
/* 877 */     this.serialVersionOnStream = 3; initialize(Locale.getDefault(Locale.Category.FORMAT)); } public DecimalFormatSymbols(Locale paramLocale) { this.serialVersionOnStream = 3;
/*     */     initialize(paramLocale); }
/*     */ 
/*     */   
/*     */   public static Locale[] getAvailableLocales() {
/*     */     LocaleServiceProviderPool localeServiceProviderPool = LocaleServiceProviderPool.getPool((Class)DecimalFormatSymbolsProvider.class);
...
/*     */     LocaleProviderAdapter localeProviderAdapter = LocaleProviderAdapter.getAdapter((Class)DecimalFormatSymbolsProvider.class, paramLocale);
...
/*     */     this.groupingSeparator = paramChar;
/*     */   }
/*     */   
...
/*     */     this.patternSeparator = paramChar;
/*     */   }
/*     */   
...
/*     */     this.currencySymbol = paramString;
/*     */   }
/*     */   
...
/*     */     this.monetarySeparator = paramChar;
/*     */   }
/*     */   
...
/*     */     int i = c * 37 + this.groupingSeparator;
/*     */     i = i * 37 + this.decimalSeparator;
/*     */     return i;
/*     */   }
/*     */   
...
/*     */       if (arrayOfObject[1] != null && arrayOfObject[1] == this.intlCurrencySymbol) {
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/java/text/DecimalFormatSymbols.class
