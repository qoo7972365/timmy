...
/*     */     try {
/* 794 */       Class<?> clazz = "java.util.jar.Pack200.Packer".equals(paramString) ? packerImpl : unpackerImpl;
/* 795 */       if (clazz == null) {
/*     */         
/* 797 */         str = AccessController.<String>doPrivileged(new GetPropertyAction(paramString, ""));
/*     */         
/* 799 */         if (str != null && !str.equals("")) {
/* 800 */           clazz = Class.forName(str);
/* 801 */         } else if ("java.util.jar.Pack200.Packer".equals(paramString)) {
/* 802 */           clazz = PackerImpl.class;
/*     */         } else {
/* 804 */           clazz = UnpackerImpl.class;
/*     */         } 
/*     */       } 
/* 807 */       return clazz.newInstance();
...
/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/java/util/jar/Pack200.class
