...
/*     */ 
/*     */   
/* 773 */   private static final Map<String, String> zidToMzone = new HashMap<>();
/* 774 */   private static final Map<String, String> mzoneToZid = new HashMap<>();
/* 775 */   private static final Map<String, Map<String, String>> mzoneToZidL = new HashMap<>();
/* 776 */   private static final Map<String, String> aliases = new HashMap<>();
/*     */   static {
/*     */     byte b;
/* 779 */     for (b = 0; b < zidMap.length; b += 3) {
/* 780 */       zidToMzone.put(zidMap[b], zidMap[b + 1]);
/* 781 */       mzoneToZid.put(zidMap[b + 1], zidMap[b + 2]);
/*     */     } 
/*     */     
/* 784 */     for (b = 0; b < mzoneMap.length; b += 3) {
/* 785 */       String str = mzoneMap[b];
/* 786 */       Map<Object, Object> map = (Map)mzoneToZidL.get(str);
/* 787 */       if (map == null) {
/* 788 */         map = new HashMap<>();
/* 789 */         mzoneToZidL.put(str, map);
/*     */       } 
/* 791 */       map.put(mzoneMap[b + 1], mzoneMap[b + 2]);
/*     */     } 
/*     */     
/* 794 */     for (b = 0; b < aliasMap.length; b += 2)
/* 795 */       aliases.put(aliasMap[b], aliasMap[b + 1]); 
/*     */   }
/*     */ }


/* Location:              /Users/timmy/timmy/OSWE/oswe/openCRX/rt.jar!/java/time/format/ZoneName.class
