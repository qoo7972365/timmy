...
/*     */ 
/*     */ public final class WLSDisableServlet_jsp extends org.apache.jasper.runtime.HttpJspBase implements JspSourceDependent
/*     */ {
...
/*     */       
/*  80 */       ArrayList servletDisableList = new ArrayList();
/*  81 */       AMConnectionPool pool = AMConnectionPool.getInstance();
/*  82 */       ArrayList servletEnableList = new ArrayList();
/*     */       
/*  84 */       String servletEnableQuery = "select t1.RESOURCEID, DISPLAYNAME from AM_ManagedObject t1,AM_WLS_DISABLE_STATS t2 where t1.resourceid=t2.resourceid and t1.type='WEBLOGIC-server' and t2.ENABLESERVLET=0";
/*  85 */       ResultSet servletEnableSet = AMConnectionPool.executeQueryStmt(servletEnableQuery);
/*     */       
/*  87 */       while (servletEnableSet.next())
/*     */       {
/*  89 */         String monitorResourceId = String.valueOf(servletEnableSet.getInt("RESOURCEID"));
/*  90 */         servletEnableList.add(monitorResourceId);
/*     */       }
/*     */       
/*     */       try
/*     */       {
/*  95 */         if (servletEnableSet != null) {
/*  96 */           servletEnableSet.close();
/*     */         }
/*     */       }
/*     */       catch (Exception e) {}
/*     */       
...
/*     */ 
/*     */ 
/* 104 */       String servletDisableQuery = "select t1.RESOURCEID, DISPLAYNAME from AM_ManagedObject t1,AM_WLS_DISABLE_STATS t2 where t1.resourceid=t2.resourceid and t1.type='WEBLOGIC-server' and t2.ENABLESERVLET=1";
/*     */       
/* 106 */       ResultSet servletDisableResultSet = null;
/*     */       try
/*     */       {
/* 109 */         servletDisableResultSet = AMConnectionPool.executeQueryStmt(servletDisableQuery);
/* 110 */         while (servletDisableResultSet.next())
/*     */         {
/* 112 */           String monitorDisplayName = servletDisableResultSet.getString("DISPLAYNAME");
/* 113 */           String monitorResourceId = String.valueOf(servletDisableResultSet.getInt("RESOURCEID"));
/* 114 */           servletDisableList.add(monitorResourceId);
/*     */         }
/*     */       }
...
/*     */       try
/*     */       {
/* 124 */         if (servletDisableResultSet != null) {
/* 125 */           servletDisableResultSet.close();
/*     */         }
/*     */       }
/*     */       catch (Exception e) {
...
/* 133 */       if (((servletEnableList != null) && (!servletEnableList.isEmpty())) || ((servletDisableList != null) && (!servletDisableList.isEmpty())))
/*     */       {
/* 135 */         int servletDisableSize = 8;
/* 136 */         int servletEnableSize = 8;
/* 137 */         if ((servletEnableList != null) && (servletEnableList.size() > 8))
/* 138 */           servletEnableSize = servletEnableList.size();
/* 139 */         if ((servletDisableList != null) && (servletDisableList.size() > 0)) {
/* 140 */           servletDisableSize = servletDisableList.size();
/*     */         }
/*     */         
/* 143 */         out.write("\n        \t<table>\n                <tr>\n\n        \t        <td align=\"center\" class=\"bodytext\"> &nbsp; </td>\n                \t<td align=\"center\" class=\"bodytextbold\">");
/* 144 */         out.print(FormatUtil.getString("am.webclient.disableservletmon.txt"));
/* 145 */         out.write("</td>\n\t                <td align=\"center\" class=\"bodytext\"> &nbsp; </td>\n        \t        <td align=\"center\" class=\"bodytextbold\">");
/* 146 */         out.print(FormatUtil.getString("am.webclient.enableservletmon.txt"));
/* 147 */         out.write("</td>\n                \t<td align=\"center\" class=\"bodytext\"> &nbsp; </td>\n                </tr>\n                <tr>\n\t                <td width=\"5%\" align=\"center\" class=\"bodytext\"> &nbsp; </td>\n        \t        <td width=\"26%\" align=\"right\" class=\"bodytext\">\n\t\t<div id=\"divServletDisable\" class=\"formtextarea\" style=\"OVERFLOW: auto;width: 300px;height: 130px\" onscroll=\"OnDivScroll(this);\"> \n\t\t\t\n\t\t\t<select name=\"wlsservlet_disable\" style=\"width:750px\" size=\"");
/* 148 */         out.print(servletEnableSize);
/* 149 */         out.write("\"  multiple  id=\"servlet_disableid\" onfocus=\"OnSelectFocus(this);\" >\n                \t");
/*     */         
/* 151 */         if ((servletEnableList != null) && (!servletEnableList.isEmpty()))
/*     */         {
/* 153 */           Properties monitorNameId = FaultUtil.getMonitorName(servletEnableList, false, false);
...
/*     */           } }
/* 172 */         out.write("\n\t\t\t</select>\n\t\t\t</div>\n\t\t\t</td>\n\t\t        <td width=\"7%\" align=\"center\" class=\"bodytext\"> \n\t\t\t\t<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\n\t      \t\t\t<tr>\n\t\t            \t\t<td align=\"center\" ><input name=\"AddButton2\" type=\"button\" class=\"buttons\" onClick=\"javascript:fnAddToRightAndSetScrollSize(wlsservlet_disable,wlsservlet_enable);\" value=\"&nbsp;&gt;&nbsp;\"></td>\n\t      \t\t\t</tr>\n              \t\t\t<tr>\n\t\t    \t\t       <td><img src=\"../images/spacer.gif\" height=\"8\" width=\"5\"></td>\n\t      \t\t\t</tr>\n\t      \t\t\t<tr>\n\t\t            \t\t<td align=\"center\"><input name=\"AddButton2\" type=\"button\" class=\"buttons\" onClick=\"javascript:fnAddAllFrmCombo(wlsservlet_disable,wlsservlet_enable),fnRemoveAllFrmCombo(wlsservlet_disable);\" value=\"&gt;&gt;\"></td>\n\t      \t\t\t</tr>\n              \t\t\t<tr>\n\t\t    \t\t       <td><img src=\"../images/spacer.gif\" height=\"8\" width=\"5\"></td>\n\t      \t\t\t</tr>\n              \t\t\t<tr>\n\t\t\t\t       <td align=\"center\"><input name=\"RemoveButton2\" type=\"button\" class=\"buttons\" onClick=\"javascript:fnAddToRightAndSetScrollSize(wlsservlet_enable,wlsservlet_disable)\" value=\"&nbsp;&lt;&nbsp;\"></td>\n");
/* 173 */         out.write("\t\t                </tr>\n              \t\t\t<tr>\n\t\t    \t\t       <td><img src=\"../images/spacer.gif\" height=\"8\" width=\"5\"></td>\n\t      \t\t\t</tr>\n              \t\t\t<tr>\n\t\t\t\t       <td align=\"center\"><input name=\"RemoveButton2\" type=\"button\" class=\"buttons\" onClick=\"javascript:fnAddAllFrmCombo(wlsservlet_enable,wlsservlet_disable),fnRemoveAllFrmCombo(wlsservlet_enable);\" value=\"&lt;&lt;\"></td>\n\t\t                </tr>\n\t\t\t      </table>\n\t\t\t</td>\n\t\t         <td width=\"26%\" align=\"left\" class=\"bodytext\">\n\t\t\t<div id=\"divServletEnable\" class=\"formtextarea\" style=\"OVERFLOW: auto;width: 300px;height: 130px\" onscroll=\"OnDivScroll(this);\">\n\t\t\t<select  name=\"wlsservlet_enable\" style=\"width:750px\" size=\"");
/* 174 */         out.print(servletDisableSize);
/* 175 */         out.write("\" multiple id=\"servlet_enableid\" onfocus=\"OnSelectFocus(this);\">\n\t\t\t");
/*     */         
/* 177 */         if ((servletDisableList != null) && (servletDisableList.size() > 0))
/*     */         {
/* 179 */           Properties commonThresholdMonitorNameId = FaultUtil.getMonitorName(servletDisableList, false, false);
...
/* Location:              C:\Program Files (x86)\ManageEngine\AppManager12\working\WEB-INF\lib\AdventNetAppManagerWebClient.jar!\org\apache\jsp\jsp\includes\WLSDisableServlet_jsp.class
